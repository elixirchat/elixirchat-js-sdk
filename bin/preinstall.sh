...
# parcel and sass must be installed prior to launching bin/postinstall.sh
# to avoid the bug when parcel or sass are not being found in bin/postinstall.sh
