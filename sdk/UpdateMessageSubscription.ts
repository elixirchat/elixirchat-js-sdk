...
import {ERROR_ALERT, UPDATE_MESSAGE_SUBSCRIPTION_CHANGE_MESSAGE} from './ElixirChatEventTypes';
    ...
    graphQLClientSocket.subscribe({
      ...
      onResult: (response) => {
        ...
        if (data) {
          ...
          triggerEvent(UPDATE_MESSAGE_SUBSCRIPTION_CHANGE_MESSAGE, updatedMessage);
        }
      },
    });
  };
