...
function serializeUser(user, elixirChat) {
  ...
  var elixirChatId = ((_a = user) === null || _a === void 0 ? void 0 : _a.foreignId) || null;
  var isOperator = ((_b = user) === null || _b === void 0 ? void 0 : _b.__typename) !== 'Client';
  return {
    id: ((_c = user) === null || _c === void 0 ? void 0 : _c.id) || null,
    firstName: ((_d = user) === null || _d === void 0 ? void 0 : _d.firstName) || '',
    lastName: ((_e = user) === null || _e === void 0 ? void 0 : _e.lastName) || '',
    ...
    value: function initializeSocketClient() {
      ...
      this.graphQLClientSocket = new GraphQLClientSocket_1.GraphQLClientSocket({
        ...
        onResult: function onResult(response) {
          ...
          var data = ((_b = (_a = response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.updateReadMessages) || {};
...
function serializeMessage(message, elixirChat) {
  ...
  var serializedResponseToMessage = {
    ...
    isDeleted: (_d = responseToMessage) === null || _d === void 0 ? void 0 : _d.isDeleted
  };
  ...
  return {
    ...
    isDeleted: ((_q = message) === null || _q === void 0 ? void 0 : _q.isDeleted) || false,
...
function () {
  function MessageSubscription(_ref) {
    ...
    this.onMessageReceive = function (response) {
      ...
      var _this$elixirChat2 = _this.elixirChat,
          triggerEvent = _this$elixirChat2.triggerEvent,
          debug = _this$elixirChat2.debug;
      var data = (_b = (_a = response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.newMessage;
    ...
    this.retrySendMessage = function (message) {
      ...
      _this.sendMessage({
        text: message.text,
        attachments: message.attachments,
        responseToMessageId: (_b = (_a = message) === null || _a === void 0 ? void 0 : _a.responseToMessage) === null || _b === void 0 ? void 0 : _b.id,
  ...
  _createClass(MessageSubscription, [{
    ...
    value: function generateNewClientPlaceholderMessage(messageHistory) {
      ...
      var firstMessageTimestamp = (_b = (_a = messageHistory) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.timestamp;
    ...
    value: function onSendMessageFailure(tempId, response) {
      ...
      var submissionErrorCode = ((_c = (_b = (_a = response) === null || _a === void 0 ? void 0 : _a.errors) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.status) || defaultErrorCode;
  ...
  _createClass(ElixirChat, [{
    ...
    value: function initialize(config) {
      ...
      this.on(ElixirChatEventTypes_1.JOIN_ROOM_SUCCESS, function (data) {
        ...
        var areAnyOperatorsOnline = (_b = (_a = data) === null || _a === void 0 ? void 0 : _a.company) === null || _b === void 0 ? void 0 : _b.isWorking;
