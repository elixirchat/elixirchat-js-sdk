...
exports.trimEachRow = exports.isVideoConvertibleIntoMp4 = exports.isWebImage = exports.getJSONFromLocalStorage = exports.detectPlatform = exports.detectBrowser = exports._flatten = exports._round = exports._last = exports.randomDigitStringId = exports.capitalize = exports.logEvent = void 0;
...
exports.insertGraphQlFragments = exports.gql = exports.simplifyGraphQLJSON = exports.GraphQLClient = void 0;
...
function serializeUser(user, elixirChat) {
  var elixirChatId = (user === null || user === void 0 ? void 0 : user.foreignId) || null;
  var isOperator = (user === null || user === void 0 ? void 0 : user.__typename) !== 'Client';
  return {
...
},{"../GraphQLClient":"fvSB"}],"zWqG":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.IMAGE_PREVIEW_CLOSE = exports.IMAGE_PREVIEW_OPEN = exports.TEXTAREA_VERTICAL_RESIZE = exports.REPLY_MESSAGE = exports.SCREENSHOT_REQUEST_ERROR = exports.SCREENSHOT_REQUEST_SUCCESS = exports.WIDGET_UNMUTE = exports.WIDGET_MUTE = exports.WIDGET_POPUP_BLUR = exports.WIDGET_POPUP_FOCUS = exports.WIDGET_POPUP_TOGGLE = exports.WIDGET_POPUP_CLOSE = exports.WIDGET_POPUP_OPEN = exports.WIDGET_RENDERED = exports.WIDGET_IFRAME_READY = void 0;
...
},{"../utilsCommon":"EjGt","../widget/ElixirChatWidgetEventTypes":"zWqG"}],"qf4T":[function(require,module,exports) {
...
exports.UPDATE_MESSAGES_CHANGE = exports.UPDATE_MESSAGES_SUBSCRIBE_ERROR = exports.UPDATE_MESSAGES_SUBSCRIBE_SUCCESS = exports.MESSAGES_FETCH_HISTORY_INITIAL_ERROR = exports.MESSAGES_FETCH_HISTORY_ERROR = exports.MESSAGES_FETCH_HISTORY_INITIAL_SUCCESS = exports.MESSAGES_FETCH_HISTORY_SUCCESS = exports.MESSAGES_HISTORY_CHANGE_MANY = exports.MESSAGES_HISTORY_CHANGE_ONE = exports.MESSAGES_HISTORY_PREPEND_MANY = exports.MESSAGES_HISTORY_PREPEND_ONE = exports.MESSAGES_HISTORY_APPEND_MANY = exports.MESSAGES_HISTORY_APPEND_ONE = exports.MESSAGES_HISTORY_SET = exports.MESSAGES_SUBSCRIBE_ERROR = exports.MESSAGES_SUBSCRIBE_SUCCESS = exports.TYPING_STATUS_SUBSCRIBE_ERROR = exports.TYPING_STATUS_SUBSCRIBE_SUCCESS = exports.TYPING_STATUS_CHANGE = exports.OPERATOR_ONLINE_STATUS_SUBSCRIBE_ERROR = exports.OPERATOR_ONLINE_STATUS_SUBSCRIBE_SUCCESS = exports.OPERATOR_ONLINE_STATUS_CHANGE = exports.JOIN_ROOM_ERROR = exports.JOIN_ROOM_SUCCESS = exports.UNREAD_FETCH_COUNTS_ERROR = exports.UNREAD_FETCH_COUNTS_SUCCESS = exports.UNREAD_MESSAGES_SUBSCRIBE_ERROR = exports.UNREAD_MESSAGES_SUBSCRIBE_SUCCESS = exports.LAST_READ_MESSAGE_CHANGE = exports.UNREAD_REPLIES_CHANGE = exports.UNREAD_MESSAGES_CHANGE = void 0;
...
},{"../utilsCommon":"EjGt","./GraphQLClient":"fvSB","./GraphQLClientSocket":"P6qz","./ElixirChatEventTypes":"Cteb"}],"QERd":[function(require,module,exports) {
"use strict";
...
exports.OperatorOnlineStatusSubscription = void 0;
...
},{"./ElixirChatEventTypes":"Cteb","./GraphQLClient":"fvSB","./GraphQLClientSocket":"P6qz","../utilsCommon":"EjGt"}],"sQAQ":[function(require,module,exports) {
"use strict";
...
exports.serializeFile = exports.fragmentFile = void 0;
...
function serializeFile(fileData, elixirChat) {
  ...
  var uploadsUrlPrefix = elixirChat.apiUrl.replace(/\/$/, '') + '/';
  var fileUrl = '';
...
},{"../GraphQLClient":"fvSB"}],"ZEl5":[function(require,module,exports) {
"use strict";
...
function serializeMessage(message, elixirChat) {
  ...
  var serializedResponseToMessage = {
    id: (responseToMessage === null || responseToMessage === void 0 ? void 0 : responseToMessage.id) || null,
    text: (responseToMessage === null || responseToMessage === void 0 ? void 0 : responseToMessage.text) || '',
    ...
    isDeleted: responseToMessage === null || responseToMessage === void 0 ? void 0 : responseToMessage.isDeleted
  };
  ...
  return {
    id: (message === null || message === void 0 ? void 0 : message.id) || null,
    tempId: (message === null || message === void 0 ? void 0 : message.tempId) || null,
    text: (message === null || message === void 0 ? void 0 : message.text) || '',
    timestamp: (message === null || message === void 0 ? void 0 : message.timestamp) || '',
    cursor: (message === null || message === void 0 ? void 0 : message.cursor) || null,
    sender: serializedSender,
    responseToMessage: serializedResponseToMessage,
    attachments: serializedAttachments,
    mentions: serializedMentions,
    isSubmitting: (message === null || message === void 0 ? void 0 : message.isSubmitting) || false,
    submissionErrorCode: (message === null || message === void 0 ? void 0 : message.submissionErrorCode) || null,
    mustOpenWidget: (message === null || message === void 0 ? void 0 : message.mustOpenWidget) || false,
    isUnread: (message === null || message === void 0 ? void 0 : message.isUnread) || false,
    isSystem: (message === null || message === void 0 ? void 0 : message.isSystem) || false,
    isDeleted: (message === null || message === void 0 ? void 0 : message.isDeleted) || false,
    systemType: (message === null || message === void 0 ? void 0 : message.__typename) || null,
    systemWorkHoursStartAt: (message === null || message === void 0 ? void 0 : message.workHoursStartAt) || null
  };
}
  ...
  function MessageSubscription(_ref) {
      ...
      return new Promise(function (resolve, reject) {
        _this.graphQLClient.query(_this.sendMessageQuery, variables, binaries).then(function (response) {
          if (response && response.sendMessage) {
            var message = serializeMessage_1.serializeMessage(response.sendMessage, _this.elixirChat);
        ...
        _this.graphQLClient.query(_this.messageHistoryQuery, variables).then(function (response) {
          if (response && response.messages) {
            ...
            var processedMessages = GraphQLClient_1.simplifyGraphQLJSON(response.messages).map(function (message) {
              return serializeMessage_1.serializeMessage(message, _this.elixirChat);
            ...
            triggerEvent(hasMessageHistoryBeenEverFetched ? ElixirChatEventTypes_1.MESSAGES_FETCH_HISTORY_SUCCESS : ElixirChatEventTypes_1.MESSAGES_FETCH_HISTORY_INITIAL_SUCCESS, processedMessages);
    ...
    this.fetchPrecedingMessageHistory = function (limit) {
      ...
      return _this.getMessageHistoryByCursor({
        ...
        triggerEvent(ElixirChatEventTypes_1.MESSAGES_HISTORY_PREPEND_MANY, processedMessageHistory);
        return processedMessageHistory;
      });
    };
  ...
  _createClass(MessageSubscription, [{
    ...
    value: function initializeSocketClient() {
      var _this$elixirChat5 = this.elixirChat,
          socketUrl = _this$elixirChat5.socketUrl,
          authToken = _this$elixirChat5.authToken,
    ...
    value: function generateNewClientPlaceholderMessage(messageHistory) {
      ...
      var firstMessageTimestamp = (_a = messageHistory === null || messageHistory === void 0 ? void 0 : messageHistory[0]) === null || _a === void 0 ? void 0 : _a.timestamp;
    ...
    value: function appendMessageConditionally(message) {
      var _this$elixirChat6 = this.elixirChat,
    ...
    value: function onSendMessageFailure(tempId, response) {
      ...
      var submissionErrorCode = ((_b = (_a = response === null || response === void 0 ? void 0 : response.errors) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.status) || defaultErrorCode;
...
},{"./ElixirChatEventTypes":"Cteb","./serializers/serializeMessage":"ZEl5","../utilsCommon":"EjGt","./GraphQLClientSocket":"P6qz","./GraphQLClient":"fvSB"}],"Pqo8":[function(require,module,exports) {
"use strict";
  ...
  _createClass(ElixirChat, [{
    ...
    value: function initialize(config) {
      ...
      this.on(ElixirChatEventTypes_1.JOIN_ROOM_SUCCESS, function (data) {
        ...
        var areAnyOperatorsOnline = (_a = data === null || data === void 0 ? void 0 : data.company) === null || _a === void 0 ? void 0 : _a.isWorking;
