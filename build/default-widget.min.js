...
"use strict";function e(e,t,n,r,o,i,a){try{var c=e[i](a),u=c.value}catch(f){return void n(f)}c.done?t(u):Promise.resolve(u).then(r,o)}function t(t){return function(){var n=this,r=arguments;return new Promise(function(o,i){var a=t.apply(n,r);function c(t){e(a,o,i,c,u,"next",t)}function u(t){e(a,o,i,c,u,"throw",t)}c(void 0)})}}function n(e){return(n="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function r(e,t,r){var o=document.createElement(e);if("object"===n(t))for(var i in t)o[i]=t[i];return r&&r.appendChild(o),o}function o(e,t,n,r){var o={"en-US":function(e,t){return 1===e?t[0]:t[1]},"ru-RU":function(e,t){return t[e%100>4&&e%100<20?2:[2,0,1,1,1,2][Math.min(e%10,5)]]}},i=o[e](t,n)||n[0];return r?i:t+" "+i}function i(){var e=new AudioContext,t=e.createBiquadFilter();t.type="notch",t.frequency.value=780,t.Q.value=1.5,t.connect(e.destination);var n=e.createGain();n.gain.exponentialRampToValueAtTime(1e-4,e.currentTime+1),n.connect(t);var r=e.createOscillator();r.frequency.value=830.6,r.connect(n),r.start(0),r.stop(1.65);var o=e.createGain();o.gain.exponentialRampToValueAtTime(1e-4,e.currentTime+1.5),o.connect(t);var i=e.createOscillator();i.frequency.value=440,i.connect(o),i.start(.15),i.stop(1.65)}function a(e,t,n){return'@font-face {\n    font-family: "'.concat(e,'";\n    ').concat(t?"font-weight: ".concat(t,";"):"",'\n    src: url("').concat(n,'") format("woff");\n  }')}function c(e){return["image/jpg","image/jpeg","image/png","image/gif"].includes(e.toLowerCase())}function u(e,t){var n=t/1024,r=n/1024,o=r/1024,i=n,a="kb";return o>1?(i=o,a="gb"):r>1&&(i=r,a="mb"),(i=i<.1?.1:+i.toFixed(1)).toLocaleString(e)+" "+{"ru-RU":{kb:"Кб",mb:"Мб",gb:"Гб"},"en-US":{kb:"Kb",mb:"Mb",gb:"Gb"}}[e||"en-US"][a]}function f(e){return s.apply(this,arguments)}function s(){return(s=t(regeneratorRuntime.mark(function e(t){return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",new Promise(function(e){var n=new Image;n.onload=function(){e({width:n.width,height:n.height})},n.onerror=function(){e({width:0,height:0})},n.src=t}));case 1:case"end":return e.stop()}},e)}))).apply(this,arguments)}Object.defineProperty(exports,"__esModule",{value:!0}),exports.insertElement=r,exports.inflect=o,exports.playNotificationSound=i,exports.generateFontFaceRule=a,exports.isWebImage=c,exports.getHumanReadableFileSize=u,exports.getImageDimensions=f;
