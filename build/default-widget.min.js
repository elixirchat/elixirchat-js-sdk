...
"use strict";function e(e,t,n,r,o,i,a){try{var u=e[i](a),c=u.value}catch(s){return void n(s)}u.done?t(c):Promise.resolve(c).then(r,o)}function t(t){return function(){var n=this,r=arguments;return new Promise(function(o,i){var a=t.apply(n,r);function u(t){e(a,o,i,u,c,"next",t)}function c(t){e(a,o,i,u,c,"throw",t)}u(void 0)})}}var n=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0});var r=n(require("./widget/DefaultWidget/assets"));function o(e,t,n,r){var o={"en-US":function(e,t){return 1===e?t[0]:t[1]},"ru-RU":function(e,t){return t[e%100>4&&e%100<20?2:[2,0,1,1,1,2][Math.min(e%10,5)]]}}[e](t,n)||n[0];return r?o:t+" "+o}function i(e,t){if("en-US"===e)return t;var n=t,r={"в понедельник":"в понедельник","в вторник":"во вторник","в среда":"в среду","в четверг":"в четверг","в пятница":"в пятницу","в суббота":"в субботу","в воскресенье":"в воскресенье"};for(var o in r){var i=new RegExp(o,"ig");n=n.replace(i,r[o])}return n}function a(e){var t=new Audio(r.default.notificationSound);t.play().then(function(){t.pause(),t.currentTime=0}),"TEXTAREA"!==e.target.tagName&&e.currentTarget.removeEventListener(e.type,a)}function u(){var e=new Audio(r.default.notificationSound);try{e.play()}catch(t){console.error("Unable to play notification sound before any action was taken by the user in the current browser tab")}}function c(e,t,n,r){return'@font-face {\n    font-family: "'.concat(e,'";\n    ').concat(t?"font-weight: ".concat(t,";"):"",'\n    src: url("').concat(n,'") format("').concat(r,'");\n  }')}function s(e,t){var n=t/1024,r=n/1024,o=r/1024,i=n,a="kb";return o>1?(i=o,a="gb"):r>1&&(i=r,a="mb"),(i=i<.1?.1:+i.toFixed(1)).toLocaleString(e)+" "+{"ru-RU":{kb:"Кб",mb:"Мб",gb:"Гб"},"en-US":{kb:"Kb",mb:"Mb",gb:"Gb"}}[e||"en-US"][a]}function f(e){return l.apply(this,arguments)}function l(){return(l=t(regeneratorRuntime.mark(function e(t){return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",new Promise(function(e){var n=new Image;n.onload=function(){e({width:n.width,height:n.height})},n.onerror=function(){e({width:0,height:0})},n.src=t}));case 1:case"end":return e.stop()}},e)}))).apply(this,arguments)}function p(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:function(){},r=t.isSmooth,o=t.position;if(e&&e.tagName)if(e.scrollIntoView({behavior:r?"smooth":"auto",block:o||"center"}),"undefined"!=typeof IntersectionObserver){var i=new IntersectionObserver(function(t){t[0].isIntersecting&&(i.unobserve(e),n())});i.observe(e)}else setTimeout(function(){n&&n()},300)}function v(e,t){var n=e||{},r=n.firstName,o=n.lastName;return r||o?[r,o].join(" "):t}function d(e,t){var n=arguments.length>2&&void 0!==arguments[2]&&arguments[2],r=e||{},o=r.sender,i=void 0===o?{}:o,a=r.text,u=void 0===a?"":a,c=i.firstName,s=i.lastName;return u&&!n?u.substr(0,100):i.isOperator?c||s?[c,s].join(" "):t:[c,s].join(" ")}exports.inflect=o,exports.inflectDayJSWeekDays=i,exports.unlockNotificationSoundAutoplay=a,exports.playNotificationSound=u,exports.generateFontFaceRule=c,exports.getHumanReadableFileSize=s,exports.getImageDimensions=f,exports.scrollToElement=p,exports.getCustomerSupportNameString=v,exports.generateMessageOrQuoteTitle=d;
