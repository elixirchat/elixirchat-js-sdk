...
"use strict";function e(i){return(e="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(i)}function i(e,i){if(!(e instanceof i))throw new TypeError("Cannot call a class as a function")}function t(e,i){for(var t=0;t<i.length;t++){var a=i[t];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}function a(e,i,a){return i&&t(e.prototype,i),a&&t(e,a),e}function r(i,t){return!t||"object"!==e(t)&&"function"!=typeof t?n(i):t}function n(e){if(void 0===e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return e}function s(e){return(s=Object.setPrototypeOf?Object.getPrototypeOf:function(e){return e.__proto__||Object.getPrototypeOf(e)})(e)}function o(e,i){if("function"!=typeof i&&null!==i)throw new TypeError("Super expression must either be null or a function");e.prototype=Object.create(i&&i.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),i&&l(e,i)}function l(e,i){return(l=Object.setPrototypeOf||function(e,i){return e.__proto__=i,e})(e,i)}Object.defineProperty(exports,"__esModule",{value:!0}),require("babel-polyfill");var g=require("../utilsCommon"),c=require("../utilsWidget"),d=require("./DefaultWidget/DefaultWidget"),u=require("./DefaultWidget/assets"),m=require("./DefaultWidget/styles"),h=window.ElixirChat;h||g.logEvent(!0,'Cannot find ElixirChat SDK. Are you sure you imported SDK (ether via "import" or via the <script/> tag)?\nSee: https://github.com/elixirchat/elixirchat-js-sdk#add-default-widget',{NODE_ENV:"production"},"error");var w=function(e){function t(){var e;return i(this,t),(e=r(this,s(t).apply(this,arguments))).imagePreviewHorizontalPaddings=100,e.imagePreviewVerticalPaddings=120,e.widgetIsVisible=!1,e.widgetImagePreviewIsVisible=!1,e.widgetChatReactComponent={},e.onToggleChatVisibilityCallbacks=[],e.setUnreadCount=function(i){var t=e.widgetButton.querySelector(".elixirchat-widget-button-counter");e.widgetUnreadCount=+i||0,i?(t.classList.add("elixirchat-widget-button-counter--has-unread"),t.innerText=i):(t.classList.remove("elixirchat-widget-button-counter--has-unread"),t.innerText="")},e.toggleChatVisibility=function(){e.widgetIsVisible=!e.widgetIsVisible,e.widgetIsVisible?(e.widgetButton.classList.add("elixirchat-widget-button--visible"),e.widgetChatIframe.classList.add("elixirchat-widget-iframe--opening","elixirchat-widget-iframe--visible"),setTimeout(function(){e.widgetChatIframe.classList.remove("elixirchat-widget-iframe--opening")},0)):(e.widgetButton.classList.remove("elixirchat-widget-button--visible"),e.widgetChatIframe.classList.remove("elixirchat-widget-iframe--visible")),e.onToggleChatVisibilityCallbacks.forEach(function(i){return i(e.widgetIsVisible)})},e.onToggleChatVisibility=function(i){e.onToggleChatVisibilityCallbacks.push(i)},e.appendWidget=function(i){var t=i.container,a=i.iframeStyles,r=void 0===a?"":a,n=i.visibleByDefault,s=void 0!==n&&n;if(t instanceof HTMLElement)return e.container=t,e.iframeStyles=r,e.visibleByDefault=s,e.appendChatIframe(),e.appendWidgetButton(),e.appendImagePreview(),e.visibleByDefault&&e.toggleChatVisibility(),g.logEvent(e.debug,"Appended ElixirChat default widget",{container:t}),e.widgetChatReactComponent;g.logEvent(e.debug,'You must provide an HTMLElement as a "container" option to appendWidget() method',{container:t,iframeStyles:r},"error")},e}return o(t,h),a(t,[{key:"injectGlobalStyles",value:function(e){var i=e;c.areCssVariablesSupported()||(i=c.replaceCssVariables(e,c.parseCssVariables(u.globalAssetUrlCssVars))),c.insertElement("style",{innerHTML:i,type:"text/css"},this.container)}},{key:"injectIframeStyles",value:function(e){var i=this.widgetChatIframe.contentWindow.document.querySelector("main"),t=e;c.areCssVariablesSupported()||(t=c.replaceCssVariables(e,c.parseCssVariables(u.iframeAssetUrlCssVars))),c.insertElement("style",{innerHTML:t,type:"text/css"},i)}},{key:"appendWidgetButton",value:function(){var e=c.insertElement("button",{className:"elixirchat-widget-button"},this.container);c.insertElement("span",{className:"elixirchat-widget-button-counter"},e),e.addEventListener("click",this.toggleChatVisibility),this.widgetButton=e,this.injectGlobalStyles(m.DefaultWidgetGlobalStyles,this.container),this.injectGlobalStyles(u.globalAssetUrlCssVars,this.container),this.injectGlobalStyles([c.generateFontFaceRule("Graphik","normal",u.assetsBase64.GraphikRegularWeb)].join("\n"))}},{key:"appendChatIframe",value:function(){var e=c.insertElement("iframe",{hidden:!0,className:"elixirchat-widget-iframe"},this.container);e.contentWindow.document.body.appendChild(c.insertElement("main")),this.widgetChatIframe&&this.widgetChatIframe.remove(),this.widgetChatIframe=e;var i=e.contentWindow.document.querySelector("main");this.widgetChatReactComponent=d.appendWidgetIframeContent(i,this),this.injectIframeStyles(this.iframeStyles),this.injectIframeStyles(u.iframeAssetUrlCssVars),this.injectIframeStyles([c.generateFontFaceRule("Graphik","normal",u.assetsBase64.GraphikRegularWeb),c.generateFontFaceRule("Graphik","bold",u.assetsBase64.GraphikBoldWeb)].join("\n"))}},{key:"appendImagePreview",value:function(){var e=this,i=c.insertElement("div",{className:"elixirchat-widget-image-preview"},this.container),t=c.insertElement("div",{className:"elixirchat-widget-image-preview__inner"},i),a=c.insertElement("img",{className:"elixirchat-widget-image-preview__img"},t);i.onclick=function(){return e.closeImagePreview()},a.onerror=function(){a.classList.add("elixirchat-widget-image-preview__img--error"),a.classList.remove("elixirchat-widget-image-preview__img--loading")},a.onload=function(){a.classList.remove("elixirchat-widget-image-preview__img--error","elixirchat-widget-image-preview__img--loading")},this.widgetImagePreview=i,this.widgetImagePreviewImg=a}},{key:"calculateImagePreviewSize",value:function(e,i){var t=window.innerWidth-this.imagePreviewHorizontalPaddings,a=e,r=i;if(e>t){var n=t/e;a=t,r=Math.round(i*n)}return{width:a,height:r}}},{key:"calculateImagePreviewTopMargin",value:function(e){var i=window.innerHeight-this.imagePreviewVerticalPaddings;return i<e?0:(i-e)/2}},{key:"openImagePreview",value:function(e){var i=e.width,t=e.height,a=e.url,r=e.name,n=this.calculateImagePreviewSize(i,t);this.widgetImagePreviewImg.style.marginTop=this.calculateImagePreviewTopMargin(n.height)+"px",this.widgetImagePreviewImg.width=n.width,this.widgetImagePreviewImg.height=n.height,this.widgetImagePreviewImg.src=a,this.widgetImagePreviewImg.alt=r,this.widgetImagePreviewImg.classList.add("elixirchat-widget-image-preview__img--loading"),this.widgetImagePreviewIsVisible=!0,this.widgetImagePreview.classList.add("elixirchat-widget-image-preview--visible")}},{key:"closeImagePreview",value:function(){this.widgetImagePreviewIsVisible=!1,this.widgetImagePreview.classList.remove("elixirchat-widget-image-preview--visible")}}]),t}();exports.ElixirChatWidget=w,"undefined"!=typeof window&&(window.ElixirChatWidget=w);
