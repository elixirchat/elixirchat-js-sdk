...
"use strict";function e(e,n,t,r,o,i,a){try{var c=e[i](a),u=c.value}catch(f){return void t(f)}c.done?n(u):Promise.resolve(u).then(r,o)}function n(n){return function(){var t=this,r=arguments;return new Promise(function(o,i){var a=n.apply(t,r);function c(n){e(a,o,i,c,u,"next",n)}function u(n){e(a,o,i,c,u,"throw",n)}c(void 0)})}}function t(e){return(t="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function r(e,n,r){var o=document.createElement(e);if("object"===t(n))for(var i in n)o[i]=n[i];return r&&r.appendChild(o),o}function o(e,n,t,r){var o={"en-US":function(e,n){return 1===e?n[0]:n[1]},"ru-RU":function(e,n){return n[e%100>4&&e%100<20?2:[2,0,1,1,1,2][Math.min(e%10,5)]]}},i=o[e](n,t)||t[0];return r?i:n+" "+i}function i(e,n){if("en-US"===e)return n;var t=n,r={"в понедельник":"в понедельник","в вторник":"во вторник","в среда":"в среду","в четверг":"в четверг","в пятница":"в пятницу","в суббота":"в субботу","в воскресенье":"в воскресенье"};for(var o in r){var i=new RegExp(o,"ig");t=t.replace(i,r[o])}return t}function a(){var e=new AudioContext,n=e.createBiquadFilter();n.type="notch",n.frequency.value=780,n.Q.value=1.5,n.connect(e.destination);var t=e.createGain();t.gain.exponentialRampToValueAtTime(1e-4,e.currentTime+1),t.connect(n);var r=e.createOscillator();r.frequency.value=830.6,r.connect(t),r.start(0),r.stop(1.65);var o=e.createGain();o.gain.exponentialRampToValueAtTime(1e-4,e.currentTime+1.5),o.connect(n);var i=e.createOscillator();i.frequency.value=440,i.connect(o),i.start(.15),i.stop(1.65)}function c(e,n,t){return'@font-face {\n    font-family: "'.concat(e,'";\n    ').concat(n?"font-weight: ".concat(n,";"):"",'\n    src: url("').concat(t,'") format("woff");\n  }')}function u(e){return["image/jpg","image/jpeg","image/png","image/gif"].includes(e.toLowerCase())}function f(e,n){var t=n/1024,r=t/1024,o=r/1024,i=t,a="kb";return o>1?(i=o,a="gb"):r>1&&(i=r,a="mb"),(i=i<.1?.1:+i.toFixed(1)).toLocaleString(e)+" "+{"ru-RU":{kb:"Кб",mb:"Мб",gb:"Гб"},"en-US":{kb:"Kb",mb:"Mb",gb:"Gb"}}[e||"en-US"][a]}function s(e){return l.apply(this,arguments)}function l(){return(l=n(regeneratorRuntime.mark(function e(n){return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",new Promise(function(e){var t=new Image;t.onload=function(){e({width:t.width,height:t.height})},t.onerror=function(){e({width:0,height:0})},t.src=n}));case 1:case"end":return e.stop()}},e)}))).apply(this,arguments)}Object.defineProperty(exports,"__esModule",{value:!0}),exports.insertElement=r,exports.inflect=o,exports.inflectDayJSWeekDays=i,exports.playNotificationSound=a,exports.generateFontFaceRule=c,exports.isWebImage=u,exports.getHumanReadableFileSize=f,exports.getImageDimensions=s;
