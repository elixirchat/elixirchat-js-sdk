...
"use strict";function _typeof(t){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t})(t)}function logEvent(){var t=arguments.length>0&&void 0!==arguments[0]&&arguments[0],o=arguments.length>1?arguments[1]:void 0,n=arguments.length>2?arguments[2]:void 0,e=arguments.length>3&&void 0!==arguments[3]?arguments[3]:"info";if(t&&window.console){var r="error"===e?"#EB3223;":"",i="\n       font-weight: bold;\n       color: ".concat(r,"\n    "),l="\n      font-weight: normal;\n      text-decoration: underline;\n      color: ".concat(r,"\n    "),c="\n      font: 10px Arial;\n      padding-left: 3px;\n      color: ".concat(r,"\n    ");console.groupCollapsed("%cElixirChat: ".concat(o," %cInfo%c▾"),i,l,c),"object"!==_typeof(n)||n instanceof Array?console.log("%c\nData:\n","font-weight: bold;",n):Object.keys(n).forEach(function(t){console.log("%c".concat(t,":\n"),"font-weight: bold;",n[t],"\n")}),console.log("%c\nStacktrace:","font-weight: bold;"),console.trace(),console.groupEnd()}}function capitalize(t){return t.substr(0,1).toUpperCase()+t.substr(1)}function randomDigitStringId(t){return(Array(t).join("0")+Math.random()).slice(-t)}function parseUrl(t){var o=document.createElement("a");return o.href=t,o}function _get(object,path,defaultValue){try{return eval("object."+path)}catch(e){return defaultValue}}function _omit(t,o){var n={};for(var e in t)o.includes(e)||(n[e]=t[e]);return n}function _merge(t,o){var n={};for(var e in t)n[e]=t[e];for(var r in o)o[r]&&(n[r]=o[r]);return n}function _last(t){return t[t.length-1]}function _round(t){return+t.toFixed(2)}function _isEqualShallow(t,o){if(Object.keys(t).length!==Object.keys(o).length)return!1;for(var n in t)if(t[n]!==o[n])return!1;return!0}Object.defineProperty(exports,"__esModule",{value:!0}),exports.logEvent=logEvent,exports.capitalize=capitalize,exports.randomDigitStringId=randomDigitStringId,exports.parseUrl=parseUrl,exports._get=_get,exports._omit=_omit,exports._merge=_merge,exports._last=_last,exports._round=_round,exports._isEqualShallow=_isEqualShallow;
},{}],"4KO9":[function(require,module,exports) {
"use strict";function e(e,t,n,r,o,i,a){try{var u=e[i](a),c=u.value}catch(f){return void n(f)}u.done?t(c):Promise.resolve(c).then(r,o)}function t(t){return function(){var n=this,r=arguments;return new Promise(function(o,i){var a=t.apply(n,r);function u(t){e(a,o,i,u,c,"next",t)}function c(t){e(a,o,i,u,c,"throw",t)}u(void 0)})}}function n(e,t){return i(e)||o(e,t)||r()}function r(){throw new TypeError("Invalid attempt to destructure non-iterable instance")}function o(e,t){var n=[],r=!0,o=!1,i=void 0;try{for(var a,u=e[Symbol.iterator]();!(r=(a=u.next()).done)&&(n.push(a.value),!t||n.length!==t);r=!0);}catch(c){o=!0,i=c}finally{try{r||null==u.return||u.return()}finally{if(o)throw i}}return n}function i(e){if(Array.isArray(e))return e}function a(e){return(a="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function u(e,t,n){var r=document.createElement(e);if("object"===a(t))for(var o in t)r[o]=t[o];return n&&n.appendChild(r),r}function c(e,t,n,r){var o={"en-US":function(e,t){return 1===e?t[0]:t[1]},"ru-RU":function(e,t){return t[e%100>4&&e%100<20?2:[2,0,1,1,1,2][Math.min(e%10,5)]]}},i=o[e](t,n)||n[0];return r?i:t+" "+i}function f(){var e=new AudioContext,t=e.createBiquadFilter();t.type="notch",t.frequency.value=780,t.Q.value=1.5,t.connect(e.destination);var n=e.createGain();n.gain.exponentialRampToValueAtTime(1e-4,e.currentTime+1),n.connect(t);var r=e.createOscillator();r.frequency.value=830.6,r.connect(n),r.start(0),r.stop(1.65);var o=e.createGain();o.gain.exponentialRampToValueAtTime(1e-4,e.currentTime+1.5),o.connect(t);var i=e.createOscillator();i.frequency.value=440,i.connect(o),i.start(.15),i.stop(1.65)}function s(e,t,n){return'@font-face {\n    font-family: "'.concat(e,'";\n    font-weight: ').concat(t,';\n    src: url("').concat(n,'") format("woff");\n  }')}function l(e,t){return e.replace(/var\(--([a-z0-9_]+)\)/gim,function(e,n){return t[n]})}function p(e){var t={};return e.trim().replace(/^.*{/gm,"").replace(/}$/,"").split("--").filter(function(e){return/url\(/i.test(e)}).forEach(function(e){var r=n(e.trim().replace(/^([a-z0-9]+)\s*:\s*/i,"$1@@@").split("@@@"),2),o=r[0],i=r[1];o=o.trim(),i=i.trim().replace(/;$/,""),t[o]=i}),t}function m(){var e=window.CSS&&window.CSS.supports.bind(window.CSS)||window.supportsCSS;return!!e&&(e("--f:0")||e("--f",0))}function v(e){return["image/jpg","image/jpeg","image/png","image/gif"].includes(e.toLowerCase())}function y(e,t){var n=t/1024,r=n/1024,o=r/1024,i=n,a="kb";return o>1?(i=o,a="gb"):r>1&&(i=r,a="mb"),(i=i<.1?.1:+i.toFixed(1)).toLocaleString(e)+" "+{"ru-RU":{kb:"Кб",mb:"Мб",gb:"Гб"},"en-US":{kb:"Kb",mb:"Mb",gb:"Gb"}}[e||"en-US"][a]}function b(e){return d.apply(this,arguments)}function d(){return(d=t(regeneratorRuntime.mark(function e(t){return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",new Promise(function(e){var n=new Image;n.onload=function(){e({width:n.width,height:n.height})},n.onerror=function(){e({width:0,height:0})},n.src=t}));case 1:case"end":return e.stop()}},e)}))).apply(this,arguments)}Object.defineProperty(exports,"__esModule",{value:!0}),exports.insertElement=u,exports.inflect=c,exports.playNotificationSound=f,exports.generateFontFaceRule=s,exports.replaceCssVariables=l,exports.parseCssVariables=p,exports.areCssVariablesSupported=m,exports.isWebImage=v,exports.getHumanReadableFileSize=y,exports.getImageDimensions=b;
