...
"use strict";function capitalize(t){return t.substr(0,1).toUpperCase()+t.substr(1)}function randomDigitStringId(t){return(Array(t).join("0")+Math.random()).slice(-t)}function _last(t){return t[t.length-1]}function _round(t){return+t.toFixed(2)}function _flatten(t){for(var e=[],r=0;r<t.length;r++){var o=t[r];o instanceof Array?e=e.concat(o):e.push(o)}return e}function _find(t,e,r){for(var o="function"==typeof e?e:function(t){for(var r in e)if(e[r]!==t[r])return!1;return!0},n=0;n<t.length;n++){var i=t[n];if(o(i))return r?n:i}}function _findIndex(t,e){return _find(t,e,!0)}function _uniqBy(t,e){var r={},o="string"==typeof e?function(t){return t[e]}:e;return t.filter(function(t){var e=o(t);return!r[e]&&(r[e]=!0,!0)})}function template(t,e){return(t||"").toString().replace(/{{\s*([a-z0-9]+)\s*}}/gi,function(t,r){return e[r]||""})}function detectBrowser(){var t={Opera:"opera",Chrome:"chrome",Safari:"safari",Firefox:"firefox",MSIE:"ie"};for(var e in t)if(navigator.userAgent.indexOf(e)>-1)return t[e];return null}function detectPlatform(){return{isWindows:navigator.platform.indexOf("Win")>-1,isMac:navigator.platform.indexOf("Mac")>-1}}function getJSONFromLocalStorage(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"",r=e;try{null===(r=JSON.parse(localStorage.getItem(t)))&&(r=e)}catch(o){}return r}function setToLocalStorage(t,e){localStorage.setItem(t,JSON.stringify(e))}function isWebImage(t){return["image/jpg","image/jpeg","image/png","image/gif"].includes(t.toLowerCase())}function isWebVideo(t){return"video/mp4"===t.toLowerCase().trim()}function getUserFullName(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:" ";return[((null==t?void 0:t.firstName)||"").trim(),((null==t?void 0:t.lastName)||"").trim()].filter(function(t){return t}).join(e)}function trimEachRow(t){return t.split(/\n/).map(function(t){return t.trim()}).join("\n")}function extractSerializedData(t,e){var r={};for(var o in e)r[o]=(null==t?void 0:t[o])||e[o];return r}function testFunc(t){window.__arguments8=arguments,window.__this8=this,window.__callback8=t;var e=new Error,r=e.stack.split("\n")[2],o=r.split(":")[1],n=r.split(" ")[5]+":"+o;console.warn("TEST F",arguments,"///",n,e.stack),window.__stack=e.stack,t&&t("yyy")}Object.defineProperty(exports,"__esModule",{value:!0}),exports.testFunc=exports.extractSerializedData=exports.trimEachRow=exports.getUserFullName=exports.isWebVideo=exports.isWebImage=exports.setToLocalStorage=exports.getJSONFromLocalStorage=exports.detectPlatform=exports.detectBrowser=exports.template=exports._uniqBy=exports._findIndex=exports._find=exports._flatten=exports._round=exports._last=exports.randomDigitStringId=exports.capitalize=void 0,exports.capitalize=capitalize,exports.randomDigitStringId=randomDigitStringId,exports._last=_last,exports._round=_round,exports._flatten=_flatten,exports._find=_find,exports._findIndex=_findIndex,exports._uniqBy=_uniqBy,exports.template=template,exports.detectBrowser=detectBrowser,exports.detectPlatform=detectPlatform,exports.getJSONFromLocalStorage=getJSONFromLocalStorage,exports.setToLocalStorage=setToLocalStorage,exports.isWebImage=isWebImage,exports.isWebVideo=isWebVideo,exports.getUserFullName=getUserFullName,exports.trimEachRow=trimEachRow,exports.extractSerializedData=extractSerializedData,exports.testFunc=testFunc;
...
},{"./utilsCommon":"EjGt","./widget/DefaultWidget/assets":"GpM8","dayjs":"dZYI","dayjs/plugin/calendar":"B5kD","dayjs/locale/ru":"ZQMA"}],"vlE8":[function(require,module,exports) {
...
},{"./ElixirChatWidgetEventTypes":"b9rh","../utilsCommon":"EjGt"}],"BHaV":[function(require,module,exports) {
...
},{"../utilsCommon":"EjGt","../widget/ElixirChatWidgetEventTypes":"b9rh"}],"QKUj":[function(require,module,exports) {
...
},{}],"aqDY":[function(require,module,exports) {
...
},{"react":"n8MK","classnames":"qb7c","../ElixirChatWidgetEventTypes":"b9rh","../../sdk/ElixirChatEventTypes":"JO9f","../../utilsWidget":"KO9y"}],"aiq6":[function(require,module,exports) {
...
},{"react":"n8MK","classnames":"qb7c","../ElixirChatWidgetEventTypes":"b9rh","../../utilsWidget":"KO9y"}],"xqZa":[function(require,module,exports) {
