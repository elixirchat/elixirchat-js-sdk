  ...
  _createClass(DefaultWidgetMessages, [{
    ...
    value: function render() {
      ...
      return react_1.default.createElement("div", {
        ...
        return react_1.default.createElement(react_1.Fragment, {
        ...
        }, message.sender.isCurrentClient ? 'Я' : (message.sender.firstName || '') + ' ' + (message.sender.lastName || '')), Boolean(message.responseToMessage) && react_1.default.createElement("div", {
          className: "elixirchat-chat-messages__reply-to"
        }, react_1.default.createElement("i", {
          className: "elixirchat-chat-messages__reply-to-icon"
        ...
        }, message.responseToMessage.text.substr(0, 100))), react_1.default.createElement("div", {
          ...
          return react_1.default.createElement("li", {
            ...
            className: "elixirchat-chat-files__preview-spinner"
          })), react_1.default.createElement("div", {
        ...
        }))), Boolean(message.images) && Boolean(message.images.length) && react_1.default.createElement("div", {
          className: "elixirchat-chat-messages__balloon-"
          ...
          return react_1.default.createElement("li", {
            ...
            onError: function onError(e) {
              return e.target.classList.add('elixirchat-chat-images__img-not-found');
            }
          })));
        }))), react_1.default.createElement("div", {
          ...
          className: "elixirchat-chat-messages__reply",
  ...
  _createClass(DefaultWidgetTextarea, [{
    ...
    value: function componentDidUpdate(prevProps) {
      var _this$props5 = this.props,
          textareaAttachments = _this$props5.textareaAttachments,
          textareaResponseToMessageId = _this$props5.textareaResponseToMessageId;
    ...
    value: function render() {
      ...
      return react_1.default.createElement("div", {
        ...
        className: "elixirchat-chat-textarea__reply-to-icon"
      }), react_1.default.createElement("span", {
        ...
        className: "elixirchat-chat-textarea__reply-to-remove",
...
function (_react_1$Component) {
  ...
  function DefaultWidget() {
    ...
    _this.updateUnseenRepliesToCurrentClient = function () {
      var messages = _this.state.messages;
      var elixirChatWidget = _this.props.elixirChatWidget;
      var repliesToCurrentClient = messages.filter(function (message) {
      ...
      if (elixirChatWidget.widgetIsVisible) {
        var latestReplyToCurrentClient = utilsCommon_1._last(repliesToCurrentClient);
        ...
        var latestUnseenReplyIndex = repliesToCurrentClient.map(function (message) {
          return message.id;
        }).indexOf(latestUnseenReplyId);
        var unseenRepliesToCurrentClient = latestUnseenReplyIndex === -1 ? repliesToCurrentClient : repliesToCurrentClient.slice(latestUnseenReplyIndex + 1);
  ...
  _createClass(DefaultWidget, [{
    ...
    value: function componentDidMount() {
      ...
      elixirChatWidget.onConnectError(function () {
        _this2.setState({
          isLoading: false,
          isLoadingError: true
        });
...
function appendWidgetIframeContent(container, elixirChatWidget) {
  var component;
...
},{"react":"1n8/","react-dom":"NKHc","../../utilsCommon":"EjGt","../../utilsWidget":"4KO9","./DefaultWidgetMessages":"Q0s5","./DefaultWidgetTextarea":"5K0r","./styles":"xqZa"}],"GpM8":[function(require,module,exports) {
"use strict";
/**
...
var ChatReplyRightIconBlack = dataUrlSvg + "";
var ChatReplyRightIconWhite = dataUrlSvg + "";
var ChatReplyRightIconBlue = dataUrlSvg + "";
...
var ChatScreenshotIconWhite = dataUrlSvg + "";
...
var SpinnerXsBlack = dataUrlSvg + "";
exports.assetsBase64 = {
  ...
  ChatReplyRightIconBlack: ChatReplyRightIconBlack,
  ChatReplyRightIconWhite: ChatReplyRightIconWhite,
  ChatReplyRightIconBlue: ChatReplyRightIconBlue,
  ChatScreenshotIconBlack: ChatScreenshotIconBlack,
  ChatScreenshotIconBlue: ChatScreenshotIconBlue,
  ChatScreenshotIconWhite: ChatScreenshotIconWhite,
  ChatTypingIconBlack: ChatTypingIconBlack,
  WidgetIconChat: WidgetIconChat,
  WidgetIconClose: WidgetIconClose,
  SpinnerXsBlack: SpinnerXsBlack
};
/**
...
function (_ElixirChat) {
  ...
  function ElixirChatWidget() {
    ...
    function () {
      ...
      regeneratorRuntime.mark(function _callee(_ref) {
        var container, _ref$iframeStyles, iframeStyles, _ref$visibleByDefault, visibleByDefault, errorMessage;

        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                container = _ref.container, _ref$iframeStyles = _ref.iframeStyles, iframeStyles = _ref$iframeStyles === void 0 ? '' : _ref$iframeStyles, _ref$visibleByDefault = _ref.visibleByDefault, visibleByDefault = _ref$visibleByDefault === void 0 ? false : _ref$visibleByDefault;
  ...
  _createClass(ElixirChatWidget, [{
    ...
    value: function appendWidgetButton() {
      ...
      this.injectGlobalStyles([utilsWidget_1.generateFontFaceRule('Graphik', 'normal', assets_1.assetsBase64.GraphikRegularWeb)].join('\n'));
    }
  }, {
    ...
    value: function appendChatIframe() {
      ...
      return new Promise(function (resolve) {
        ...
        iframe.onload = function () {
          ...
          _this2.widgetChatReactComponent = DefaultWidget_1.appendWidgetIframeContent(iframeContainer, _this2);

          _this2.injectIframeStyles(_this2.iframeStyles);

          _this2.injectIframeStyles(assets_1.iframeAssetUrlCssVars);

          _this2.injectIframeStyles([utilsWidget_1.generateFontFaceRule('Graphik', 'normal', assets_1.assetsBase64.GraphikRegularWeb), utilsWidget_1.generateFontFaceRule('Graphik', 'bold', assets_1.assetsBase64.GraphikBoldWeb)].join('\n'));
    ...
    value: function appendImagePreview() {
      ...
      var imagePreviewImgClassNameError = 'elixirchat-widget-image-preview__img--error';
...
},{"babel-polyfill":"wllv","../utilsCommon":"EjGt","../utilsWidget":"4KO9","./DefaultWidget/DefaultWidget":"Fn99","./DefaultWidget/assets":"GpM8","./DefaultWidget/styles":"xqZa"}],"7QCb":[function(require,module,exports) {
"use strict";
