...
function (_ElixirChat) {
  ...
  _createClass(ElixirChatWidget, [{
    ...
    value: function appendWidgetButton() {
      ...
      this.injectGlobalStyles([utilsWidget_1.generateFontFaceRule('Graphik', 'normal', assets_1.fontsBase64.GraphikRegularWeb), utilsWidget_1.generateFontFaceRule('elixirchat-icons', null, assets_1.fontsBase64.elixirchatIcons)].join('\n'));
      this.injectGlobalStyles(styles_1.DefaultWidgetGlobalStyles, this.container);
      this.injectGlobalStyles(styles_1.iconsStyles, this.container);
    }
  }, {
    ...
    value: function appendChatIframe() {
      ...
      return new Promise(function (resolve) {
        ...
        iframe.onload = function () {
          ...
          _this2.injectIframeStyles([utilsWidget_1.generateFontFaceRule('Graphik', 'normal', assets_1.fontsBase64.GraphikRegularWeb), utilsWidget_1.generateFontFaceRule('Graphik', 'bold', assets_1.fontsBase64.GraphikBoldWeb), utilsWidget_1.generateFontFaceRule('elixirchat-icons', null, assets_1.fontsBase64.elixirchatIcons)].join('\n'));

          _this2.injectIframeStyles(_this2.iframeStyles);

          _this2.injectIframeStyles(styles_1.iconsStyles);
...
},{"babel-polyfill":"wllv","../utilsCommon":"EjGt","../utilsWidget":"4KO9","./DefaultWidget/DefaultWidget":"Fn99","./DefaultWidget/styles":"xqZa","./DefaultWidget/assets":"GpM8"}],"7QCb":[function(require,module,exports) {
"use strict";
