...
"use strict";function e(){var t=n(["\n  fragment fragmentUser on Account {\n    __typename\n    id\n\n    ... on Client {\n      firstName\n      lastName\n      foreignId\n    }\n    \n    ... on Employee {\n      firstName\n      lastName\n    }\n\n    ... on Bot {\n      firstName\n    }\n  }\n"]);return e=function(){return t},t}function n(e,n){return n||(n=e.slice(0)),Object.freeze(Object.defineProperties(e,{raw:{value:Object.freeze(n)}}))}Object.defineProperty(exports,"__esModule",{value:!0});var t=require("../GraphQLClient"),r=require("../../utilsCommon");function i(e,n){var t=r._get(e,"foreignId")||null,i="Client"!==r._get(e,"__typename");return{id:r._get(e,"id")||null,firstName:r._get(e,"firstName")||r._get(e,"employee.firstName")||"",lastName:r._get(e,"lastName")||r._get(e,"employee.lastName")||"",isCurrentClient:t===n.client.id,isOperator:i,elixirChatId:t}}exports.fragmentUser=t.gql(e()),exports.serializeUser=i;
