...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=require("../../utilsCommon");function t(i,l){var n=i||{},r=null;n.thumbnails&&n.thumbnails.length&&(r=n.thumbnails.map(function(e){var i=t(e,l);return{id:i.id,url:i.url,name:i.name,bytesSize:i.bytesSize,width:i.width,height:i.height,contentType:i.contentType,thumbType:e.thumbType||null}}));var u=e.parseUrl(l.apiUrl),a=u.protocol+"//"+u.host+"/",h="";return n.url&&(h=/^uploads/i.test(n.url)?a+n.url:n.url),{id:n.id||null,url:h,name:n.name||"",bytesSize:n.bytesSize||0,height:n.height||0,width:n.width||0,thumbnails:r,contentType:n.contentType||null,originalFileObject:n.originalFileObject||null}}exports.serializeFile=t;
},{"../../utilsCommon":"EjGt"}],"ZEl5":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=require("../../utilsCommon"),t=require("./serializeUser"),s=require("./serializeFile");function i(i,r){var o=i.sender,l=void 0===o?{}:o,a=i.attachments,n=i.data,m=void 0===n?{}:n,u=m.responseToMessage,g=m.author,_=void 0===g?{}:g,d=Object.assign({},e._omit(l,["employee"]),e._get(l,"employee"),e._omit(_,["employee"]),e._get(_,"employee")),p=t.serializeUser(d,r),y=(a||[]).map(function(e){return s.serializeFile(e,r)}),c=e._get(u,"sender",{}),b=Object.assign({},e._omit(c,["employee"]),e._get(c,"employee")),v={id:e._get(u,"id")||null,text:e._get(u,"text")||"",sender:t.serializeUser(b,r)},x=e._get(i,"system",!1);return{id:e._get(i,"id")||null,text:e._get(i,"text",""),timestamp:e._get(i,"timestamp",""),cursor:e._get(i,"cursor")||null,sender:p,responseToMessage:v.id?v:null,attachments:y,isSubmitting:e._get(i,"isSubmitting")||!1,isSubmissionError:e._get(i,"isSubmissionError")||!1,isSystem:x,systemData:x?{type:e._get(i,"data.type")||null}:null}}exports.serializeMessage=i;
},{"../../utilsCommon":"EjGt","./serializeUser":"1lqy","./serializeFile":"sQAQ"}],"1fv+":[function(require,module,exports) {
"use strict";function e(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function t(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function n(e,n,r){return n&&t(e.prototype,n),r&&t(e,r),e}Object.defineProperty(exports,"__esModule",{value:!0});var r=function(){function t(n){var r=n.url,a=n.token;e(this,t),this.headers={Accept:"application/json"},this.url=r,this.token=a,this.token&&(this.headers.Authorization="Bearer ".concat(this.token))}return n(t,[{key:"makeFormData",value:function(e,t){var n=new FormData,r={roomId:t.roomId,text:t.text,attachments:t.attachments.map(function(e){return e.name}),responseToMessageId:t.responseToMessageId};return n.append("query",e),n.append("variables",JSON.stringify(r)),t.attachments.forEach(function(e){n.append(e.name,e)}),n}},{key:"query",value:function(e,t){var n,r,a=this;return(arguments.length>2&&void 0!==arguments[2]?arguments[2]:{asFormData:!1}).asFormData?(r=this.makeFormData(e,t),n=this.headers):(r=JSON.stringify({query:e,variables:t}),n=Object.assign({},this.headers,{"Content-Type":"application/json"})),new Promise(function(e,t){fetch(a.url,{method:"POST",headers:n,body:r}).then(function(e){return e.json()}).then(function(n){n.errors?t(n):e(n.data)}).catch(function(e){return t(e)})})}}]),t}();exports.GraphQLClient=r,exports.simplifyGraphQLJSON=function(e){return e.edges.map(function(e){return Object.assign({},e.node,{cursor:e.cursor})})},exports.gql=function(e){return e.join("")};
},{}],"y8vH":[function(require,module,exports) {
"use strict";function e(e){return s(e)||t(e)||n()}function n(){throw new TypeError("Invalid attempt to spread non-iterable instance")}function t(e){if(Symbol.iterator in Object(e)||"[object Arguments]"===Object.prototype.toString.call(e))return Array.from(e)}function s(e){if(Array.isArray(e)){for(var n=0,t=new Array(e.length);n<e.length;n++)t[n]=e[n];return t}}function r(){var e=o(["\n    query ($beforeCursor: String, $limit: Int!) {\n      messages(before: $beforeCursor, last: $limit) {\n        edges {\n          cursor\n          node {\n            id\n            text\n            timestamp\n            system\n            attachments {\n              id\n              url\n              name\n              bytesSize\n              height\n              width\n              contentType\n              thumbnails { id url name bytesSize height width contentType thumbType }\n            }\n            data {\n              ... on NotSystemMessageData {\n                responseToMessage {\n                  id\n                  text\n                  sender {\n                    __typename\n                    ... on Client { id foreignId firstName lastName }\n                    ... on CompanyEmployee {\n                      employee { id firstName lastName }\n                    }\n                  }\n                }\n              }\n              ... on SystemMessageData {\n                type\n                author {\n                  employee { id firstName lastName }\n                }\n              }\n\n            }\n            sender {\n              __typename\n              ... on Client { id foreignId firstName lastName }\n              ... on CompanyEmployee {\n                employee { id firstName lastName }\n              }\n            }\n          }\n        }\n      }\n    }\n  "]);return r=function(){return e},e}function i(){var e=o(["\n    mutation ($text: String!, $responseToMessageId: ID, $attachments: [Upload!]) {\n      sendMessage(text: $text, responseToMessageId: $responseToMessageId, attachments: $attachments) {\n        id\n        text\n        timestamp\n        system\n        attachments {\n          id\n          url\n          name\n          bytesSize\n          height\n          width\n          contentType\n          thumbnails { id url name bytesSize height width contentType thumbType }\n        }\n        data {\n          ... on NotSystemMessageData {\n            responseToMessage {\n              id\n              text\n              sender {\n                __typename\n                ... on Client { id foreignId firstName lastName }\n                ... on CompanyEmployee {\n                  employee { id firstName lastName }\n                }\n              }\n            }\n          }\n          ... on SystemMessageData {\n            type\n            author {\n              employee { id firstName lastName }\n            }\n          }\n\n        }\n        sender {\n          __typename\n          ... on Client { id foreignId firstName lastName }\n          ... on CompanyEmployee {\n            employee { id firstName lastName }\n          }\n        }\n      }\n    }\n  "]);return i=function(){return e},e}function a(){var e=o(["\n    subscription {\n      newMessage {\n        id\n        text\n        timestamp\n        system\n        attachments {\n          id\n          url\n          name\n          bytesSize\n          height\n          width\n          contentType\n          thumbnails { id url name bytesSize height width contentType thumbType }\n        }\n        data {\n          ... on NotSystemMessageData {\n            responseToMessage {\n              id\n              text\n              sender {\n                __typename\n                ... on Client { id foreignId firstName lastName }\n                ... on CompanyEmployee {\n                  employee { id firstName lastName }\n                }\n              }\n            }\n          }\n          ... on SystemMessageData {\n            type\n            author {\n              employee { id firstName lastName }\n            }\n          }\n        }\n        sender {\n          __typename\n          ... on Client { id foreignId firstName lastName }\n          ... on CompanyEmployee {\n            employee { id firstName lastName }\n          }\n        }\n      }\n    }\n  "]);return a=function(){return e},e}function o(e,n){return n||(n=e.slice(0)),Object.freeze(Object.defineProperties(e,{raw:{value:Object.freeze(n)}}))}function u(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}function l(e,n){for(var t=0;t<n.length;t++){var s=n[t];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(e,s.key,s)}}function c(e,n,t){return n&&l(e.prototype,n),t&&l(e,t),e}var m=this&&this.__importStar||function(e){if(e&&e.__esModule)return e;var n={};if(null!=e)for(var t in e)Object.hasOwnProperty.call(e,t)&&(n[t]=e[t]);return n.default=e,n};Object.defineProperty(exports,"__esModule",{value:!0});var h=m(require("@absinthe/socket")),f=m(require("phoenix")),y=require("./serializers/serializeMessage"),d=require("./GraphQLClient"),p=function(){function n(t){var s=this;u(this,n),this.latestMessageHistoryCursorsCache=[],this.reachedBeginningOfMessageHistory=!1,this.isBeforeUnload=!1,this.isCurrentlySubscribed=!1,this.subscriptionQuery=d.gql(a()),this.sendMessageQuery=d.gql(i()),this.messageHistoryQuery=d.gql(r()),this.onBeforeUnload=function(){return s.isBeforeUnload=!0,!1},this.unsubscribe=function(){window.removeEventListener("beforeunload",s.onBeforeUnload),s.absintheSocket=h.cancel(s.absintheSocket,s.notifier),s.latestMessageHistoryCursorsCache=[],s.reachedBeginningOfMessageHistory=!1,s.isCurrentlySubscribed=!1,s.onUnsubscribe()},this.sendMessage=function(e){var n=e.text,t=e.attachments,r=e.responseToMessageId,i=s.sendMessageQuery,a={text:n,attachments:t,responseToMessageId:r};return new Promise(function(e,n){s.graphQLClient.query(i,a,{asFormData:!0}).then(function(t){if(t&&t.sendMessage){var r=y.serializeMessage(t.sendMessage,{apiUrl:s.apiUrl,currentClientId:s.currentClientId});e(r)}else n({error:t,variables:a,query:i})}).catch(function(e){n({error:e,variables:a,query:i})})})},this.fetchMessageHistory=function(n,t){var r=s.messageHistoryQuery,i={limit:n,beforeCursor:t};return new Promise(function(a,o){s.reachedBeginningOfMessageHistory?a([]):s.graphQLClient.query(r,i).then(function(u){if(u.messages){var l=d.simplifyGraphQLJSON(u.messages).map(function(e){return y.serializeMessage(e,{apiUrl:s.apiUrl,currentClientId:s.currentClientId})}).filter(function(e){return!s.latestMessageHistoryCursorsCache.includes(e.cursor)});s.latestMessageHistoryCursorsCache=[].concat(e(l.map(function(e){return e.cursor})),e(s.latestMessageHistoryCursorsCache)).slice(0,n),l.length<n&&(s.reachedBeginningOfMessageHistory=!0),a(l)}else o({response:u,limit:n,beforeCursor:t,query:r,variables:i})}).catch(function(e){o({error:e,limit:n,beforeCursor:t,query:r,variables:i})})})},this.apiUrl=t.apiUrl,this.socketUrl=t.socketUrl,this.token=t.token,this.currentClientId=t.currentClientId,this.onSubscribeSuccess=t.onSubscribeSuccess||function(){},this.onSubscribeError=t.onSubscribeError||function(){},this.onUnsubscribe=t.onUnsubscribe||function(){},this.onMessage=t.onMessage,this.initialize()}return c(n,[{key:"initialize",value:function(){this.absintheSocket=h.create(new f.Socket(this.socketUrl,{params:{token:this.token}})),this.graphQLClient=new d.GraphQLClient({url:this.apiUrl,token:this.token}),window.addEventListener("beforeunload",this.onBeforeUnload),this.subscribe()}},{key:"subscribe",value:function(){var e=this,n=h.send(this.absintheSocket,{operation:this.subscriptionQuery});h.observe(this.absintheSocket,n,{onAbort:function(n){return e.onSubscribeAbort(n)},onStart:function(n){e.notifier=n,e.isCurrentlySubscribed||(e.isCurrentlySubscribed=!0,e.onSubscribeSuccess(n))},onResult:function(n){var t=n.data;if(t&&t.newMessage){var s=y.serializeMessage(t.newMessage,{apiUrl:e.apiUrl,currentClientId:e.currentClientId});e.onMessage(s)}}})}},{key:"onSubscribeAbort",value:function(e,n){this.onSubscribeError({error:e,variables:{methodName:n},graphQLQuery:this.subscriptionQuery})}}]),n}();exports.MessagesSubscription=p;
