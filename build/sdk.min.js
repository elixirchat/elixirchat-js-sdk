...
"use strict";function e(e){return r(e)||t(e)||s()}function s(){throw new TypeError("Invalid attempt to spread non-iterable instance")}function t(e){if(Symbol.iterator in Object(e)||"[object Arguments]"===Object.prototype.toString.call(e))return Array.from(e)}function r(e){if(Array.isArray(e)){for(var s=0,t=new Array(e.length);s<e.length;s++)t[s]=e[s];return t}}function n(){var e=o(["\n    query ($beforeCursor: String, $limit: Int!) {\n      messages(before: $beforeCursor, last: $limit) {\n        edges {\n          cursor\n          node {\n            ...fragmentMessage\n          }\n        }\n      }\n    }\n  "]);return n=function(){return e},e}function i(){var e=o(["\n    mutation ($text: String!, $responseToMessageId: ID, $attachments: [Upload!], $tempId: ID) {\n      sendMessage(text: $text, responseToMessageId: $responseToMessageId, attachments: $attachments, tempId: $tempId) {\n        ...fragmentMessage\n      }\n    }\n  "]);return i=function(){return e},e}function a(){var e=o(["\n    subscription {\n      newMessage {\n        ...fragmentMessage\n      }\n    }\n  "]);return a=function(){return e},e}function o(e,s){return s||(s=e.slice(0)),Object.freeze(Object.defineProperties(e,{raw:{value:Object.freeze(s)}}))}function g(e,s){if(!(e instanceof s))throw new TypeError("Cannot call a class as a function")}function u(e,s){for(var t=0;t<s.length;t++){var r=s[t];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function l(e,s,t){return s&&u(e.prototype,s),t&&u(e,t),e}Object.defineProperty(exports,"__esModule",{value:!0});var c=require("./ElixirChatEventTypes"),h=require("./serializers/serializeMessage"),m=require("../utilsCommon"),d=require("./GraphQLClientSocket"),p=require("./GraphQLClient"),y=function(){function s(t){var r=this,o=t.elixirChat;g(this,s),this.messageHistory=[],this.hasMessageHistoryBeenEverFetched=!1,this.temporaryMessageTempIds=[],this.latestMessageHistoryCursorsCache=[],this.reachedBeginningOfMessageHistory=!1,this.subscriptionQuery=p.insertGraphQlFragments(p.gql(a()),{fragmentMessage:h.fragmentMessage}),this.sendMessageQuery=p.insertGraphQlFragments(p.gql(i()),{fragmentMessage:h.fragmentMessage}),this.messageHistoryQuery=p.insertGraphQlFragments(p.gql(n()),{fragmentMessage:h.fragmentMessage}),this.subscribe=function(){var e=r.elixirChat,s=e.apiUrl,t=e.authToken;r.graphQLClient=new p.GraphQLClient({url:s,token:t}),r.initializeSocketClient()},this.onMessageReceive=function(e){var s,t,n=r.elixirChat,i=n.triggerEvent,a=n.debug,o=null===(t=null===(s=e)||void 0===s?void 0:s.data)||void 0===t?void 0:t.newMessage;if(o){var g=h.serializeMessage(o,r.elixirChat);r.temporaryMessageTempIds.includes(g.tempId)?r.forgetTemporaryMessage(g.tempId):(r.messageHistory.push(g),m.logEvent(a,"Received new message",{message:g}),i(c.MESSAGES_HISTORY_APPEND_ONE,g))}},this.sendMessage=function(e){var s,t=r.elixirChat.debug,n=r.serializeSendMessageParams(e),i=n.variables,a=n.binaries;if(!i.text&&!i.attachments.length){var o='Either "text" or "attachments" parameter must not be empty';return m.logEvent(t,o,{variables:i},"error"),new Promise(function(e,s){s({message:o})})}if(e.appendConditionally){s=m.randomDigitStringId(6),i.tempId=s;var g=r.generateTemporaryMessage(s,e);r.appendMessageConditionally(g)}else e.retrySubmissionByTempId&&(s=e.retrySubmissionByTempId,i.tempId=s,r.enrichTemporaryMessage(s,{isSubmitting:!0,submissionErrorCode:null}));return new Promise(function(n,o){r.graphQLClient.query(r.sendMessageQuery,i,a).then(function(a){if(a&&a.sendMessage){var g=h.serializeMessage(a.sendMessage,r.elixirChat),u=g.tempId;u?(r.enrichTemporaryMessage(u,g),m.logEvent(t,"Enriched temporary message with actual one",{message:g})):m.logEvent(t,"Sent message",{params:e,variables:i,message:g}),n(g)}else r.onSendMessageFailure(s,a),o(a)}).catch(function(e){r.onSendMessageFailure(s,e),o(e)})})},this.retrySendMessage=function(e){var s,t;r.sendMessage({text:e.text,attachments:e.attachments,responseToMessageId:null===(t=null===(s=e)||void 0===s?void 0:s.responseToMessage)||void 0===t?void 0:t.id,retrySubmissionByTempId:e.tempId})},this.getMessageHistoryByCursor=function(s,t){var n=r.elixirChat.triggerEvent;return new Promise(function(i,a){r.reachedBeginningOfMessageHistory?i([]):r.graphQLClient.query(r.messageHistoryQuery,{limit:s,beforeCursor:t}).then(function(t){if(t&&t.messages){var o=r.hasMessageHistoryBeenEverFetched,g=p.simplifyGraphQLJSON(t.messages).map(function(e){return h.serializeMessage(e,r.elixirChat)}).filter(function(e){return!r.latestMessageHistoryCursorsCache.includes(e.cursor)});r.hasMessageHistoryBeenEverFetched=!0,r.latestMessageHistoryCursorsCache=[].concat(e(g.map(function(e){return e.cursor})),e(r.latestMessageHistoryCursorsCache)).slice(0,s),r.reachedBeginningOfMessageHistory=g.length<s,r.reachedBeginningOfMessageHistory&&g.unshift(r.generateNewClientPlaceholderMessage(g)),n(o?c.MESSAGES_FETCH_HISTORY_SUCCESS:c.MESSAGES_FETCH_HISTORY_INITIAL_SUCCESS,g),i(g)}else r.onGetMessageHistoryByCursorFailure(t),a(t)}).catch(function(e){r.onGetMessageHistoryByCursorFailure(e),a(e)})})},this.fetchMessageHistory=function(e){var s=r.elixirChat,t=s.triggerEvent,n=s.debug;return r.getMessageHistoryByCursor(e,null).then(function(e){return r.messageHistory=e,m.logEvent(n,"Fetched new message history",{processedMessageHistory:e}),t(c.MESSAGES_HISTORY_SET,e),e})},this.fetchPrecedingMessageHistory=function(e){var s=r.elixirChat,t=s.triggerEvent,n=s.debug,i=r.messageHistory[0].cursor;return i?r.getMessageHistoryByCursor(e,i).then(function(e){return r.messageHistory=e.concat(r.messageHistory),m.logEvent(n,"Fetched and prepended additional message history",{processedMessageHistory:e}),t(c.MESSAGES_HISTORY_PREPEND_MANY,e),e}):new Promise(function(e,s){var t="Failed to fetch previous message history - cursors not found";m.logEvent(n,t),s({message:t})})},this.unsubscribe=function(){var e=r.elixirChat.debug;m.logEvent(e,"Unsubscribing from messages..."),r.graphQLClientSocket.unsubscribe(),r.graphQLClientSocket=null,r.graphQLClient=null},this.elixirChat=o}return l(s,[{key:"initializeSocketClient",value:function(){var e=this.elixirChat,s=e.socketUrl,t=e.authToken,r=e.debug,n=e.triggerEvent;this.graphQLClientSocket=new d.GraphQLClientSocket({socketUrl:s,authToken:t,query:this.subscriptionQuery,onAbort:function(e){m.logEvent(r,"Failed to subscribe to messages",e,"error"),n(c.MESSAGES_SUBSCRIBE_ERROR,e)},onStart:function(){m.logEvent(r,"Successfully subscribed to messages"),n(c.MESSAGES_SUBSCRIBE_SUCCESS)},onResult:this.onMessageReceive})}},{key:"serializeSendMessageParams",value:function(e){var s="string"==typeof e.text?e.text.trim():"",t=e.tempId,r="string"==typeof e.responseToMessageId?e.responseToMessageId:null,n=[],i={};try{e.attachments.forEach(function(e){var s=e.file;n.push(s.name),i[s.name]=s})}catch(a){}return{variables:{text:s,tempId:t,attachments:n,responseToMessageId:r},binaries:i}}},{key:"generateNewClientPlaceholderMessage",value:function(e){var s,t;return{timestamp:(null===(t=null===(s=e)||void 0===s?void 0:s[0])||void 0===t?void 0:t.timestamp)||(new Date).toISOString(),id:m.randomDigitStringId(6),isSystem:!0,sender:{},attachments:[],responseToMessage:{},systemType:"NewClientPlaceholderMessage"}}},{key:"generateTemporaryMessage",value:function(e,s){var t=s.text,r=s.attachments,n=s.responseToMessageId,i=this.messageHistory.filter(function(e){return e.id===n})[0],a=r.map(function(e){var s=e.file,t=s.type,r=URL.createObjectURL(s),n=[];return m.isWebImage(t)&&e.width&&e.height&&(n=[{id:e.id,url:r}]),Object.assign(Object.assign({},e),{url:r,thumbnails:n,contentType:t,bytesSize:s.size})});return{tempId:e,id:m.randomDigitStringId(6),text:t.trim()||"",timestamp:(new Date).toISOString(),sender:{isOperator:!1,isCurrentClient:!0},responseToMessage:i||{},attachments:a,isSubmitting:!0}}},{key:"appendMessageConditionally",value:function(e){var s=this.elixirChat,t=s.triggerEvent,r=s.debug;this.messageHistory.push(e),this.temporaryMessageTempIds.push(e.tempId),m.logEvent(r,"Conditionally appended message",{message:e}),t(c.MESSAGES_HISTORY_APPEND_ONE,e)}},{key:"enrichTemporaryMessage",value:function(e,s){var t=this.elixirChat.triggerEvent;this.messageHistory.forEach(function(r){if(r.tempId===e){for(var n in s)r[n]=s[n];t(c.MESSAGES_HISTORY_CHANGE_ONE,r)}})}},{key:"forgetTemporaryMessage",value:function(e){this.temporaryMessageTempIds=this.temporaryMessageTempIds.filter(function(s){return s!==e})}},{key:"onSendMessageFailure",value:function(e,s){var t,r,n,i=this.elixirChat.debug,a=(null===(n=null===(r=null===(t=s)||void 0===t?void 0:t.errors)||void 0===r?void 0:r[0])||void 0===n?void 0:n.status)||400;navigator.onLine||(a=503),m.logEvent(i,"Failed to send message with code: "+a,{response:s,tempId:e},"error"),e&&this.enrichTemporaryMessage(e,{isSubmitting:!1,submissionErrorCode:a})}},{key:"onGetMessageHistoryByCursorFailure",value:function(e){var s=this.elixirChat,t=s.triggerEvent,r=s.debug;this.hasMessageHistoryBeenEverFetched?(m.logEvent(r,"Failed to fetch message history",{error:e},"error"),t(c.MESSAGES_FETCH_HISTORY_ERROR,e)):(m.logEvent(r,"Failed to fetch initial message history",{error:e},"error"),t(c.MESSAGES_FETCH_HISTORY_INITIAL_ERROR,e))}}]),s}();exports.MessageSubscription=y;
