...
"use strict";function e(e,r){return i(e)||n(e,r)||t()}function t(){throw new TypeError("Invalid attempt to destructure non-iterable instance")}function n(e,t){var n=[],i=!0,r=!1,s=void 0;try{for(var o,a=e[Symbol.iterator]();!(i=(o=a.next()).done)&&(n.push(o.value),!t||n.length!==t);i=!0);}catch(c){r=!0,s=c}finally{try{i||null==a.return||a.return()}finally{if(r)throw s}}return n}function i(e){if(Array.isArray(e))return e}function r(){var e=s(["\n    mutation($companyId: Uuid!, $room: ForeignRoom, $client: ForeignClient) {\n      joinRoom (companyId: $companyId, room: $room, client: $client) {\n        token\n        company {\n          working\n          widgetTitle\n        }\n        client {\n          ...fragmentClient\n        }\n        room {\n          id\n          title\n          foreignId\n        }\n      }\n    }\n  "]);return r=function(){return e},e}function s(e,t){return t||(t=e.slice(0)),Object.freeze(Object.defineProperties(e,{raw:{value:Object.freeze(t)}}))}function o(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function a(e,t){for(var n=0;n<t.length;n++){var i=t[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}function c(e,t,n){return t&&a(e.prototype,t),n&&a(e,n),e}Object.defineProperty(exports,"__esModule",{value:!0});var u=require("unique-names-generator"),l=require("../utilsCommon"),h=require("./serializers/serializeUser"),g=require("./ScreenshotTaker"),d=require("./UnreadMessagesCounter"),m=require("./TypingStatusSubscription"),f=require("./OperatorOnlineStatusSubscription"),p=require("./MessageSubscription"),y=require("./GraphQLClient"),b=require("./ElixirChatEventTypes"),S=function(){function t(e){var n=this;o(this,t),this.widgetTitle="",this.defaultWidgetTitle="Служба поддержки",this.eventCallbacks={},this.joinRoomQuery=y.insertGraphQlFragments(y.gql(r()),{fragmentClient:h.fragmentClient}),this.markPrecedingMessagesRead=function(e){var t=n.messageHistory.map(function(e){return e.id}).indexOf(e);n.messageHistory.forEach(function(e,n){t>=n&&(e.isUnread=!1)}),n.triggerEvent(b.MESSAGES_HISTORY_CHANGE_MANY,n.messageHistory)},this.triggerEvent=function(e){for(var t=arguments.length,i=new Array(t>1?t-1:0),r=1;r<t;r++)i[r-1]=arguments[r];l.logEvent(n.debug,e,{params:i},"event");var s=n.eventCallbacks[e];s&&s.length&&s.forEach(function(e){return e.apply(void 0,i)})},this.on=function(e,t){e instanceof Array?e.map(function(e){return n.on(e,t)}):(n.eventCallbacks[e]||(n.eventCallbacks[e]=[]),n.eventCallbacks[e].push(t))},this.off=function(e,t){var i=n.eventCallbacks[e];i&&i.length&&(n.eventCallbacks[e]=i.filter(function(e){return e!==t}))},this.sendMessage=function(e){return n.isConnected?(n.typingStatusSubscription.dispatchTypedText(!1),n.messageSubscription.sendMessage(e)):n.showDisconnectedError(!0)},this.retrySendMessage=function(e){return n.isConnected?n.messageSubscription.retrySendMessage(e):n.showDisconnectedError(!0)},this.fetchMessageHistory=function(e){return n.isConnected?n.messageSubscription.fetchMessageHistory(e):n.showDisconnectedError(!0)},this.fetchPrecedingMessageHistory=function(e){return n.isConnected?n.messageSubscription.fetchPrecedingMessageHistory(e):n.showDisconnectedError(!0)},this.dispatchTypedText=function(e){if(!n.isConnected)return n.showDisconnectedError();n.typingStatusSubscription.dispatchTypedText(e)},this.setLastReadMessage=function(e){return n.isConnected?n.unreadMessagesCounter.setLastReadMessage(e):n.showDisconnectedError(!0)},this.takeScreenshot=function(){return n.screenshotTaker.takeScreenshot()},this.disconnect=function(){if(!n.isConnected)return n.showDisconnectedError();l.logEvent(n.debug,"Disconnecting from ElixirChat"),n.isConnected=!1,n.messageSubscription.unsubscribe(),n.unreadMessagesCounter.unsubscribe(),n.typingStatusSubscription.unsubscribe(),n.operatorOnlineStatusSubscription.unsubscribe()},this.reconnect=function(e){var t=e.room,i=e.client;return l.logEvent(n.debug,"Attempting to reconnect to another room",{room:t,client:i}),n.setRoomAndClient({room:t,client:i}),n.disconnect(),n.joinRoom()},this.apiUrl=e.apiUrl,this.socketUrl=e.socketUrl,this.backendStaticUrl=e.backendStaticUrl,this.companyId=e.companyId,this.debug=e.debug||!1,this.hasAllRequiredConfigParameters()&&this.initialize(e)}return c(t,[{key:"hasAllRequiredConfigParameters",value:function(){var e=this,t=["apiUrl","socketUrl","backendStaticUrl","companyId"].filter(function(t){return!e[t]});if(t.length){var n="Required parameters: ".concat(t.join(", ")," not provided. \nSee more: https://github.com/elixirchat/elixirchat-js-sdk#config");return l.logEvent(this.debug,n,null,"error"),!1}return!0}},{key:"initialize",value:function(e){var t=this;l.logEvent(this.debug,"Initializing ElixirChat",{apiUrl:this.apiUrl,socketUrl:this.socketUrl,backendStaticUrl:this.backendStaticUrl,companyId:this.companyId,room:this.room,client:this.client,debug:this.debug}),this.on(b.JOIN_ROOM_SUCCESS,function(e){l.logEvent(t.debug,"Joined room",e);var n=l._get(e,"company.working");t.messageSubscription.subscribe(),t.unreadMessagesCounter.subscribe(),t.typingStatusSubscription.subscribe(),t.operatorOnlineStatusSubscription.subscribe(n)}),this.on(b.JOIN_ROOM_ERROR,function(e){l.logEvent(t.debug,"Failed to join room",{error:e},"error")}),this.on(b.LAST_READ_MESSAGE_CHANGE,this.markPrecedingMessagesRead),this.setRoomAndClient({room:e.room,client:e.client}),this.screenshotTaker=new g.ScreenshotTaker({elixirChat:this}),this.messageSubscription=new p.MessageSubscription({elixirChat:this}),this.unreadMessagesCounter=new d.UnreadMessagesCounter({elixirChat:this}),this.typingStatusSubscription=new m.TypingStatusSubscription({elixirChat:this}),this.operatorOnlineStatusSubscription=new f.OperatorOnlineStatusSubscription({elixirChat:this}),this.joinRoom()}},{key:"setRoomAndClient",value:function(e){var t=e.room||{},n=e.client||{},i=l.getJSONFromLocalStorage("elixirchat-room")||{},r=l.getJSONFromLocalStorage("elixirchat-client")||{},s=this.generateAnonymousClientData(),o=n.id||r.id||s.id,a=n.firstName||r.firstName||s.firstName,c=n.lastName||r.lastName||s.lastName;this.client={id:o,firstName:a,lastName:c},this.isPrivate=!(t.id||i.id);var u=t.id||i.id||o,h=t.title||i.title||a+" "+c,g=t.data||{};this.room={id:u,title:h,data:g},localStorage.setItem("elixirchat-room",JSON.stringify(t)),localStorage.setItem("elixirchat-client",JSON.stringify(n)),l.logEvent(this.debug,"Set room and client values",{room:this.room,client:this.client,isPrivate:this.isPrivate})}},{key:"generateAnonymousClientData",value:function(){var t=u.uniqueNamesGenerator({length:2,separator:" ",dictionaries:null}),n=e(t.split(" ").map(l.capitalize),2),i=n[0],r=n[1],s=l.randomDigitStringId(4);return{id:t.replace(" ","-")+"-"+s,firstName:i,lastName:r}}},{key:"serializeRoomData",value:function(e){var t={};for(var n in e)t[n]=e[n].toString();return JSON.stringify(t)}},{key:"joinRoom",value:function(){var e=this;this.graphQLClient=new y.GraphQLClient({url:this.apiUrl});var t=this.joinRoomQuery,n={companyId:this.companyId,client:this.client,room:{id:this.room.id,title:this.room.title,data:this.serializeRoomData(this.room.data)}};return this.graphQLClient.query(t,n).then(function(t){var n=t.joinRoom;n?(e.isConnected=!0,e.authToken=n.token,e.widgetTitle=n.company.widgetTitle||e.defaultWidgetTitle,e.elixirChatClientId=n.client.id,e.elixirChatRoomId=n.room.id,e.triggerEvent(b.JOIN_ROOM_SUCCESS,n)):e.triggerEvent(b.JOIN_ROOM_ERROR,n)}).catch(function(t){e.triggerEvent(b.JOIN_ROOM_ERROR,t)})}},{key:"showDisconnectedError",value:function(e){var t="ElixirChat is not currently connected. Use reconnect() method to connect to another room.";if(l.logEvent(this.debug,t,null,"error"),e)return new Promise(function(e,n){n({message:t})})}},{key:"areAnyOperatorsOnline",get:function(){return this.operatorOnlineStatusSubscription.areAnyOperatorsOnline}},{key:"unreadMessagesCount",get:function(){return this.unreadMessagesCounter.unreadMessagesCount}},{key:"unreadRepliesCount",get:function(){return this.unreadMessagesCounter.unreadRepliesCount}},{key:"messageHistory",get:function(){return this.messageSubscription.messageHistory}},{key:"hasMessageHistoryBeenEverFetched",get:function(){return this.messageSubscription.hasMessageHistoryBeenEverFetched}},{key:"reachedBeginningOfMessageHistory",get:function(){return this.messageSubscription.reachedBeginningOfMessageHistory}}]),t}();exports.ElixirChat=S,"undefined"!=typeof window&&(window.ElixirChat=S);
