...
"use strict";function _toConsumableArray(e){return _arrayWithoutHoles(e)||_iterableToArray(e)||_unsupportedIterableToArray(e)||_nonIterableSpread()}function _nonIterableSpread(){throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function _unsupportedIterableToArray(e,t){if(e){if("string"==typeof e)return _arrayLikeToArray(e,t);var s=Object.prototype.toString.call(e).slice(8,-1);return"Object"===s&&e.constructor&&(s=e.constructor.name),"Map"===s||"Set"===s?Array.from(e):"Arguments"===s||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(s)?_arrayLikeToArray(e,t):void 0}}function _iterableToArray(e){if("undefined"!=typeof Symbol&&Symbol.iterator in Object(e))return Array.from(e)}function _arrayWithoutHoles(e){if(Array.isArray(e))return _arrayLikeToArray(e)}function _arrayLikeToArray(e,t){(null==t||t>e.length)&&(t=e.length);for(var s=0,r=new Array(t);s<t;s++)r[s]=e[s];return r}function _templateObject3(){var e=_taggedTemplateLiteral(["\n    query ($first: Int, $last: Int, $before: String, $after: String) {\n      messages(first: $first, last: $last, before: $before, after: $after) {\n        edges {\n          cursor\n          node {\n            ...fragmentMessage\n          }\n        }\n      }\n    }\n  "]);return _templateObject3=function _templateObject3(){return e},e}function _templateObject2(){var e=_taggedTemplateLiteral(["\n    mutation ($text: String!, $responseToMessageId: ID, $attachments: [Upload!], $tempId: ID) {\n      sendMessage(text: $text, responseToMessageId: $responseToMessageId, attachments: $attachments, tempId: $tempId) {\n        ...fragmentMessage\n      }\n    }\n  "]);return _templateObject2=function _templateObject2(){return e},e}function _templateObject(){var e=_taggedTemplateLiteral(["\n    subscription {\n      newMessage {\n        ...fragmentMessage\n      }\n    }\n  "]);return _templateObject=function _templateObject(){return e},e}function _taggedTemplateLiteral(e,t){return t||(t=e.slice(0)),Object.freeze(Object.defineProperties(e,{raw:{value:Object.freeze(t)}}))}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _defineProperties(e,t){for(var s=0;s<t.length;s++){var r=t[s];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function _createClass(e,t,s){return t&&_defineProperties(e.prototype,t),s&&_defineProperties(e,s),e}Object.defineProperty(exports,"__esModule",{value:!0}),exports.MessageSubscription=void 0;var e=require("./ElixirChatEventTypes"),t=require("./serializers/serializeMessage"),s=require("../utilsCommon"),r=require("./GraphQLClient"),a=function(){function MessageSubscription(a){var i=this,n=a.elixirChat;_classCallCheck(this,MessageSubscription),this.messageHistory=[],this.MESSAGE_HISTORY_REQUEST_INTERVAL=6e4,this.temporaryMessageTempIds=[],this.messageHistoryRequestInterval=null,this.subscriptionQuery=r.insertGraphQlFragments(r.gql(_templateObject()),{fragmentMessage:t.fragmentMessage}),this.sendMessageQuery=r.insertGraphQlFragments(r.gql(_templateObject2()),{fragmentMessage:t.fragmentMessage}),this.messageHistoryQuery=r.insertGraphQlFragments(r.gql(_templateObject3()),{fragmentMessage:t.fragmentMessage}),this.subscribe=function(){var t=i.elixirChat,s=t.graphQLClientSocket,r=t.logInfo,a=t.logError,n=t.triggerEvent;i.initializeUpdatingMessageHistoryOnInterval(),s.subscribe({query:i.subscriptionQuery,onAbort:function onAbort(t){a("MessageSubscription: Failed to subscribe",{error:t}),n(e.ERROR_ALERT,{customMessage:"MessageSubscription: Failed to subscribe",error:t,retryCallback:i.subscribe})},onStart:function onStart(){r("MessageSubscription: Subscribed")},onResult:i.onMessageReceive})},this.onMessageReceive=function(s){var r,a=i.elixirChat,n=a.triggerEvent,o=a.logInfo,g=null===(r=null==s?void 0:s.data)||void 0===r?void 0:r.newMessage;if(g){var u=t.serializeMessage(g,i.elixirChat);i.temporaryMessageTempIds.includes(u.tempId)?i.forgetTemporaryMessage(u.tempId):(i.messageHistory.push(u),o("Received new message",{message:u}),n(e.MESSAGES_RECEIVE,u))}},this.changeMessageBy=function(t,s){var r=i.elixirChat.triggerEvent;i.messageHistory=i.messageHistory.map(function(e){var r,a=Object.assign({},e);return i.doesMessageMatchQuery(e,t)&&(a=Object.assign(Object.assign({},a),s)),(null===(r=e.responseToMessage)||void 0===r?void 0:r.id)&&i.doesMessageMatchQuery(e.responseToMessage,t)&&(a.responseToMessage=Object.assign(Object.assign({},a.responseToMessage),s)),a}),r(e.MESSAGES_HISTORY_CHANGE,i.messageHistory)},this.sendMessage=function(e){var r,a=i.elixirChat,n=a.logInfo,o=a.logError,g=a.sendAPIRequest,u=(a.triggerEvent,i.serializeSendMessageParams(e)),l=u.variables,c=u.binaries;if(!l.text&&!l.attachments.length){var m='MessageSubscription: Either "text" or "attachments" parameter must not be empty';return o(m,l),Promise.reject({message:m})}if(e.appendConditionally){r=s.randomDigitStringId(6),l.tempId=r;var p=i.generateTemporaryMessage(e,{tempId:r});i.appendMessageConditionally(p)}else e.retrySubmissionByTempId&&(r=e.retrySubmissionByTempId,l.tempId=r,i.changeMessageBy({tempId:r},{isSubmitting:!0,submissionErrorCode:null}));return g(i.sendMessageQuery,l,c).then(function(s){var r=t.serializeMessage(s,i.elixirChat),a=r.tempId;return a?(n("MessageSubscription: Enriched temporary message with actual one",{sentMessage:r}),i.changeMessageBy({tempId:a},r)):n("MessageSubscription: Sent message",{textareaParams:e,variables:l,sentMessage:r}),r}).catch(function(e){var t=i.getSubmissionErrorCode(e);throw i.changeMessageBy({tempId:r},{isSubmitting:!1,submissionErrorCode:t}),e})},this.retrySendMessage=function(e){var t;return i.sendMessage({text:e.text,attachments:e.attachments,responseToMessageId:null===(t=null==e?void 0:e.responseToMessage)||void 0===t?void 0:t.id,retrySubmissionByTempId:e.tempId})},this.fetchMessageHistory=function(t){var s=i.elixirChat.triggerEvent;return i.getMessageHistoryByCursor({limit:t}).then(function(t){return s(e.MESSAGES_HISTORY_CHANGE,t),i.messageHistory=t,t})},this.fetchPrecedingMessageHistory=function(t){var r,a=i.elixirChat,n=a.logError,o=a.triggerEvent,g=null===(r=i.messageHistory[0])||void 0===r?void 0:r.cursor;if(!g){var u="MessageSubscription: Failed to fetch previous message history - cursors not found";return n(u),Promise.reject({message:u})}return i.getMessageHistoryByCursor({limit:t,beforeCursor:g}).then(function(t){return i.messageHistory=s._uniqBy([].concat(_toConsumableArray(t),_toConsumableArray(i.messageHistory)),"id"),o(e.MESSAGES_HISTORY_PREPEND,t),t})},this.markPrecedingMessagesRead=function(t){var s=i.elixirChat.triggerEvent,r=i.messageHistory.map(function(e){return e.id}).indexOf(t);i.messageHistory.forEach(function(e,t){r>=t&&(e.isUnread=!1)}),s(e.MESSAGES_HISTORY_CHANGE,i.messageHistory)},this.unsubscribe=function(){var e=i.elixirChat,t=e.graphQLClientSocket,s=e.logInfo;i.messageHistory=[],i.temporaryMessageTempIds=[],clearInterval(i.messageHistoryRequestInterval),s("MessageSubscription: Unsubscribing..."),t.unsubscribe(i.companyMessageSubscription)},this.elixirChat=n}return _createClass(MessageSubscription,[{key:"initializeUpdatingMessageHistoryOnInterval",value:function initializeUpdatingMessageHistoryOnInterval(){var e=this;clearInterval(this.messageHistoryRequestInterval),this.messageHistoryRequestInterval=setInterval(function(){var t,r=null===(t=s._last(e.messageHistory))||void 0===t?void 0:t.cursor;r&&e.getMessageHistoryByCursor({limit:10,afterCursor:r}).then(function(t){t.forEach(e.onMessageReceive)})},this.MESSAGE_HISTORY_REQUEST_INTERVAL)}},{key:"forgetTemporaryMessage",value:function forgetTemporaryMessage(e){this.temporaryMessageTempIds=this.temporaryMessageTempIds.filter(function(t){return t!==e})}},{key:"doesMessageMatchQuery",value:function doesMessageMatchQuery(e,t){for(var s in t)if(t[s]!==e[s])return!1;return!0}},{key:"getSubmissionErrorCode",value:function getSubmissionErrorCode(e){var t,s,r,a=(null===(r=null===(s=null===(t=e.rawError)||void 0===t?void 0:t.errors)||void 0===s?void 0:s[0])||void 0===r?void 0:r.status)||400;return navigator.onLine||(a=503),a}},{key:"serializeSendMessageParams",value:function serializeSendMessageParams(e){var t="string"==typeof e.text?e.text.trim():"",s=e.tempId,r="string"==typeof e.responseToMessageId?e.responseToMessageId:null,a=[],i={};try{e.attachments.forEach(function(e){var t=e.file;a.push(t.name),i[t.name]=t})}catch(n){}return{variables:{text:t,tempId:s,attachments:a,responseToMessageId:r},binaries:i}}},{key:"generateTemporaryMessage",value:function generateTemporaryMessage(e,r){var a=e.text,i=e.attachments,n=e.responseToMessageId,o=this.messageHistory.filter(function(e){return e.id===n})[0],g=i.map(function(e){var t=e.id,r=e.file,a=e.width,i=e.height,n=URL.createObjectURL(r),o=[];return"image"===s.getMediaType(r.type)&&a&&i&&(o=[{id:t,url:n}]),Object.assign(Object.assign({},e),{url:n,thumbnails:o,contentType:r.type,bytesSize:r.size})});return t.serializeMessage(Object.assign({id:s.randomDigitStringId(6),text:a.trim()||"",timestamp:(new Date).toISOString(),responseToMessage:o||{},attachments:g,isSubmitting:!0,sender:{__typename:"Client",foreignId:this.elixirChat.client.id}},r),this.elixirChat)}},{key:"appendMessageConditionally",value:function appendMessageConditionally(t){var s=this.elixirChat,r=s.triggerEvent,a=s.logInfo;this.messageHistory.push(t),this.temporaryMessageTempIds.push(t.tempId),a("Conditionally appended message",{message:t}),r(e.MESSAGES_RECEIVE,t)}},{key:"getMessageHistoryByCursor",value:function getMessageHistoryByCursor(e){var s,a=this,i=this.elixirChat.sendAPIRequest,n=e.limit,o=e.beforeCursor,g=e.afterCursor;return s=o?{last:n,before:o}:g?{first:n,after:g}:{last:n},i(this.messageHistoryQuery,s).then(function(e){return r.simplifyGraphQLJSON(e).map(function(e){return t.serializeMessage(e,a.elixirChat)})})}}]),MessageSubscription}();exports.MessageSubscription=a;
