...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=require("../../utilsCommon");function t(t,r){var i=e._get(t,"foreignId")||null;return{id:e._get(t,"id")||null,firstName:e._get(t,"firstName")||"",lastName:e._get(t,"lastName")||"",isOperator:"Client"!==e._get(t,"__typename"),isCurrentClient:i===r.currentClientId,elixirChatId:i}}exports.serializeUser=t;
},{"../../utilsCommon":"EjGt"}],"sQAQ":[function(require,module,exports) {
"use strict";function e(t,i){var l=t||{},n=null;l.thumbnails&&l.thumbnails.length&&(n=l.thumbnails.map(function(t){var l=e(t,i);return{id:l.id,url:l.url,name:l.name,bytesSize:l.bytesSize,width:l.width,height:l.height,contentType:l.contentType,thumbType:t.thumbType||null}}));var u=i.backendStaticUrl.replace(/\/$/,"")+"/",r="";return l.url&&(r=/^uploads/i.test(l.url)?u+l.url:l.url),{id:l.id||null,url:r,name:l.name||"",bytesSize:l.bytesSize||0,height:l.height||0,width:l.width||0,thumbnails:n,contentType:l.contentType||null,originalFileObject:l.originalFileObject||null}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.serializeFile=e;
},{}],"ZEl5":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=require("../../utilsCommon"),t=require("./serializeUser"),s=require("./serializeFile");function i(i,r){var l=i.sender,o=void 0===l?{}:l,n=i.attachments,a=i.data,m=void 0===a?{}:a,u=m.responseToMessage,g=m.author,_=void 0===g?{}:g,d=Object.assign({},e._omit(o,["employee"]),e._get(o,"employee"),e._omit(_,["employee"]),e._get(_,"employee")),p=t.serializeUser(d,r),y=(n||[]).map(function(e){return s.serializeFile(e,r)}),c=e._get(u,"sender",{}),b=Object.assign({},e._omit(c,["employee"]),e._get(c,"employee")),v={id:e._get(u,"id")||null,text:e._get(u,"text")||"",sender:t.serializeUser(b,r)},x=e._get(i,"system",!1);return{id:e._get(i,"id")||null,tempId:e._get(i,"tempId")||null,text:e._get(i,"text")||"",timestamp:e._get(i,"timestamp")||"",cursor:e._get(i,"cursor")||null,sender:p,responseToMessage:v.id?v:null,attachments:y,isSubmitting:e._get(i,"isSubmitting")||!1,isSubmissionError:e._get(i,"isSubmissionError")||!1,isSystem:x,systemData:x?{type:e._get(i,"data.type")||null}:null}}exports.serializeMessage=i;
},{"../../utilsCommon":"EjGt","./serializeUser":"1lqy","./serializeFile":"sQAQ"}],"1fv+":[function(require,module,exports) {
"use strict";function e(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function t(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function n(e,n,r){return n&&t(e.prototype,n),r&&t(e,r),e}Object.defineProperty(exports,"__esModule",{value:!0});var r=function(){function t(n){var r=n.url,a=n.token;e(this,t),this.headers={Accept:"application/json"},this.url=r,this.token=a,this.token&&(this.headers.Authorization="Bearer ".concat(this.token))}return n(t,[{key:"makeFormData",value:function(e,t){var n=new FormData,r={roomId:t.roomId,text:t.text,attachments:t.attachments.map(function(e){return e.name}),responseToMessageId:t.responseToMessageId,tempId:t.tempId};return n.append("query",e),n.append("variables",JSON.stringify(r)),t.attachments.forEach(function(e){n.append(e.name,e)}),n}},{key:"query",value:function(e,t){var n,r,a=this;return(arguments.length>2&&void 0!==arguments[2]?arguments[2]:{asFormData:!1}).asFormData?(r=this.makeFormData(e,t),n=this.headers):(r=JSON.stringify({query:e,variables:t}),n=Object.assign({},this.headers,{"Content-Type":"application/json"})),new Promise(function(e,t){fetch(a.url,{method:"POST",headers:n,body:r}).then(function(e){return e.json()}).then(function(n){n.errors?t(n):e(n.data)}).catch(function(e){return t(e)})})}}]),t}();exports.GraphQLClient=r,exports.simplifyGraphQLJSON=function(e){return e.edges.map(function(e){return Object.assign({},e.node,{cursor:e.cursor})})},exports.gql=function(e){return e.join("")};
},{}],"y8vH":[function(require,module,exports) {
"use strict";function e(e){return s(e)||t(e)||n()}function n(){throw new TypeError("Invalid attempt to spread non-iterable instance")}function t(e){if(Symbol.iterator in Object(e)||"[object Arguments]"===Object.prototype.toString.call(e))return Array.from(e)}function s(e){if(Array.isArray(e)){for(var n=0,t=new Array(e.length);n<e.length;n++)t[n]=e[n];return t}}function r(){var e=o(["\n    query ($beforeCursor: String, $limit: Int!) {\n      messages(before: $beforeCursor, last: $limit) {\n        edges {\n          cursor\n          node {\n            id\n            tempId\n            text\n            timestamp\n            system\n            attachments {\n              id\n              url\n              name\n              bytesSize\n              height\n              width\n              contentType\n              thumbnails { id url name bytesSize height width contentType thumbType }\n            }\n            data {\n              ... on NotSystemMessageData {\n                responseToMessage {\n                  id\n                  text\n                  sender {\n                    __typename\n                    ... on Client { id foreignId firstName lastName }\n                    ... on CompanyEmployee {\n                      employee { id firstName lastName }\n                    }\n                  }\n                }\n              }\n              ... on SystemMessageData {\n                type\n                author {\n                  employee { id firstName lastName }\n                }\n              }\n\n            }\n            sender {\n              __typename\n              ... on Client { id foreignId firstName lastName }\n              ... on CompanyEmployee {\n                employee { id firstName lastName }\n              }\n            }\n          }\n        }\n      }\n    }\n  "]);return r=function(){return e},e}function i(){var e=o(["\n    mutation ($text: String!, $responseToMessageId: ID, $attachments: [Upload!], $tempId: ID) {\n      sendMessage(text: $text, responseToMessageId: $responseToMessageId, attachments: $attachments, tempId: $tempId) {\n        id\n        tempId\n        text\n        timestamp\n        system\n        attachments {\n          id\n          url\n          name\n          bytesSize\n          height\n          width\n          contentType\n          thumbnails { id url name bytesSize height width contentType thumbType }\n        }\n        data {\n          ... on NotSystemMessageData {\n            responseToMessage {\n              id\n              text\n              sender {\n                __typename\n                ... on Client { id foreignId firstName lastName }\n                ... on CompanyEmployee {\n                  employee { id firstName lastName }\n                }\n              }\n            }\n          }\n          ... on SystemMessageData {\n            type\n            author {\n              employee { id firstName lastName }\n            }\n          }\n\n        }\n        sender {\n          __typename\n          ... on Client { id foreignId firstName lastName }\n          ... on CompanyEmployee {\n            employee { id firstName lastName }\n          }\n        }\n      }\n    }\n  "]);return i=function(){return e},e}function a(){var e=o(["\n    subscription {\n      newMessage {\n        id\n        tempId\n        text\n        timestamp\n        system\n        attachments {\n          id\n          url\n          name\n          bytesSize\n          height\n          width\n          contentType\n          thumbnails { id url name bytesSize height width contentType thumbType }\n        }\n        data {\n          ... on NotSystemMessageData {\n            responseToMessage {\n              id\n              text\n              sender {\n                __typename\n                ... on Client { id foreignId firstName lastName }\n                ... on CompanyEmployee {\n                  employee { id firstName lastName }\n                }\n              }\n            }\n          }\n          ... on SystemMessageData {\n            type\n            author {\n              employee { id firstName lastName }\n            }\n          }\n        }\n        sender {\n          __typename\n          ... on Client { id foreignId firstName lastName }\n          ... on CompanyEmployee {\n            employee { id firstName lastName }\n          }\n        }\n      }\n    }\n  "]);return a=function(){return e},e}function o(e,n){return n||(n=e.slice(0)),Object.freeze(Object.defineProperties(e,{raw:{value:Object.freeze(n)}}))}function u(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}function c(e,n){for(var t=0;t<n.length;t++){var s=n[t];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(e,s.key,s)}}function l(e,n,t){return n&&c(e.prototype,n),t&&c(e,t),e}var m=this&&this.__importStar||function(e){if(e&&e.__esModule)return e;var n={};if(null!=e)for(var t in e)Object.hasOwnProperty.call(e,t)&&(n[t]=e[t]);return n.default=e,n};Object.defineProperty(exports,"__esModule",{value:!0});var d=m(require("@absinthe/socket")),h=m(require("phoenix")),f=require("./serializers/serializeMessage"),y=require("./GraphQLClient"),b=function(){function n(t){var s=this;u(this,n),this.latestMessageHistoryCursorsCache=[],this.reachedBeginningOfMessageHistory=!1,this.isBeforeUnload=!1,this.isCurrentlySubscribed=!1,this.subscriptionQuery=y.gql(a()),this.sendMessageQuery=y.gql(i()),this.messageHistoryQuery=y.gql(r()),this.onBeforeUnload=function(){return s.isBeforeUnload=!0,!1},this.unsubscribe=function(){window.removeEventListener("beforeunload",s.onBeforeUnload),s.absintheSocket=d.cancel(s.absintheSocket,s.notifier),s.latestMessageHistoryCursorsCache=[],s.reachedBeginningOfMessageHistory=!1,s.isCurrentlySubscribed=!1,s.onUnsubscribe()},this.sendMessage=function(e){var n=e.text,t=e.attachments,r=e.responseToMessageId,i=e.tempId,a=s.sendMessageQuery,o={text:n,attachments:t,responseToMessageId:r,tempId:i};return new Promise(function(e,n){s.graphQLClient.query(a,o,{asFormData:!0}).then(function(t){if(t&&t.sendMessage){var r=f.serializeMessage(t.sendMessage,{backendStaticUrl:s.backendStaticUrl,currentClientId:s.currentClientId});e(r)}else n({error:t,variables:o,query:a})}).catch(function(e){n({error:e,variables:o,query:a})})})},this.fetchMessageHistory=function(n,t){var r=s.messageHistoryQuery,i={limit:n,beforeCursor:t};return new Promise(function(a,o){s.reachedBeginningOfMessageHistory?a([]):s.graphQLClient.query(r,i).then(function(u){if(u.messages){var c=y.simplifyGraphQLJSON(u.messages).map(function(e){return f.serializeMessage(e,{backendStaticUrl:s.backendStaticUrl,currentClientId:s.currentClientId})}).filter(function(e){return!s.latestMessageHistoryCursorsCache.includes(e.cursor)});s.latestMessageHistoryCursorsCache=[].concat(e(c.map(function(e){return e.cursor})),e(s.latestMessageHistoryCursorsCache)).slice(0,n),c.length<n&&(s.reachedBeginningOfMessageHistory=!0),a(c)}else o({response:u,limit:n,beforeCursor:t,query:r,variables:i})}).catch(function(e){o({error:e,limit:n,beforeCursor:t,query:r,variables:i})})})},this.apiUrl=t.apiUrl,this.socketUrl=t.socketUrl,this.backendStaticUrl=t.backendStaticUrl,this.token=t.token,this.currentClientId=t.currentClientId,this.onSubscribeSuccess=t.onSubscribeSuccess||function(){},this.onSubscribeError=t.onSubscribeError||function(){},this.onUnsubscribe=t.onUnsubscribe||function(){},this.onMessage=t.onMessage,this.initialize()}return l(n,[{key:"initialize",value:function(){this.absintheSocket=d.create(new h.Socket(this.socketUrl,{params:{token:this.token}})),this.graphQLClient=new y.GraphQLClient({url:this.apiUrl,token:this.token}),window.addEventListener("beforeunload",this.onBeforeUnload),this.subscribe()}},{key:"subscribe",value:function(){var e=this,n=d.send(this.absintheSocket,{operation:this.subscriptionQuery});d.observe(this.absintheSocket,n,{onAbort:function(n){return e.onSubscribeAbort(n)},onStart:function(n){e.notifier=n,e.isCurrentlySubscribed||(e.isCurrentlySubscribed=!0,e.onSubscribeSuccess(n))},onResult:function(n){var t=n.data;if(t&&t.newMessage){var s=f.serializeMessage(t.newMessage,{backendStaticUrl:e.backendStaticUrl,currentClientId:e.currentClientId});e.onMessage(s)}}})}},{key:"onSubscribeAbort",value:function(e,n){this.onSubscribeError({error:e,variables:{methodName:n},graphQLQuery:this.subscriptionQuery})}}]),n}();exports.MessagesSubscription=b;
