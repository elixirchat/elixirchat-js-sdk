...
"use strict";function e(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}function n(e,n){for(var t=0;t<n.length;t++){var s=n[t];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(e,s.key,s)}}function t(e,t,s){return t&&n(e.prototype,t),s&&n(e,s),e}Object.defineProperty(exports,"__esModule",{value:!0});var s=require("../utilsCommon"),r=function(){function n(t){var r=this,a=t.currentClientId;e(this,n),this.unreadMessagesCount=0,this.unreadRepliesCount=0,this.unreadMessages=[],this.unreadReplies=[],this.receivedMessages=[],this.currentClientId=null,this.onUnreadMessagesChangeCallbacks=[],this.onUnreadRepliesChangeCallbacks=[],this.setReceivedMessages=function(e){r.receivedMessages=e;var n=r.getUnreadMessages(),t=r.getUnreadRepliesToCurrentClient();r.triggerOnChangeCallbacks(n,t)},this.onUnreadMessagesChange=function(e){r.onUnreadMessagesChangeCallbacks.push(e)},this.onUnreadRepliesChange=function(e){r.onUnreadRepliesChangeCallbacks.push(e)},this.resetUnreadMessagesAndReplies=function(){var e=r.getAllRepliesToCurrentClient(),n=s._last(e);n&&localStorage.setItem("elixirchat-latest-unread-reply-id",n.id);var t=s._last(r.receivedMessages);t&&localStorage.setItem("elixirchat-latest-unread-message-id",t.id),r.triggerOnChangeCallbacks([],[])},this.getUnreadRepliesToCurrentClient=function(){var e=r.getAllRepliesToCurrentClient(),n=localStorage.getItem("elixirchat-latest-unread-reply-id"),t=e.map(function(e){return e.id}).indexOf(n);return-1===t?e:e.slice(t+1)},this.getUnreadMessages=function(){var e=localStorage.getItem("elixirchat-latest-unread-message-id"),n=r.receivedMessages.filter(function(e){return e.sender.id!==r.currentClientId}),t=n.map(function(e){return e.id}).indexOf(e);return-1===t?n:n.slice(t+1)},this.currentClientId=a}return t(n,[{key:"triggerOnChangeCallbacks",value:function(e,n){this.unreadMessagesCount!==e.length&&(this.onUnreadMessagesChangeCallbacks.forEach(function(n){return n(e.length,e)}),this.unreadMessagesCount=e.length,this.unreadMessages=e),this.unreadRepliesCount!==n.length&&(this.onUnreadRepliesChangeCallbacks.forEach(function(e){return e(n.length,n)}),this.unreadRepliesCount=n.length,this.unreadReplies=n)}},{key:"getAllRepliesToCurrentClient",value:function(){var e=this;return this.receivedMessages.filter(function(n){var t=n.responseToMessage,r=n.sender.id===e.currentClientId;return s._get(t,"sender.id")===e.currentClientId&&!r})}}]),n}();exports.UnreadMessagesCounter=r;
...
"use strict";function e(e,r){return s(e)||n(e,r)||t()}function t(){throw new TypeError("Invalid attempt to destructure non-iterable instance")}function n(e,t){var n=[],s=!0,r=!1,o=void 0;try{for(var i,a=e[Symbol.iterator]();!(s=(i=a.next()).done)&&(n.push(i.value),!t||n.length!==t);s=!0);}catch(c){r=!0,o=c}finally{try{s||null==a.return||a.return()}finally{if(r)throw o}}return n}function s(e){if(Array.isArray(e))return e}function r(){var e=o(["\n    mutation($companyId: Uuid!, $room: ForeignRoom, $client: ForeignClient) {\n      joinRoom (companyId: $companyId, room: $room, client: $client) {\n        token\n        company {\n          working\n          widgetTitle\n        }\n        client {\n          ...fragmentClient\n        }\n        room {\n          id\n          title\n          foreignId\n        }\n      }\n    }\n  "]);return r=function(){return e},e}function o(e,t){return t||(t=e.slice(0)),Object.freeze(Object.defineProperties(e,{raw:{value:Object.freeze(t)}}))}function i(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function a(e,t){for(var n=0;n<t.length;n++){var s=t[n];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(e,s.key,s)}}function c(e,t,n){return t&&a(e.prototype,t),n&&a(e,n),e}Object.defineProperty(exports,"__esModule",{value:!0});var u=require("unique-names-generator"),l=require("../utilsCommon"),g=require("./serializers/serializeUser"),h=require("./MessagesSubscription"),d=require("./TypingStatusSubscription"),m=require("./OperatorOnlineStatusSubscription"),b=require("./UnreadMessagesCounter"),p=require("./ScreenshotTaker"),f=require("./GraphQLClient");exports.API_REFERENCE_URL="https://github.com/elixirchat/elixirchat-js-sdk";var C=function(){function t(e){var n=this;i(this,t),this.receivedMessages=[],this.areAnyOperatorsOnline=!1,this.widgetTitle="",this.defaultWidgetTitle="Служба поддержки",this.joinRoomQuery=f.insertGraphQlFragments(f.gql(r()),{fragmentClient:g.fragmentClient}),this.onMessageCallbacks=[],this.onConnectSuccessCallbacks=[],this.onConnectErrorCallbacks=[],this.onTypingCallbacks=[],this.onOperatorOnlineStatusChangeCallbacks=[],this.onUnreadMessagesChangeCallbacks=[],this.onUnreadRepliesChangeCallbacks=[],this.onUnreadRepliesChange=function(e){n.onUnreadRepliesChangeCallbacks.push(e)},this.onUnreadMessagesChange=function(e){n.onUnreadMessagesChangeCallbacks.push(e)},this.resetUnreadMessagesAndReplies=function(){n.unreadMessagesCounter.resetUnreadMessagesAndReplies()},this.dispatchTypedText=function(e){n.typingStatusSubscription.dispatchTypedText(e)},this.onMessage=function(e){n.onMessageCallbacks.push(e)},this.onTyping=function(e){n.onTypingCallbacks.push(e)},this.onOperatorOnlineStatusChange=function(e){n.onOperatorOnlineStatusChangeCallbacks.push(e)},this.reconnect=function(e){var t=e.room,s=e.client;return l.logEvent(n.debug,"Attempting to reconnect to another room",{room:t,client:s}),t&&(n.room=t),s&&(n.client=s),n.isPrivate=!t||!t.id,n.setDefaultConfigValues(),n.messagesSubscription.unsubscribe(),n.operatorOnlineStatusSubscription.unsubscribe(),n.connectToRoom().then(function(){n.saveRoomClientToLocalStorage(n.room,n.client),n.subscribeToNewMessages(),n.subscribeToOperatorOnlineStatusChange(),n.typingStatusSubscription.resubscribeToAnotherRoom(n.room.id)})},this.onConnectSuccess=function(e){n.onConnectSuccessCallbacks.push(e)},this.onConnectError=function(e){n.onConnectErrorCallbacks.push(e)},this.takeScreenshot=function(){return n.screenshotTaker.takeScreenshot().then(function(e){return l.logEvent(n.debug,"Captured screenshot",e),e}).catch(function(e){throw l.logEvent(n.debug,"Could not capture screenshot",e,"error"),e})},this.fetchMessageHistory=function(e,t){return n.messagesSubscription.fetchMessageHistory(e,t).then(function(s){return l.logEvent(n.debug,"Fetched message history",{limit:e,beforeCursor:t,messages:s}),n.receivedMessages=n.receivedMessages.concat(s),n.unreadMessagesCounter.setReceivedMessages(n.receivedMessages),s}).catch(function(e){throw l.logEvent(n.debug,"Could not fetch message history",e,"error"),e})},this.apiUrl=e.apiUrl,this.socketUrl=e.socketUrl,this.backendStaticUrl=e.backendStaticUrl,this.companyId=e.companyId,this.debug=e.debug||!1,this.room=e.room,this.client=e.client,this.isPrivate=!this.room||!this.room.id;var s=this.getRoomClientFromLocalStorage();this.room&&this.room.id||(this.room=s.room),this.client&&this.client.id||(this.client=s.client),this.initialize()}return c(t,[{key:"initialize",value:function(){var e=this;this.companyId?(l.logEvent(this.debug,"Initializing ElixirChat",{apiUrl:this.apiUrl,socketUrl:this.socketUrl,backendStaticUrl:this.backendStaticUrl,companyId:this.companyId,room:this.room,client:this.client,debug:this.debug}),this.screenshotTaker=new p.ScreenshotTaker,this.setDefaultConfigValues(),this.connectToRoom().then(function(){e.saveRoomClientToLocalStorage(e.room,e.client),e.subscribeToUnreadMessagesCounter(),e.subscribeToNewMessages(),e.subscribeToTypingStatusChange(),e.subscribeToOperatorOnlineStatusChange()})):l.logEvent(this.debug,"Required parameter companyId is not provided: \nSee more: ".concat(exports.API_REFERENCE_URL,"#config-companyid"),null,"error")}},{key:"getDefaultClientData",value:function(){var t=u.uniqueNamesGenerator({length:2,separator:" ",dictionaries:null}),n=e(t.split(" ").map(l.capitalize),2),s=n[0],r=n[1],o=l.randomDigitStringId(4),i={id:t.replace(" ","-")+"-"+o,firstName:s,lastName:r};return l.logEvent(this.debug,"Generated default client data",i),i}},{key:"getRoomClientFromLocalStorage",value:function(){var e,t;try{e=JSON.parse(localStorage.getItem("elixirchat-room"))}catch(n){}try{t=JSON.parse(localStorage.getItem("elixirchat-client"))}catch(n){}return l.logEvent(this.debug,"Fetched room, client values from localStorage",{room:e,client:t}),{room:e,client:t}}},{key:"saveRoomClientToLocalStorage",value:function(e,t){localStorage.setItem("elixirchat-room",JSON.stringify(e)),localStorage.setItem("elixirchat-client",JSON.stringify(t))}},{key:"setDefaultConfigValues",value:function(){var e=this.client||{},t=this.room||{},n=this.getDefaultClientData(),s=e.id||n.id,r=e.firstName,o=e.lastName;r||o||(r=n.firstName,o=n.lastName),this.client={id:s,firstName:r,lastName:o};var i=t.id||s,a=t.title||r+" "+o,c=t.data||{};this.room={id:i,title:a,data:c},l.logEvent(this.debug,"Set room and client values",{room:this.room,client:this.client})}},{key:"serializeRoomData",value:function(e){var t={};for(var n in e)t[n]=e[n].toString();return JSON.stringify(t)}},{key:"connectToRoom",value:function(){var e=this;this.graphQLClient=new f.GraphQLClient({url:this.apiUrl});var t=this.joinRoomQuery,n={companyId:this.companyId,room:{id:this.room.id,title:this.room.title,data:this.serializeRoomData(this.room.data)},client:this.client};return new Promise(function(s,r){e.graphQLClient.query(t,n).then(function(o){var i=o.joinRoom;i?(e.authToken=i.token,e.connected=!0,e.client.firstName=i.client.firstName,e.client.lastName=i.client.lastName,e.client.id=i.client.foreignId,e.elixirChatClientId=i.client.id,e.widgetTitle=i.company.widgetTitle||e.defaultWidgetTitle,e.areAnyOperatorsOnline=i.company.working,e.room.id=i.room.foreignId,e.room.title=i.room.title,e.elixirChatRoomId=i.room.id,l.logEvent(e.debug,"Joined room",{joinRoom:i,room:e.room,client:e.client}),s(i)):(l.logEvent(e.debug,"Failed to join room",{joinRoom:i,query:t,variables:n},"error"),e.onConnectErrorCallbacks.forEach(function(e){return e(i)}),r(i))}).catch(function(s){l.logEvent(e.debug,"Failed to join room",{response:s,query:t,variables:n},"error"),e.onConnectErrorCallbacks.forEach(function(e){return e(s)}),r(s)})})}},{key:"subscribeToTypingStatusChange",value:function(){var e=this;this.typingStatusSubscription=new d.TypingStatusSubscription({socketUrl:this.socketUrl,token:this.authToken,roomId:this.elixirChatRoomId,clientId:this.elixirChatClientId,onSubscribeSuccess:function(){l.logEvent(e.debug,"Successfully subscribed to typing status change",{roomId:e.elixirChatRoomId})},onSubscribeError:function(t){l.logEvent(e.debug,"Failed to subscribe to typing status change",t,"error")},onChange:function(t){l.logEvent(e.debug,"Some users started/stopped typing",{peopleWhoAreTyping:t}),e.onTypingCallbacks.forEach(function(e){return e(t)})}})}},{key:"subscribeToOperatorOnlineStatusChange",value:function(){var e=this;this.operatorOnlineStatusSubscription=new m.OperatorOnlineStatusSubscription({isOnline:this.areAnyOperatorsOnline,socketUrl:this.socketUrl,token:this.authToken,onSubscribeSuccess:function(){l.logEvent(e.debug,"Successfully subscribed to operator online status change")},onSubscribeError:function(t){l.logEvent(e.debug,"Failed to subscribe to operator online status change",t,"error")},onStatusChange:function(t){l.logEvent(e.debug,t?"Operators got back online":"All operators went"),e.areAnyOperatorsOnline=t,e.onOperatorOnlineStatusChangeCallbacks.forEach(function(e){return e(t)})},onUnsubscribe:function(){l.logEvent(e.debug,"Unsubscribed from  operator online status change")}})}},{key:"subscribeToNewMessages",value:function(){var e=this;this.messagesSubscription=new h.MessagesSubscription({apiUrl:this.apiUrl,socketUrl:this.socketUrl,backendStaticUrl:this.backendStaticUrl,token:this.authToken,currentClientId:this.client.id,onSubscribeSuccess:function(){var t={room:e.room,client:e.client};l.logEvent(e.debug,"Successfully subscribed to messages",t),e.onConnectSuccessCallbacks.forEach(function(e){return e(t)})},onSubscribeError:function(t){l.logEvent(e.debug,"Failed to subscribe to messages",{data:t},"error"),e.onConnectErrorCallbacks.forEach(function(e){return e(t)})},onMessage:function(t){l.logEvent(e.debug,"Received new message",t),e.receivedMessages.push(t),e.unreadMessagesCounter.setReceivedMessages(e.receivedMessages),e.onMessageCallbacks.forEach(function(e){return e(t)})},onUnsubscribe:function(){l.logEvent(e.debug,"Unsubscribed from messages",{room:e.room,client:e.client})}})}},{key:"sendMessage",value:function(e){var t=this,n=e.text,s=e.attachments&&e.attachments.length?Array.from(e.attachments).filter(function(e){return e}):[],r="string"==typeof e.responseToMessageId?e.responseToMessageId:null,o=e.tempId;if(n.trim()||s.length)return this.messagesSubscription.sendMessage({text:n,attachments:s,responseToMessageId:r,tempId:o}).then(function(i){return l.logEvent(t.debug,"Sent message",{message:i,params:e,normalizedParams:{text:n,attachments:s,responseToMessageId:r,tempId:o}}),t.typingStatusSubscription.dispatchTypedText(!1),i}).catch(function(e){throw l.logEvent(t.debug,"Failed to send message",e,"error"),e});var i='Either "text" or "attachment" property must not be empty';return l.logEvent(this.debug,i,e,"error"),new Promise(function(t,n){n({message:i,params:e})})}},{key:"subscribeToUnreadMessagesCounter",value:function(){var e=this;this.unreadMessagesCounter=new b.UnreadMessagesCounter({currentClientId:this.elixirChatClientId}),this.unreadMessagesCounter.onUnreadMessagesChange(function(t,n){l.logEvent(e.debug,"Unread messages count changed to "+t,{unreadMessages:n}),e.onUnreadMessagesChangeCallbacks.forEach(function(e){return e(t,n)})}),this.unreadMessagesCounter.onUnreadRepliesChange(function(t,n){l.logEvent(e.debug,"Unread replies count changed to "+t,{unreadReplies:n}),e.onUnreadRepliesChangeCallbacks.forEach(function(e){return e(t,n)})})}},{key:"unreadMessagesCount",get:function(){return this.unreadMessagesCounter?this.unreadMessagesCounter.unreadMessagesCount:0}},{key:"unreadRepliesCount",get:function(){return this.unreadMessagesCounter?this.unreadMessagesCounter.unreadRepliesCount:0}},{key:"unreadMessages",get:function(){return this.unreadMessagesCounter?this.unreadMessagesCounter.unreadMessages:[]}},{key:"unreadReplies",get:function(){return this.unreadMessagesCounter?this.unreadMessagesCounter.unreadReplies:[]}},{key:"reachedBeginningOfMessageHistory",get:function(){return!!this.messagesSubscription&&this.messagesSubscription.reachedBeginningOfMessageHistory}}]),t}();exports.ElixirChat=C,"undefined"!=typeof window&&(window.ElixirChat=C);
