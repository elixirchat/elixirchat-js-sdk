...
"use strict";function e(e){return r(e)||s(e)||n()}function n(){throw new TypeError("Invalid attempt to spread non-iterable instance")}function s(e){if(Symbol.iterator in Object(e)||"[object Arguments]"===Object.prototype.toString.call(e))return Array.from(e)}function r(e){if(Array.isArray(e)){for(var n=0,s=new Array(e.length);n<e.length;n++)s[n]=e[n];return s}}function t(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}function i(e,n){for(var s=0;s<n.length;s++){var r=n[s];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function a(e,n,s){return n&&i(e.prototype,n),s&&i(e,s),e}var o=this&&this.__importStar||function(e){if(e&&e.__esModule)return e;var n={};if(null!=e)for(var s in e)Object.hasOwnProperty.call(e,s)&&(n[s]=e[s]);return n.default=e,n};Object.defineProperty(exports,"__esModule",{value:!0});var u=o(require("@absinthe/socket")),l=o(require("phoenix")),c=require("./GraphQLClient"),d=function(){function n(s){var r=this;t(this,n),this.latestMessageHistoryCursorsCache=[],this.reachedBeginningOfMessageHistory=!1,this.isBeforeUnload=!1,this.subscriptionQuery="\n    subscription {\n      newMessage {\n        id\n        text\n        timestamp\n        data {\n          ... on NotSystemMessageData {\n            responseToMessage {\n              id\n              text\n              sender {\n                __typename\n                ... on Client { id foreignId firstName lastName }\n                ... on Employee { id firstName lastName }\n              }\n            }\n          }\n        }\n        sender {\n          __typename\n          ... on Client { id foreignId firstName lastName }\n          ... on Employee { id firstName lastName }\n        }\n      }\n    }\n  ",this.sendMessageQuery="\n    sendMessage {\n      id\n      text\n      timestamp\n      data {\n        ... on NotSystemMessageData {\n          responseToMessage {\n            id\n            text\n            sender {\n              __typename\n              ... on Client { id foreignId firstName lastName }\n              ... on Employee { id firstName lastName }\n            }\n          }\n        }\n      }\n      sender {\n        __typename\n        ... on Client { id foreignId firstName lastName }\n        ... on Employee { id firstName lastName }\n      }\n    }\n  ",this.messageHistoryQuery="\n    messages {\n      edges {\n        cursor\n        node {\n          id\n          text\n          timestamp\n          data {\n            ... on NotSystemMessageData {\n              responseToMessage {\n                id\n                text\n                sender {\n                  __typename\n                  ... on Client { id foreignId firstName lastName }\n                  ... on Employee { id firstName lastName }\n                }\n              }\n            }\n          }\n          sender {\n            __typename\n            ... on Client { id foreignId firstName lastName }\n            ... on Employee { id firstName lastName }\n          }\n        }\n      }\n    }\n  ",this.onBeforeUnload=function(){return r.isBeforeUnload=!0,!1},this.unsubscribe=function(){window.removeEventListener("beforeunload",r.onBeforeUnload),r.absintheSocket=u.cancel(r.absintheSocket,r.notifier),r.latestMessageHistoryCursorsCache=[],r.reachedBeginningOfMessageHistory=!1},this.serializeMessage=function(e){var n=e.data.responseToMessage;if(n&&n.sender){var s={elixirChatId:n.sender.id,firstName:n.sender.firstName,lastName:n.sender.lastName,isAgent:"Employee"===n.sender.__typename,isCurrentClient:!1};s.isAgent||(s.id=n.sender.foreignId,s.isCurrentClient=n.sender.foreignId===r.currentClientId),n=Object.assign({},n,{responseToMessageSender:s})}var t={elixirChatId:e.sender.id,firstName:e.sender.firstName,lastName:e.sender.lastName,isAgent:"Employee"===e.sender.__typename,isCurrentClient:!1};return t.isAgent||(t.id=e.sender.foreignId,t.isCurrentClient=e.sender.foreignId===r.currentClientId),{id:e.id,text:e.text,timestamp:e.timestamp,sender:t,responseToMessage:n,cursor:e.cursor||null}},this.sendMessage=function(e){var n={text:e.text,responseToMessageId:e.responseToMessageId},s=c.prepareGraphQLQuery("mutation",r.sendMessageQuery,n);return new Promise(function(e,t){n.text&&r.graphQLClient.query(s,n).then(function(i){i&&i.sendMessage?e(r.serializeMessage(i.sendMessage)):t({error:i,variables:n,graphQLQuery:s})}).catch(function(e){t({error:e,variables:n,graphQLQuery:s})})})},this.fetchMessageHistory=function(n,s){var t={last:n,before:s},i=c.prepareGraphQLQuery("query",r.messageHistoryQuery,t,{before:"String"});return new Promise(function(a,o){r.reachedBeginningOfMessageHistory?a([]):r.graphQLClient.query(i,t).then(function(u){if(u.messages){var l=c.simplifyGraphQLJSON(u.messages).map(r.serializeMessage);l=l.filter(function(e){return!r.latestMessageHistoryCursorsCache.includes(e.cursor)}),r.latestMessageHistoryCursorsCache=[].concat(e(l.map(function(e){return e.cursor})),e(r.latestMessageHistoryCursorsCache)).slice(0,n),l.length<n&&(r.reachedBeginningOfMessageHistory=!0),a(l)}else o({response:u,limit:n,beforeCursor:s,query:i,variables:t})}).catch(function(e){o({error:e,limit:n,beforeCursor:s,query:i,variables:t})})})},this.apiUrl=s.apiUrl,this.socketUrl=s.socketUrl,this.token=s.token,this.currentClientId=s.currentClientId,this.onSubscribeSuccess=s.onSubscribeSuccess||function(){},this.onSubscribeError=s.onSubscribeError||function(){},this.onMessage=s.onMessage,this.initialize()}return a(n,[{key:"initialize",value:function(){this.absintheSocket=u.create(new l.Socket(this.socketUrl,{params:{token:this.token}})),this.graphQLClient=new c.GraphQLClient({url:this.apiUrl,token:this.token}),window.addEventListener("beforeunload",this.onBeforeUnload),this.subscribe()}},{key:"subscribe",value:function(){var e=this,n=u.send(this.absintheSocket,{operation:this.subscriptionQuery});u.observe(this.absintheSocket,n,{onAbort:function(n){return e.onSubscribeFail(n,"onAbort")},onError:function(n){e.isBeforeUnload||e.onSubscribeFail(n,"onError")},onStart:function(n){e.notifier=n,e.onSubscribeSuccess(n)},onResult:function(n){var s=n.data;s&&s.newMessage&&e.onMessage(e.serializeMessage(s.newMessage))}})}},{key:"onSubscribeFail",value:function(e,n){this.onSubscribeError({error:e,variables:{methodName:n},graphQLQuery:this.subscriptionQuery})}}]),n}();exports.MessagesSubscription=d;
