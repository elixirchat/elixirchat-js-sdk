...
"use strict";function _templateObject(){var e=_taggedTemplateLiteral(["\n  fragment fragmentMessage on Message {\n    id\n    text\n    timestamp\n    isUnread\n    isSystem\n    \n    ... on ManualMessage {\n      tempId\n      isDeleted\n      mustOpenWidget\n      sender { ...fragmentUser }\n      attachments { ...fragmentFile }\n      mentions {\n        value\n        client { ...fragmentUser }\n      }\n      responseToMessage {\n        id\n        text\n        isDeleted\n        sender { ...fragmentUser }\n      }\n    }\n    \n    ... on ScreenshotRequestedMessage {\n      __typename\n      sender { ...fragmentUser }\n    }\n\n    ... on NobodyWorkingMessage {\n      __typename\n      workHoursStartAt\n    }\n  }\n"]);return _templateObject=function _templateObject(){return e},e}function _taggedTemplateLiteral(e,t){return t||(t=e.slice(0)),Object.freeze(Object.defineProperties(e,{raw:{value:Object.freeze(t)}}))}Object.defineProperty(exports,"__esModule",{value:!0}),exports.serializeMessage=exports.fragmentMessage=void 0;var e=require("../GraphQLClient"),t=require("./serializeUser"),n=require("./serializeFile"),s=require("../../utilsCommon");function serializeMessage(e,r){var a=e||{},i=a.sender,l=a.responseToMessage,o=a.attachments,m=a.mentions;return Object.assign(Object.assign({},(0,s.extractSerializedData)(e,{id:null,tempId:null,cursor:null,text:"",timestamp:"",mustOpenWidget:!1,submissionErrorCode:null,isSubmitting:!1,isUnread:!1,isSystem:!1,isDeleted:!1})),{sender:(0,t.serializeUser)(i,r),attachments:(o||[]).map(function(e){return(0,n.serializeFile)(e,r)}),responseToMessage:Object.assign(Object.assign({},(0,s.extractSerializedData)(l,{id:null,text:"",isDeleted:!1})),{sender:(0,t.serializeUser)(null==l?void 0:l.sender,r)}),mentions:(m||[]).map(function(e){return{client:(0,t.serializeUser)(e.client,r),value:e.value}}),systemData:{type:(null==e?void 0:e.__typename)||null,workHoursStartAt:(null==e?void 0:e.workHoursStartAt)||null}})}exports.fragmentMessage=(0,e.insertGraphQlFragments)((0,e.gql)(_templateObject()),{fragmentUser:t.fragmentUser,fragmentFile:n.fragmentFile}),exports.serializeMessage=serializeMessage;
