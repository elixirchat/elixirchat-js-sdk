...
"use strict";function e(){var n=r(["\n    query {\n      room {\n        unreadMessagesCount\n        unreadRepliesCount\n      }\n    }\n  "]);return e=function(){return n},n}function n(){var e=r(["\n    mutation ($messageId: ID!) {\n      updateLastReadMessage(messageId: $messageId) {\n        unreadMessagesCount,\n        unreadRepliesCount,\n      }\n    }\n  "]);return n=function(){return e},e}function t(){var e=r(["\n    subscription {\n      updateReadMessages {\n        unreadMessagesCount\n        unreadRepliesCount\n        lastReadMessageId\n      }\n    }\n  "]);return t=function(){return e},e}function r(e,n){return n||(n=e.slice(0)),Object.freeze(Object.defineProperties(e,{raw:{value:Object.freeze(n)}}))}function s(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}function a(e,n){for(var t=0;t<n.length;t++){var r=n[t];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function u(e,n,t){return n&&a(e.prototype,n),t&&a(e,t),e}Object.defineProperty(exports,"__esModule",{value:!0});var i=require("../utilsCommon"),o=require("./GraphQLClient"),l=require("./GraphQLClientSocket"),d=require("./ElixirChatEventTypes"),c=function(){function r(a){var u=this,l=a.elixirChat;s(this,r),this.unreadMessagesCount=0,this.unreadRepliesCount=0,this.lastReadMessageId=null,this.subscriptionQuery=o.gql(t()),this.setLastReadMessageQuery=o.gql(n()),this.fetchUnreadCountsQuery=o.gql(e()),this.subscribe=function(){var e=u.elixirChat,n=e.apiUrl,t=e.authToken;u.graphQLClient=new o.GraphQLClient({url:n,token:t}),u.fetchUnreadCounts(),u.initializeSocketClient()},this.unsubscribe=function(){var e=u.elixirChat.debug;i.logEvent(e,"Unsubscribing from unread messages count..."),u.unreadMessagesCount=0,u.unreadRepliesCount=0,u.graphQLClientSocket.unsubscribe(),u.graphQLClientSocket=null,u.graphQLClient=null},this.setLastReadMessage=function(e){return u.graphQLClient.query(u.setLastReadMessageQuery,{messageId:e})},this.fetchUnreadCounts=function(){var e=u.elixirChat,n=e.debug,t=e.triggerEvent;return u.graphQLClient.query(u.fetchUnreadCountsQuery,{}).then(function(e){if(e&&e.room)return i.logEvent(n,"Fetched unread counts",e.room),t(d.UNREAD_FETCH_COUNTS_SUCCESS,e),u.onUnreadCountsUpdate(e.room),e;throw i.logEvent(n,"Failed to fetch unread counts",e,"error"),t(d.UNREAD_FETCH_COUNTS_ERROR,e),e}).catch(function(e){throw i.logEvent(n,"Failed to fetch unread counts",e,"error"),t(d.UNREAD_FETCH_COUNTS_ERROR,e),e})},this.onUnreadCountsUpdate=function(e){var n=u.elixirChat,t=n.debug,r=n.triggerEvent,s=e.unreadMessagesCount,a=e.unreadRepliesCount,o=e.lastReadMessageId;s!==u.unreadMessagesCount&&(i.logEvent(t,"Unread messages count changed to "+s),u.unreadMessagesCount=s,r(d.UNREAD_MESSAGES_CHANGE,s)),a!==u.unreadRepliesCount&&(i.logEvent(t,"Unread replies count changed to "+a),u.unreadRepliesCount=a,r(d.UNREAD_REPLIES_CHANGE,a)),o!==u.lastReadMessageId&&(i.logEvent(t,"Last message marked as read changed to ID: "+o),u.lastReadMessageId=o,r(d.LAST_READ_MESSAGE_CHANGE,o))},this.elixirChat=l,window.__this3=this}return u(r,[{key:"initializeSocketClient",value:function(){var e=this,n=this.elixirChat,t=n.socketUrl,r=n.authToken,s=n.debug,a=n.triggerEvent;this.graphQLClientSocket=new l.GraphQLClientSocket({socketUrl:t,authToken:r,query:this.subscriptionQuery,onAbort:function(e){i.logEvent(s,"Failed to subscribe to unread messages count",e,"error"),a(d.UNREAD_MESSAGES_SUBSCRIBE_ERROR,e)},onStart:function(){i.logEvent(s,"Successfully subscribed to unread messages count"),a(d.UNREAD_MESSAGES_SUBSCRIBE_SUCCESS)},onResult:function(n){var t=i._get(n,"data.updateReadMessages")||{};e.onUnreadCountsUpdate(t)}})}}]),r}();exports.UnreadMessagesCounter=c;
...
"use strict";function e(){var t=n(["\n  fragment fragmentFile on File {\n    id\n    url\n    name\n    bytesSize\n    height\n    width\n    contentType\n    thumbnails {\n      id\n      url\n      name\n      bytesSize\n      height\n      width\n      contentType\n      thumbType\n    }\n  }\n"]);return e=function(){return t},t}function n(e,n){return n||(n=e.slice(0)),Object.freeze(Object.defineProperties(e,{raw:{value:Object.freeze(n)}}))}Object.defineProperty(exports,"__esModule",{value:!0});var t=require("../GraphQLClient");function i(e,n){var t=e||{},r=null;t.thumbnails&&t.thumbnails.length&&(r=t.thumbnails.map(function(e){var t=i(e,n);return{id:t.id,url:t.url,name:t.name,bytesSize:t.bytesSize,width:t.width,height:t.height,contentType:t.contentType,thumbType:e.thumbType||null}}));var l=n.apiUrl.replace(/\/$/,"")+"/",u="";return t.url&&(u=/^uploads/i.test(t.url)?l+t.url:t.url),{id:t.id||null,url:u,name:t.name||"",bytesSize:t.bytesSize||0,height:t.height||0,width:t.width||0,thumbnails:r,contentType:t.contentType||null,isScreenshot:t.isScreenshot||!1}}exports.fragmentFile=t.gql(e()),exports.serializeFile=i;
},{"../GraphQLClient":"fvSB"}],"ZEl5":[function(require,module,exports) {
"use strict";function e(){var t=n(["\n  fragment fragmentMessage on Message {\n    id\n    tempId\n    text\n    timestamp\n    system\n    unread\n    sender {\n      ... on Client { ...fragmentClient }\n      ... on CompanyEmployee { ...fragmentCompanyEmployee }\n    }\n    attachments {\n      ...fragmentFile\n    }\n    data {\n      ... on SystemMessageData {\n        type\n        author {\n          ...fragmentCompanyEmployee\n        }\n        whenWouldWork\n      }\n      ... on NotSystemMessageData {\n        mentions {\n          ...on Client { ...fragmentClient }\n          ...on MentionAlias { value }\n        },\n        responseToMessage {\n          id\n          text\n          sender {\n            __typename\n            ... on Client { ...fragmentClient }\n            ... on CompanyEmployee { ...fragmentCompanyEmployee }\n          }\n        }\n      }\n    }\n  }\n"]);return e=function(){return t},t}function n(e,n){return n||(n=e.slice(0)),Object.freeze(Object.defineProperties(e,{raw:{value:Object.freeze(n)}}))}Object.defineProperty(exports,"__esModule",{value:!0});var t=require("../GraphQLClient"),r=require("../../utilsCommon"),s=require("./serializeUser"),a=require("./serializeFile");function i(e,n){var t=e.sender,i=void 0===t?{}:t,o=e.attachments,m=e.data,l=void 0===m?{}:m,g=l.responseToMessage,u=l.author,p=void 0===u?{}:u,d=s.serializeUser(Object.assign({},i,p),n),f=(o||[]).map(function(e){return a.serializeFile(e,n)}),y=r._get(g,"sender",{}),_={id:r._get(g,"id")||null,text:r._get(g,"text")||"",sender:s.serializeUser(y,n)},c=(r._get(l,"mentions")||[]).map(function(e){return Object.assign({},s.serializeUser(e,n),{value:e.value})}),C=r._get(e,"system",!1);return{id:r._get(e,"id")||null,tempId:r._get(e,"tempId")||null,text:r._get(e,"text")||"",timestamp:r._get(e,"timestamp")||"",cursor:r._get(e,"cursor")||null,sender:d,responseToMessage:_.id?_:null,attachments:f,isSubmitting:r._get(e,"isSubmitting")||!1,submissionErrorCode:r._get(e,"submissionErrorCode")||null,isUnread:r._get(e,"unread")||!1,openWidget:r._get(e,"openWidget")||!1,mentions:c,isSystem:C,systemData:C?{type:r._get(e,"data.type")||null,whenWouldWork:r._get(e,"data.whenWouldWork")||null}:null}}exports.fragmentMessage=t.insertGraphQlFragments(t.gql(e()),{fragmentClient:s.fragmentClient,fragmentCompanyEmployee:s.fragmentCompanyEmployee,fragmentFile:a.fragmentFile}),exports.serializeMessage=i;
},{"../GraphQLClient":"fvSB","../../utilsCommon":"EjGt","./serializeUser":"lqyB","./serializeFile":"sQAQ"}],"jRw6":[function(require,module,exports) {
"use strict";function e(e){return r(e)||s(e)||t()}function t(){throw new TypeError("Invalid attempt to spread non-iterable instance")}function s(e){if(Symbol.iterator in Object(e)||"[object Arguments]"===Object.prototype.toString.call(e))return Array.from(e)}function r(e){if(Array.isArray(e)){for(var t=0,s=new Array(e.length);t<e.length;t++)s[t]=e[t];return s}}function n(){var e=o(["\n    query ($beforeCursor: String, $limit: Int!) {\n      messages(before: $beforeCursor, last: $limit) {\n        edges {\n          cursor\n          node {\n            ...fragmentMessage\n          }\n        }\n      }\n    }\n  "]);return n=function(){return e},e}function i(){var e=o(["\n    mutation ($text: String!, $responseToMessageId: ID, $attachments: [Upload!], $tempId: ID) {\n      sendMessage(text: $text, responseToMessageId: $responseToMessageId, attachments: $attachments, tempId: $tempId) {\n        ...fragmentMessage\n      }\n    }\n  "]);return i=function(){return e},e}function a(){var e=o(["\n    subscription {\n      newMessage {\n        ...fragmentMessage\n      }\n    }\n  "]);return a=function(){return e},e}function o(e,t){return t||(t=e.slice(0)),Object.freeze(Object.defineProperties(e,{raw:{value:Object.freeze(t)}}))}function g(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function u(e,t){for(var s=0;s<t.length;s++){var r=t[s];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function l(e,t,s){return t&&u(e.prototype,t),s&&u(e,s),e}Object.defineProperty(exports,"__esModule",{value:!0});var c=require("./ElixirChatEventTypes"),h=require("./serializers/serializeMessage"),m=require("../utilsCommon"),d=require("./GraphQLClientSocket"),p=require("./GraphQLClient"),y=function(){function t(s){var r=this,o=s.elixirChat;g(this,t),this.messageHistory=[],this.hasMessageHistoryBeenEverFetched=!1,this.temporaryMessageTempIds=[],this.latestMessageHistoryCursorsCache=[],this.reachedBeginningOfMessageHistory=!1,this.subscriptionQuery=p.insertGraphQlFragments(p.gql(a()),{fragmentMessage:h.fragmentMessage}),this.sendMessageQuery=p.insertGraphQlFragments(p.gql(i()),{fragmentMessage:h.fragmentMessage}),this.messageHistoryQuery=p.insertGraphQlFragments(p.gql(n()),{fragmentMessage:h.fragmentMessage}),this.subscribe=function(){var e=r.elixirChat,t=e.apiUrl,s=e.authToken;r.graphQLClient=new p.GraphQLClient({url:t,token:s}),r.initializeSocketClient()},this.onMessageReceive=function(e){var t=r.elixirChat,s=t.triggerEvent,n=t.debug,i=m._get(e,"data.newMessage");if(i){var a=h.serializeMessage(i,r.elixirChat);r.temporaryMessageTempIds.includes(a.tempId)?r.forgetTemporaryMessage(a.tempId):(r.messageHistory.push(a),m.logEvent(n,"Received new message",{message:a}),s(c.MESSAGES_HISTORY_APPEND_ONE,a))}},this.sendMessage=function(e){var t,s=r.elixirChat.debug,n=r.serializeSendMessageParams(e),i=n.variables,a=n.binaries;if(!i.text&&!i.attachments.length){var o='Either "text" or "attachments" parameter must not be empty';return m.logEvent(s,o,{variables:i},"error"),new Promise(function(e,t){t({message:o})})}if(e.appendConditionally){t=m.randomDigitStringId(6),i.tempId=t;var g=r.generateTemporaryMessage(t,e);r.appendMessageConditionally(g)}else e.retrySubmissionByTempId&&(t=e.retrySubmissionByTempId,i.tempId=t,r.enrichTemporaryMessage(t,{isSubmitting:!0,submissionErrorCode:null}));return new Promise(function(n,o){r.graphQLClient.query(r.sendMessageQuery,i,a).then(function(a){if(a&&a.sendMessage){var g=h.serializeMessage(a.sendMessage,r.elixirChat),u=g.tempId;u?(r.enrichTemporaryMessage(u,g),m.logEvent(s,"Enriched temporary message with actual one",{message:g})):m.logEvent(s,"Sent message",{params:e,variables:i,message:g}),n(g)}else r.onSendMessageFailure(t,a),o(a)}).catch(function(e){r.onSendMessageFailure(t,e),o(e)})})},this.retrySendMessage=function(e){r.sendMessage({text:e.text,attachments:e.attachments,responseToMessageId:m._get(e,"responseToMessage.id"),retrySubmissionByTempId:e.tempId})},this.getMessageHistoryByCursor=function(t,s){var n=r.elixirChat.triggerEvent;return new Promise(function(i,a){r.reachedBeginningOfMessageHistory?i([]):r.graphQLClient.query(r.messageHistoryQuery,{limit:t,beforeCursor:s}).then(function(s){if(s&&s.messages){var o=r.hasMessageHistoryBeenEverFetched,g=p.simplifyGraphQLJSON(s.messages).map(function(e){return h.serializeMessage(e,r.elixirChat)}).filter(function(e){return!r.latestMessageHistoryCursorsCache.includes(e.cursor)});r.hasMessageHistoryBeenEverFetched=!0,r.latestMessageHistoryCursorsCache=[].concat(e(g.map(function(e){return e.cursor})),e(r.latestMessageHistoryCursorsCache)).slice(0,t),r.reachedBeginningOfMessageHistory=g.length<t,r.reachedBeginningOfMessageHistory&&g.unshift(r.generateNewClientPlaceholderMessage(g)),n(o?c.MESSAGES_FETCH_HISTORY_SUCCESS:c.MESSAGES_FETCH_HISTORY_INITIAL_SUCCESS,g),i(g)}else r.onGetMessageHistoryByCursorFailure(s),a(s)}).catch(function(e){r.onGetMessageHistoryByCursorFailure(e),a(e)})})},this.fetchMessageHistory=function(e){var t=r.elixirChat,s=t.triggerEvent,n=t.debug;return r.getMessageHistoryByCursor(e,null).then(function(e){return r.messageHistory=e,m.logEvent(n,"Fetched new message history",{processedMessageHistory:e}),s(c.MESSAGES_HISTORY_SET,e),e})},this.fetchPrecedingMessageHistory=function(e){var t=r.elixirChat,s=t.triggerEvent,n=t.debug,i=r.messageHistory[0].cursor;return i?r.getMessageHistoryByCursor(e,i).then(function(e){return r.messageHistory=e.concat(r.messageHistory),m.logEvent(n,"Fetched and prepended additional message history",{processedMessageHistory:e}),s(c.MESSAGES_HISTORY_PREPEND_MANY,e),e}):new Promise(function(e,t){var s="Failed to fetch previous message history - cursors not found";m.logEvent(n,s),t({message:s})})},this.unsubscribe=function(){var e=r.elixirChat.debug;m.logEvent(e,"Unsubscribing from messages..."),r.graphQLClientSocket.unsubscribe(),r.graphQLClientSocket=null,r.graphQLClient=null},this.elixirChat=o}return l(t,[{key:"initializeSocketClient",value:function(){var e=this.elixirChat,t=e.socketUrl,s=e.authToken,r=e.debug,n=e.triggerEvent;this.graphQLClientSocket=new d.GraphQLClientSocket({socketUrl:t,authToken:s,query:this.subscriptionQuery,onAbort:function(e){m.logEvent(r,"Failed to subscribe to messages",e,"error"),n(c.MESSAGES_SUBSCRIBE_ERROR,e)},onStart:function(){m.logEvent(r,"Successfully subscribed to messages"),n(c.MESSAGES_SUBSCRIBE_SUCCESS)},onResult:this.onMessageReceive})}},{key:"serializeSendMessageParams",value:function(e){var t="string"==typeof e.text?e.text.trim():"",s=e.tempId,r="string"==typeof e.responseToMessageId?e.responseToMessageId:null,n=[],i={};try{e.attachments.forEach(function(e){var t=e.file;n.push(t.name),i[t.name]=t})}catch(a){}return{variables:{text:t,tempId:s,attachments:n,responseToMessageId:r},binaries:i}}},{key:"generateNewClientPlaceholderMessage",value:function(e){return{timestamp:m._get(e,"[0].timestamp")||(new Date).toISOString(),id:m.randomDigitStringId(6),isSystem:!0,sender:{},attachments:[],systemData:{type:"NEW_CLIENT_PLACEHOLDER"}}}},{key:"generateTemporaryMessage",value:function(e,t){var s=t.text,r=t.attachments,n=t.responseToMessageId,i=this.messageHistory.filter(function(e){return e.id===n})[0],a=r.map(function(e){var t=e.file,s=t.type,r=URL.createObjectURL(t),n=[];return m.isWebImage(s)&&e.width&&e.height&&(n=[{id:e.id,url:r}]),Object.assign({},e,{url:r,thumbnails:n,contentType:s,bytesSize:t.size})});return{tempId:e,id:m.randomDigitStringId(6),text:s.trim()||"",timestamp:(new Date).toISOString(),sender:{isOperator:!1,isCurrentClient:!0},responseToMessage:i||null,attachments:a,isSubmitting:!0}}},{key:"appendMessageConditionally",value:function(e){var t=this.elixirChat,s=t.triggerEvent,r=t.debug;this.messageHistory.push(e),this.temporaryMessageTempIds.push(e.tempId),m.logEvent(r,"Conditionally appended message",{message:e}),s(c.MESSAGES_HISTORY_APPEND_ONE,e)}},{key:"enrichTemporaryMessage",value:function(e,t){var s=this.elixirChat.triggerEvent;this.messageHistory.forEach(function(r){if(r.tempId===e){for(var n in t)r[n]=t[n];s(c.MESSAGES_HISTORY_CHANGE_ONE,r)}})}},{key:"forgetTemporaryMessage",value:function(e){this.temporaryMessageTempIds=this.temporaryMessageTempIds.filter(function(t){return t!==e})}},{key:"onSendMessageFailure",value:function(e,t){var s=this.elixirChat.debug,r=m._get(t,"errors[0].status")||400;navigator.onLine||(r=503),m.logEvent(s,"Failed to send message with code: "+r,{response:t,tempId:e},"error"),e&&this.enrichTemporaryMessage(e,{isSubmitting:!1,submissionErrorCode:r})}},{key:"onGetMessageHistoryByCursorFailure",value:function(e){var t=this.elixirChat,s=t.triggerEvent,r=t.debug;this.hasMessageHistoryBeenEverFetched?(m.logEvent(r,"Failed to fetch message history",{error:e},"error"),s(c.MESSAGES_FETCH_HISTORY_ERROR,e)):(m.logEvent(r,"Failed to fetch initial message history",{error:e},"error"),s(c.MESSAGES_FETCH_HISTORY_INITIAL_ERROR,e))}}]),t}();exports.MessageSubscription=y;
