...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=require("../../utilsCommon");function t(i,l){var n=i||{},r=null;n.thumbnails&&n.thumbnails.length&&(r=n.thumbnails.map(function(e){var i=t(e,l);return{id:i.id,url:i.url,name:i.name,bytesSize:i.bytesSize,width:i.width,height:i.height,contentType:i.contentType,thumbType:e.thumbType||null}}));var u=e.parseUrl(l.apiUrl),a=u.protocol+"//"+u.hostname+"/",h="";return n.url&&(h=/^uploads/i.test(n.url)?a+n.url:n.url),{id:n.id||null,url:h,name:n.name||"",bytesSize:n.bytesSize||0,height:n.height||0,width:n.width||0,thumbnails:r,contentType:n.contentType||null,originalFileObject:n.originalFileObject||null}}exports.serializeFile=t;
},{"../../utilsCommon":"EjGt"}],"1lqy":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=require("../../utilsCommon"),r=require("./serializeFile");function t(t,i){var a=r.serializeFile(t.avatar||{},i),l=e._get(t,"foreignId")||null;return{id:e._get(t,"id")||null,firstName:e._get(t,"firstName")||"",lastName:e._get(t,"lastName")||"",avatar:a,isOperator:"Employee"===e._get(t,"__typename"),isCurrentClient:l===i.currentClientId,elixirChatId:l}}exports.serializeUser=t;
},{"../../utilsCommon":"EjGt","./serializeFile":"sQAQ"}],"ZEl5":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=require("../../utilsCommon"),r=require("./serializeUser"),t=require("./serializeFile");function s(s,i){var n=s.sender,a=s.attachments,u=s.data,o=void 0===u?{}:u,l=o.responseToMessage,g=o.author,m=r.serializeUser(e._merge(n,g),i),d=(a||[]).map(function(e){return t.serializeFile(e,i)}),_={id:e._get(l,"id")||null,text:e._get(l,"text")||"",sender:r.serializeUser(e._get(l,"sender",{}),i)};return{id:e._get(s,"id")||null,text:e._get(s,"text",""),timestamp:e._get(s,"timestamp",""),cursor:e._get(s,"cursor")||null,sender:m,responseToMessage:_.id?_:null,attachments:d,isSubmitting:e._get(s,"isSubmitting")||!1,isSubmissionError:e._get(s,"isSubmissionError")||!1}}exports.serializeMessage=s;
},{"../../utilsCommon":"EjGt","./serializeUser":"1lqy","./serializeFile":"sQAQ"}],"1fv+":[function(require,module,exports) {
"use strict";function e(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function t(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function n(e,n,r){return n&&t(e.prototype,n),r&&t(e,r),e}Object.defineProperty(exports,"__esModule",{value:!0});var r=require("../utilsCommon"),o=function(){function t(n){var r=n.url,o=n.token;e(this,t),this.headers={"Content-Type":"application/json",Accept:"application/json"},this.url=r,this.token=o,this.token&&(this.headers.Authorization="Bearer ".concat(this.token))}return n(t,[{key:"query",value:function(e,t,n){var r=this,o=this.headers;return n&&(o=Object.assign({},o,{Authorization:"Bearer ".concat(n)})),new Promise(function(n,a){fetch(r.url,{method:"POST",headers:o,body:JSON.stringify({query:e,variables:t})}).then(function(e){return e.json()}).then(function(e){e.errors?a(e):n(e.data)}).catch(function(e){return a(e)})})}}]),t}();exports.GraphQLClient=o,exports.prepareGraphQLQuery=function(e,t,n){var o=arguments.length>3&&void 0!==arguments[3]?arguments[3]:{},a=[],i=[];return Object.keys(n).forEach(function(e){var c=n[e];if(c){var s;if(o&&o[e])s=o[e];else if(/id$/i.test(e))s="ID";else if("string"==typeof c)s="String";else if("number"==typeof c&&c%1)s="Float";else{if("number"!=typeof c||c%1)return r.logEvent(!0,'Unable to detect GraphQL variable type for "'.concat(e,'": ').concat(c),{query:t,variables:n,optionalTypes:o},"error"),"";s="Int"}a.push("$".concat(e,": ").concat(s,"!")),i.push("".concat(e,": $").concat(e))}}),"\n    ".concat(e," (").concat(a.join(", "),") {\n      ").concat(t.trim().replace(/^([a-z_]+).*{/i,"$1 (".concat(i.join(", "),") {")),"        \n    }\n  ")},exports.simplifyGraphQLJSON=function(e){return e.edges.map(function(e){return Object.assign({},e.node,{cursor:e.cursor})})};
},{"../utilsCommon":"EjGt"}],"y8vH":[function(require,module,exports) {
"use strict";function e(e){return t(e)||r(e)||n()}function n(){throw new TypeError("Invalid attempt to spread non-iterable instance")}function r(e){if(Symbol.iterator in Object(e)||"[object Arguments]"===Object.prototype.toString.call(e))return Array.from(e)}function t(e){if(Array.isArray(e)){for(var n=0,r=new Array(e.length);n<e.length;n++)r[n]=e[n];return r}}function s(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}function i(e,n){for(var r=0;r<n.length;r++){var t=n[r];t.enumerable=t.enumerable||!1,t.configurable=!0,"value"in t&&(t.writable=!0),Object.defineProperty(e,t.key,t)}}function a(e,n,r){return n&&i(e.prototype,n),r&&i(e,r),e}var o=this&&this.__importStar||function(e){if(e&&e.__esModule)return e;var n={};if(null!=e)for(var r in e)Object.hasOwnProperty.call(e,r)&&(n[r]=e[r]);return n.default=e,n};Object.defineProperty(exports,"__esModule",{value:!0});var u=o(require("@absinthe/socket")),l=o(require("phoenix")),c=require("./serializers/serializeMessage"),f=require("./GraphQLClient"),d=function(){function n(r){var t=this;s(this,n),this.latestMessageHistoryCursorsCache=[],this.reachedBeginningOfMessageHistory=!1,this.isBeforeUnload=!1,this.subscriptionQuery="\n    subscription {\n      newMessage {\n        id\n        text\n        timestamp\n        data {\n          ... on NotSystemMessageData {\n            responseToMessage {\n              id\n              text\n              sender {\n                __typename\n                ... on Client { id foreignId firstName lastName }\n                ... on Employee { id firstName lastName }\n              }\n            }\n          }\n        }\n        sender {\n          __typename\n          ... on Client { id foreignId firstName lastName }\n          ... on Employee { id firstName lastName }\n        }\n      }\n    }\n  ",this.sendMessageQuery="\n    sendMessage {\n      id\n      text\n      timestamp\n      data {\n        ... on NotSystemMessageData {\n          responseToMessage {\n            id\n            text\n            sender {\n              __typename\n              ... on Client { id foreignId firstName lastName }\n              ... on Employee { id firstName lastName }\n            }\n          }\n        }\n      }\n      sender {\n        __typename\n        ... on Client { id foreignId firstName lastName }\n        ... on Employee { id firstName lastName }\n      }\n    }\n  ",this.messageHistoryQuery="\n    messages {\n      edges {\n        cursor\n        node {\n          id\n          text\n          timestamp\n          data {\n            ... on NotSystemMessageData {\n              responseToMessage {\n                id\n                text\n                sender {\n                  __typename\n                  ... on Client { id foreignId firstName lastName }\n                  ... on Employee { id firstName lastName }\n                }\n              }\n            }\n          }\n          sender {\n            __typename\n            ... on Client { id foreignId firstName lastName }\n            ... on Employee { id firstName lastName }\n          }\n        }\n      }\n    }\n  ",this.onBeforeUnload=function(){return t.isBeforeUnload=!0,!1},this.unsubscribe=function(){window.removeEventListener("beforeunload",t.onBeforeUnload),t.absintheSocket=u.cancel(t.absintheSocket,t.notifier),t.latestMessageHistoryCursorsCache=[],t.reachedBeginningOfMessageHistory=!1},this.sendMessage=function(e){var n={text:e.text,responseToMessageId:e.responseToMessageId},r=f.prepareGraphQLQuery("mutation",t.sendMessageQuery,n);return new Promise(function(e,s){n.text&&t.graphQLClient.query(r,n).then(function(i){if(i&&i.sendMessage){var a=c.serializeMessage(i.sendMessage,{apiUrl:t.apiUrl,currentClientId:t.currentClientId});e(a)}else s({error:i,variables:n,graphQLQuery:r})}).catch(function(e){s({error:e,variables:n,graphQLQuery:r})})})},this.fetchMessageHistory=function(n,r){var s={last:n,before:r},i=f.prepareGraphQLQuery("query",t.messageHistoryQuery,s,{before:"String"});return new Promise(function(a,o){t.reachedBeginningOfMessageHistory?a([]):t.graphQLClient.query(i,s).then(function(u){if(u.messages){var l=f.simplifyGraphQLJSON(u.messages).map(function(e){return c.serializeMessage(e,{apiUrl:t.apiUrl,currentClientId:t.currentClientId})}).filter(function(e){return!t.latestMessageHistoryCursorsCache.includes(e.cursor)});t.latestMessageHistoryCursorsCache=[].concat(e(l.map(function(e){return e.cursor})),e(t.latestMessageHistoryCursorsCache)).slice(0,n),l.length<n&&(t.reachedBeginningOfMessageHistory=!0),a(l)}else o({response:u,limit:n,beforeCursor:r,query:i,variables:s})}).catch(function(e){o({error:e,limit:n,beforeCursor:r,query:i,variables:s})})})},this.apiUrl=r.apiUrl,this.socketUrl=r.socketUrl,this.token=r.token,this.currentClientId=r.currentClientId,this.onSubscribeSuccess=r.onSubscribeSuccess||function(){},this.onSubscribeError=r.onSubscribeError||function(){},this.onMessage=r.onMessage,this.initialize()}return a(n,[{key:"initialize",value:function(){this.absintheSocket=u.create(new l.Socket(this.socketUrl,{params:{token:this.token}})),this.graphQLClient=new f.GraphQLClient({url:this.apiUrl,token:this.token}),window.addEventListener("beforeunload",this.onBeforeUnload),this.subscribe()}},{key:"subscribe",value:function(){var e=this,n=u.send(this.absintheSocket,{operation:this.subscriptionQuery});u.observe(this.absintheSocket,n,{onAbort:function(n){return e.onSubscribeFail(n,"onAbort")},onError:function(n){e.isBeforeUnload||e.onSubscribeFail(n,"onError")},onStart:function(n){e.notifier=n,e.onSubscribeSuccess(n)},onResult:function(n){var r=n.data;if(r&&r.newMessage){var t=c.serializeMessage(r.newMessage,{apiUrl:e.apiUrl,currentClientId:e.currentClientId});e.onMessage(t)}}})}},{key:"onSubscribeFail",value:function(e,n){this.onSubscribeError({error:e,variables:{methodName:n},graphQLQuery:this.subscriptionQuery})}}]),n}();exports.MessagesSubscription=d;
...
"use strict";function e(e,i){return n(e)||o(e,i)||t()}function t(){throw new TypeError("Invalid attempt to destructure non-iterable instance")}function o(e,t){var o=[],n=!0,i=!1,r=void 0;try{for(var s,a=e[Symbol.iterator]();!(n=(s=a.next()).done)&&(o.push(s.value),!t||o.length!==t);n=!0);}catch(c){i=!0,r=c}finally{try{n||null==a.return||a.return()}finally{if(i)throw r}}return o}function n(e){if(Array.isArray(e))return e}function i(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function r(e,t){for(var o=0;o<t.length;o++){var n=t[o];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}function s(e,t,o){return t&&r(e.prototype,t),o&&r(e,o),e}Object.defineProperty(exports,"__esModule",{value:!0});var a=require("unique-names-generator"),c=require("../utilsCommon"),l=require("./MessagesSubscription"),u=require("./TypingStatusSubscription"),h=require("./ScreenshotTaker"),m=require("./GraphQLClient");exports.API_REFERENCE_URL="https://github.com/elixirchat/elixirchat-js-sdk";var g=function(){function t(e){var o=this;i(this,t),this.joinRoomQuery="\n    joinRoom {\n      token\n      room {\n        id\n        title\n        foreignId\n        members {\n          client {\n            id\n            foreignId\n            firstName\n            lastName\n          }\n        }\n      }\n    }\n  ",this.onMessageCallbacks=[],this.onConnectSuccessCallbacks=[],this.onConnectErrorCallbacks=[],this.onTypingCallbacks=[],this.dispatchTypedText=function(e){o.typingStatusSubscription.dispatchTypedText(e)},this.onMessage=function(e){o.onMessageCallbacks.push(e)},this.onTyping=function(e){o.onTypingCallbacks.push(e)},this.reconnect=function(e){var t=e.room,n=e.client;return c.logEvent(o.debug,"Attempting to reconnect to another room",{room:t,client:n}),t&&(o.room=t),n&&(o.client=n),o.setDefaultConfigValues(),o.messagesSubscription.unsubscribe(),o.connectToRoom().then(function(){o.saveRoomClientToLocalStorage(o.room,o.client),o.subscribeToNewMessages(),o.typingStatusSubscription.resubscribeToAnotherRoom(o.room.id)})},this.onConnectSuccess=function(e){o.onConnectSuccessCallbacks.push(e)},this.onConnectError=function(e){o.onConnectErrorCallbacks.push(e)},this.takeScreenshot=function(){return o.screenshotTaker.takeScreenshot().then(function(e){return c.logEvent(o.debug,"Captured screenshot",e),e}).catch(function(e){throw c.logEvent(o.debug,"Could not capture screenshot",e,"error"),e})},this.fetchMessageHistory=function(e,t){return o.messagesSubscription.fetchMessageHistory(e,t).then(function(n){return c.logEvent(o.debug,"Fetched message history",{limit:e,beforeCursor:t,messages:n}),n}).catch(function(e){throw c.logEvent(o.debug,"Could not fetch message history",e,"error"),e})},this.apiUrl=e.apiUrl,this.socketUrl=e.socketUrl,this.companyId=e.companyId,this.debug=e.debug||!1,this.room=e.room,this.client=e.client;var n=this.getRoomClientFromLocalStorage();this.room&&this.room.id||(this.room=n.room),this.client&&this.client.id||(this.client=n.client),this.initialize()}return s(t,[{key:"initialize",value:function(){var e=this;this.companyId?(c.logEvent(this.debug,"Initializing ElixirChat",{apiUrl:this.apiUrl,socketUrl:this.socketUrl,companyId:this.companyId,room:this.room,client:this.client,debug:this.debug}),this.screenshotTaker=new h.ScreenshotTaker,this.setDefaultConfigValues(),this.connectToRoom().then(function(){e.saveRoomClientToLocalStorage(e.room,e.client),e.subscribeToNewMessages(),e.subscribeToTypingStatusChange()})):c.logEvent(this.debug,"Required parameter companyId is not provided: \nSee more: ".concat(exports.API_REFERENCE_URL,"#config-companyid"),null,"error")}},{key:"getDefaultClientData",value:function(){var t=a.uniqueNamesGenerator({length:2,separator:" ",dictionaries:null}),o=e(t.split(" ").map(c.capitalize),2),n=o[0],i=o[1],r=c.randomDigitStringId(4),s={id:t.replace(" ","-")+"-"+r,firstName:n,lastName:i};return c.logEvent(this.debug,"Generated default client data",s),s}},{key:"getRoomClientFromLocalStorage",value:function(){var e,t;try{e=JSON.parse(localStorage.getItem("elixirchat-room"))}catch(o){}try{t=JSON.parse(localStorage.getItem("elixirchat-client"))}catch(o){}return c.logEvent(this.debug,"Fetched room, client values from localStorage",{room:e,client:t}),{room:e,client:t}}},{key:"saveRoomClientToLocalStorage",value:function(e,t){localStorage.setItem("elixirchat-room",JSON.stringify(e)),localStorage.setItem("elixirchat-client",JSON.stringify(t))}},{key:"setDefaultConfigValues",value:function(){var e=this.client||{},t=this.room||{},o=this.getDefaultClientData(),n=e.id||o.id,i=e.firstName,r=e.lastName;i||r||(i=o.firstName,r=o.lastName),this.client={id:n,firstName:i,lastName:r};var s=t.id||o.id,a=t.title||o.firstName+" "+o.lastName,l=t.data||{};this.room={id:s,title:a,data:l},c.logEvent(this.debug,"Set room and client values",{room:this.room,client:this.client})}},{key:"serializeRoomData",value:function(e){var t={};for(var o in e)t[o]=e[o].toString();return JSON.stringify(t)}},{key:"connectToRoom",value:function(){var e=this;this.graphQLClient=new m.GraphQLClient({url:this.apiUrl});var t={companyId:this.companyId,room:{id:this.room.id,title:this.room.title,data:this.serializeRoomData(this.room.data)},client:this.client},o=m.prepareGraphQLQuery("mutation",this.joinRoomQuery,t,{companyId:"ID",room:"ForeignRoom",client:"ForeignClient"});return new Promise(function(n,i){e.graphQLClient.query(o,t).then(function(r){var s=r.joinRoom;if(s){e.authToken=s.token,e.connected=!0;var a=e.getClientByRoomMembers(s.room.members);e.client.firstName=a.firstName,e.client.lastName=a.lastName,e.client.id=a.foreignId,e.elixirChatClientId=a.id,e.room.id=s.room.foreignId,e.room.title=s.room.title,e.elixirChatRoomId=s.room.id,c.logEvent(e.debug,"Joined room",{joinRoom:s,room:e.room,client:e.client}),n(s)}else c.logEvent(e.debug,"Failed to join room",{joinRoom:s,query:o,variables:t},"error"),e.onConnectErrorCallbacks.forEach(function(e){return e(s)}),i(s)}).catch(function(n){c.logEvent(e.debug,"Failed to join room",{response:n,query:o,variables:t},"error"),e.onConnectErrorCallbacks.forEach(function(e){return e(n)}),i(n)})})}},{key:"getClientByRoomMembers",value:function(){var e=this,t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:[{}];try{var o=t.filter(function(t){return t.client.foreignId===e.client.id})[0].client;return c.logEvent(this.debug,"Got client info by room members list",{client:o}),o}catch(n){return c.logEvent(this.debug,"Failed to get client info from room members list",{members:t},"error"),{}}}},{key:"subscribeToTypingStatusChange",value:function(){var e=this;this.typingStatusSubscription=new u.TypingStatusSubscription({socketUrl:this.socketUrl,token:this.authToken,roomId:this.elixirChatRoomId,clientId:this.elixirChatClientId,onSubscribeSuccess:function(){c.logEvent(e.debug,"Successfully subscribed to typing status change",{roomId:e.elixirChatRoomId})},onSubscribeError:function(t){c.logEvent(e.debug,"Failed to subscribe to typing status change",t,"error")},onChange:function(t){c.logEvent(e.debug,"Some users started/stopped typing",{peopleWhoAreTyping:t}),e.onTypingCallbacks.forEach(function(e){return e(t)})}})}},{key:"subscribeToNewMessages",value:function(){var e=this;this.messagesSubscription=new l.MessagesSubscription({socketUrl:this.socketUrl,apiUrl:this.apiUrl,token:this.authToken,currentClientId:this.client.id,onSubscribeSuccess:function(){var t={room:e.room,client:e.client};c.logEvent(e.debug,"Successfully subscribed to messages",t),e.onConnectSuccessCallbacks.forEach(function(e){return e(t)})},onSubscribeError:function(t){c.logEvent(e.debug,"Failed to subscribe to messages",{data:t},"error"),e.onConnectErrorCallbacks.forEach(function(e){return e(t)})},onMessage:function(t){c.logEvent(e.debug,"Received new message",t),e.onMessageCallbacks.forEach(function(e){return e(t)})}})}},{key:"sendMessage",value:function(e){var t=this,o=e.text,n=e.attachments&&e.attachments.length?Array.from(e.attachments).filter(function(e){return e}):[],i="string"==typeof e.responseToMessageId?e.responseToMessageId:null;if(o.trim()||n.length)return this.messagesSubscription.sendMessage({text:o,attachments:n,responseToMessageId:i}).then(function(r){return c.logEvent(t.debug,"Sent message",{message:r,params:e,normalizedParams:{text:o,attachments:n,responseToMessageId:i}}),t.typingStatusSubscription.dispatchTypedText(!1),r}).catch(function(e){throw c.logEvent(t.debug,"Failed to send message",e,"error"),e});var r='Either "text" or "attachment" property must not be empty';return c.logEvent(this.debug,r,e,"error"),new Promise(function(t,o){o({message:r,params:e})})}},{key:"reachedBeginningOfMessageHistory",get:function(){return!!this.messagesSubscription&&this.messagesSubscription.reachedBeginningOfMessageHistory}}]),t}();exports.ElixirChat=g,"undefined"!=typeof window&&(window.ElixirChat=g);
