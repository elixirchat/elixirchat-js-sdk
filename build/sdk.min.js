...
"use strict";function _templateObject(){var e=_taggedTemplateLiteral(["\n      mutation($companyId: Uuid!, $room: ForeignRoom, $client: ForeignClient!) {\n        joinRoom (companyId: $companyId, room: $room, client: $client) {\n          token\n          company {\n            isWorking\n            workHoursStartAt\n            widgetTitle\n            employees(first: 20) {\n              count\n              edges {\n                node { ...fragmentUser }\n              }\n            }\n          }\n          client {\n            ...fragmentUser\n            omnichannelCode\n          }\n          room {\n            id\n            title\n            foreignId\n            mustOpenWidget\n            unreadMessagesCount\n            unreadRepliesCount\n          }\n        }\n      }\n    "]);return _templateObject=function _templateObject(){return e},e}function _taggedTemplateLiteral(e,t){return t||(t=e.slice(0)),Object.freeze(Object.defineProperties(e,{raw:{value:Object.freeze(t)}}))}function _slicedToArray(e,t){return _arrayWithHoles(e)||_iterableToArrayLimit(e,t)||_unsupportedIterableToArray(e,t)||_nonIterableRest()}function _nonIterableRest(){throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function _unsupportedIterableToArray(e,t){if(e){if("string"==typeof e)return _arrayLikeToArray(e,t);var n=Object.prototype.toString.call(e).slice(8,-1);return"Object"===n&&e.constructor&&(n=e.constructor.name),"Map"===n||"Set"===n?Array.from(e):"Arguments"===n||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)?_arrayLikeToArray(e,t):void 0}}function _arrayLikeToArray(e,t){(null==t||t>e.length)&&(t=e.length);for(var n=0,r=new Array(t);n<t;n++)r[n]=e[n];return r}function _iterableToArrayLimit(e,t){if("undefined"!=typeof Symbol&&Symbol.iterator in Object(e)){var n=[],r=!0,i=!1,o=void 0;try{for(var a,s=e[Symbol.iterator]();!(r=(a=s.next()).done)&&(n.push(a.value),!t||n.length!==t);r=!0);}catch(u){i=!0,o=u}finally{try{r||null==s.return||s.return()}finally{if(i)throw o}}return n}}function _arrayWithHoles(e){if(Array.isArray(e))return e}function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function _typeof(e){return typeof e}:function _typeof(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _defineProperties(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function _createClass(e,t,n){return t&&_defineProperties(e.prototype,t),n&&_defineProperties(e,n),e}Object.defineProperty(exports,"__esModule",{value:!0}),exports.ElixirChat=void 0;var e=require("unique-names-generator"),t=require("../utilsCommon"),n=require("./serializers/serializeUser"),r=require("./Logger"),i=require("./ScreenshotTaker"),o=require("./TypingStatusSubscription"),a=require("./UpdateMessageSubscription"),s=require("./OnlineStatusSubscription"),u=require("./UnreadMessagesCounter"),l=require("./MessageSubscription"),c=require("./GraphQLClient"),h=require("./GraphQLClientSocket"),d=require("./ElixirChatEventTypes"),m=require("../utilsWidget"),g=function(){function ElixirChat(e){var t=this;_classCallCheck(this,ElixirChat),this.version="4.0.2.omnichannel@8",this.config={},this.joinRoomData={},this.isInitialized=!1,this.eventHandlers={},this.on=function(e,n){var r;if(e instanceof Array)e.map(function(e){return t.on(e,n)});else{(null===(r=t.eventHandlers[e])||void 0===r?void 0:r.callbacks)||(t.eventHandlers[e]={callbacks:{}});var i=t.eventHandlers[e],o=t.getCallbackUniqueHash(n);i.callbacks[o]=n,i.firedOnce&&n(i.firedOnceArguments)}},this.off=function(e,n){var r=t.eventHandlers[e];if(n)for(var i in r.callbacks){if(r.callbacks[i]===n)return void delete r.callbacks[i]}else r.callbacks={}},this.triggerEvent=function(e,n,r){var i;r=r||{},t.logEvent(e,n),(null===(i=t.eventHandlers[e])||void 0===i?void 0:i.callbacks)||(t.eventHandlers[e]={callbacks:{}});var o=t.eventHandlers[e];o.firedOnce=r.firedOnce,r.firedOnce&&(o.firedOnceArguments=n),Object.values(o.callbacks).forEach(function(e){return e(n)})},this.sendMessage=function(e){return t.checkIfConnected().then(function(){return t.typingStatusSubscription.dispatchTypedText(!1),t.messageSubscription.sendMessage(e)})},this.retrySendMessage=function(e){return t.checkIfConnected().then(function(){return t.messageSubscription.retrySendMessage(e)})},this.fetchMessageHistory=function(e){return t.checkIfConnected().then(function(){return t.messageSubscription.fetchMessageHistory(e)})},this.fetchPrecedingMessageHistory=function(e){return t.checkIfConnected().then(function(){return t.messageSubscription.fetchPrecedingMessageHistory(e)})},this.dispatchTypedText=function(e){return t.checkIfConnected().then(function(){return t.typingStatusSubscription.dispatchTypedText(e)})},this.setLastReadMessage=function(e){return t.checkIfConnected().then(function(){return t.unreadMessagesCounter.setLastReadMessage(e)})},this.takeScreenshot=function(){return t.screenshotTaker.takeScreenshot()},this.logEvent=function(e,n){return t.logger.logEvent(e,n)},this.logInfo=function(e,n){return t.logger.logInfo(e,n)},this.logError=function(e,n){return t.logger.logError(e,n)},this.sendAPIRequest=function(e,n,r){var i=c.parseGraphQLMethodFromQuery(e);return t.graphQLClient.query(e,n,r).then(function(e){return e[i]}).catch(function(r){var o,a,s="".concat(i,": ").concat(c.getErrorMessageFromResponse(r)),u={errorMessage:s,errorType:(null===(a=null===(o=null==r?void 0:r.errors)||void 0===o?void 0:o[0])||void 0===a?void 0:a.reason)||null,rawError:r,query:e,variables:n,graphQLMethod:i};throw t.logError(s,u),Object.assign({errorMessage:s},u)})},this.disconnect=function(){return t.checkIfConnected().then(function(){t.logInfo("Disconnecting from ElixirChat"),t.isConnected=!1,t.messageSubscription.unsubscribe(),t.updateMessageSubscription.unsubscribe(),t.unreadMessagesCounter.unsubscribe(),t.typingStatusSubscription.unsubscribe(),t.onlineStatusSubscription.unsubscribe()})},this.reconnect=function(e){return t.logInfo("Attempting to reconnect to another room",e),t.disconnect(),t.joinRoom(e.room,e.client)},this.hasAllRequiredConfigParameters(e)&&this.initialize(e),"undefined"!=typeof window&&(window.elixirChat=this)}return _createClass(ElixirChat,[{key:"hasAllRequiredConfigParameters",value:function hasAllRequiredConfigParameters(e){var t=["apiUrl","socketUrl","companyId"].filter(function(t){return!e[t]});if(t.length)throw"Required parameters: ".concat(t.join(", ")," not provided. \nSee more: https://github.com/elixirchat/elixirchat-js-sdk#config");return!0}},{key:"initialize",value:function initialize(e){var t=this;return this.config=e||{},this.isInitialized=!0,this.graphQLClient=new c.GraphQLClient,this.graphQLClientSocket=new h.GraphQLClientSocket,this.logger=new r.Logger({elixirChat:this}),this.screenshotTaker=new i.ScreenshotTaker({elixirChat:this}),this.messageSubscription=new l.MessageSubscription({elixirChat:this}),this.unreadMessagesCounter=new u.UnreadMessagesCounter({elixirChat:this}),this.updateMessageSubscription=new a.UpdateMessageSubscription({elixirChat:this}),this.typingStatusSubscription=new o.TypingStatusSubscription({elixirChat:this}),this.onlineStatusSubscription=new s.OnlineStatusSubscription({elixirChat:this}),this.on(d.UPDATE_MESSAGES_CHANGE,function(e){t.messageSubscription.changeMessageBy({id:e.id},e)}),this.on(d.LAST_READ_MESSAGE_CHANGE,function(e){t.messageSubscription.markPrecedingMessagesRead(e)}),this.logInfo("Initializing ElixirChat",e),this.joinRoom()}},{key:"serializeClient",value:function serializeClient(e){e=e||{};var n=t.getFromLocalStorage("elixirchat-client")||{},r=this.generateAnonymousClientData(),i=e.id||n.id||r.id,o="string"==typeof e.firstName?e.firstName:n.firstName||r.firstName,a="string"==typeof e.lastName?e.lastName:n.lastName||r.lastName;return o||a||(o=n.firstName||r.firstName,a=n.lastName||r.lastName),{id:i.toString(),firstName:o,lastName:a}}},{key:"serializeRoom",value:function serializeRoom(e,n){e=e||{};var r=t.getFromLocalStorage("elixirchat-room")||{},i=e.id||r.id||n.id,o=e.title||r.title||n.firstName+" "+n.lastName,a={};if("object"===_typeof(e.data))for(var s in e.data)a[s]=e.data[s].toString();return{id:i.toString(),title:o,data:JSON.stringify(a)}}},{key:"generateAnonymousClientData",value:function generateAnonymousClientData(){var n=e.uniqueNamesGenerator({length:2,separator:" ",dictionaries:null}),r=_slicedToArray(n.split(" ").map(t.capitalize),2),i=r[0],o=r[1],a=t.randomDigitStringId(4);return{id:n.replace(" ","-")+"-"+a,firstName:i,lastName:o}}},{key:"joinRoom",value:function joinRoom(e,r){var i=this;this.client=this.serializeClient(r),this.room=this.serializeRoom(e,this.client),this.isPrivateRoom=this.room.id===this.client.id,t.setToLocalStorage("elixirchat-room",this.room),t.setToLocalStorage("elixirchat-client",this.client);var o={companyId:this.config.companyId,client:this.client,room:this.room},a=c.insertGraphQlFragments(c.gql(_templateObject()),{fragmentUser:n.fragmentUser}),s=new c.GraphQLClient;return s.initialize({url:this.config.apiUrl}),s.query(a,o).then(function(e){if(null==e?void 0:e.joinRoom){var t=i.serializeJoinRoomData(e.joinRoom);return i.joinRoomData=t,i.onJoinRoomSuccess(t),i.triggerEvent(d.JOIN_ROOM_SUCCESS,t,{firedOnce:!0}),t}throw i.triggerEvent(d.JOIN_ROOM_ERROR,e),e}).catch(function(e){throw i.triggerEvent(d.JOIN_ROOM_ERROR,e),e})}},{key:"onJoinRoomSuccess",value:function onJoinRoomSuccess(e){var t=this.config,n=t.apiUrl,r=t.socketUrl,i=e.token,o=e.isOnline,a=e.workHoursStartAt,s=e.unreadMessagesCount,u=e.unreadRepliesCount;this.logInfo("Joined room",e),this.isConnected=!0,this.graphQLClient.initialize({url:n,token:i}),this.graphQLClientSocket.initialize({url:r,token:i}),this.messageSubscription.subscribe(),this.updateMessageSubscription.subscribe(),this.onlineStatusSubscription.subscribe({isOnline:o,workHoursStartAt:a}),this.unreadMessagesCounter.subscribe({unreadMessagesCount:s,unreadRepliesCount:u})}},{key:"serializeJoinRoomData",value:function serializeJoinRoomData(e){var t,r=this,i=e.token,o=e.room,a=void 0===o?{}:o,s=e.client,u=void 0===s?{}:s,l=e.company,h=void 0===l?{}:l;return{token:i,logoUrl:h.logoUrl,mainTitle:h.widgetTitle,chatSubtitle:h.widgetChatSubtitle,channels:this.serializeChannels(h.channels,u.omnichannelCode),employeesCount:(null===(t=h.employees)||void 0===t?void 0:t.count)||0,employees:c.simplifyGraphQLJSON(null==h?void 0:h.employees).map(function(e){return n.serializeUser(e,r)}),isOnline:h.isWorking,isPopupOpen:a.mustOpenWidget,workHoursStartAt:h.workHoursStartAt,elixirChatClientId:u.id,elixirChatRoomId:a.id,unreadMessagesCount:a.unreadMessagesCount,unreadRepliesCount:a.unreadRepliesCount,omnichannelCode:u.omnichannelCode}}},{key:"serializeChannels",value:function serializeChannels(e,n){e=[{type:"whatsapp",username:"917290961818"},{type:"telegram",username:"elixirchat_test_bot"},{type:"vkontakte",username:"club198196792"},{type:"viber",username:"chathelpdesk"},{type:"facebook",username:"huntflow"}];var r=m.isMobileSizeScreen(),i="Чтобы продолжить, просто отправьте целиком это сообщение. Ваш код: ".concat(n),o={whatsapp:"https://web.whatsapp.com/send?phone={{ username }}&text={{ manualMessage }}",telegram:"http://t.me/{{ username }}?start={{ omnichannelCode }}",viber:"viber://pa?chatURI={{ username }}&context={{ omnichannelCode }}",facebook:"https://m.me/{{ username }}?ref={{ omnichannelCode }}",vkontakte:"https://vk.me/{{ username }}?ref={{ omnichannelCode }}"},a={whatsapp:"whatsapp://send?phone={{ username }}&text={{ manualMessage }}",telegram:"tg://resolve?domain={{ username }}&start={{ omnichannelCode }}",viber:"viber://pa?chatURI={{ username }}&context={{ omnichannelCode }}",facebook:"https://m.me/{{ username }}?ref={{ omnichannelCode }}",vkontakte:"https://vk.me/{{ username }}?ref={{ omnichannelCode }}"};return(e||[]).map(function(e){var s=e.username,u=e.type.toLowerCase(),l=r?a[u]:o[u],c=t.template(l,{username:s,omnichannelCode:n,manualMessage:i});return{type:u,username:s,omnichannelCode:n,url:c}})}},{key:"checkIfConnected",value:function checkIfConnected(){if(this.isConnected)return Promise.resolve();var e="ElixirChat is not currently connected. Use reconnect({ room, client }) method to connect to a room.";return this.logError(e),Promise.reject({message:e})}},{key:"getCallbackUniqueHash",value:function getCallbackUniqueHash(e){var n=new Error,r=t.hashCode((n.stack||"").trim().replace(/^Error\n\s*/,"").split(/\n/).map(function(e){return e.trim()}).filter(function(e){return e}).slice(0,3).join("\n")),i=t.hashCode(e.toString());return Math.abs(i+r)}},{key:"onlineStatus",get:function get(){return this.onlineStatusSubscription.onlineStatus}},{key:"unreadMessagesCount",get:function get(){return this.unreadMessagesCounter.unreadMessagesCount}},{key:"unreadRepliesCount",get:function get(){return this.unreadMessagesCounter.unreadRepliesCount}},{key:"lastReadMessageId",get:function get(){return this.unreadMessagesCounter.lastReadMessageId}},{key:"messageHistory",get:function get(){return this.messageSubscription.messageHistory}}]),ElixirChat}();exports.ElixirChat=g,"undefined"!=typeof window&&(window.ElixirChat=g);
