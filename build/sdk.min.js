...
"use strict";function _templateObject2(){var e=_taggedTemplateLiteral(["\n    mutation ($messageId: ID!) {\n      updateLastReadMessage(messageId: $messageId) {\n        unreadMessagesCount,\n        unreadRepliesCount,\n      }\n    }\n  "]);return _templateObject2=function _templateObject2(){return e},e}function _templateObject(){var e=_taggedTemplateLiteral(["\n    subscription {\n      updateReadMessages {\n        unreadMessagesCount\n        unreadRepliesCount\n        lastReadMessageId\n      }\n    }\n  "]);return _templateObject=function _templateObject(){return e},e}function _taggedTemplateLiteral(e,t){return t||(t=e.slice(0)),Object.freeze(Object.defineProperties(e,{raw:{value:Object.freeze(t)}}))}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _defineProperties(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function _createClass(e,t,n){return t&&_defineProperties(e.prototype,t),n&&_defineProperties(e,n),e}Object.defineProperty(exports,"__esModule",{value:!0}),exports.UnreadCounter=void 0;var e=require("./GraphQLClient"),t=require("./ElixirChatEventTypes"),n=function(){function UnreadCounter(n){var r=this,a=n.elixirChat;_classCallCheck(this,UnreadCounter),this.unreadMessagesCount=0,this.unreadRepliesCount=0,this.lastReadMessageId=null,this.subscriptionQuery=e.gql(_templateObject()),this.setLastReadMessageQuery=e.gql(_templateObject2()),this.subscribe=function(e){var n=r.elixirChat,a=n.graphQLClientSocket,s=n.logInfo,u=n.logError,i=n.triggerEvent;r.onUnreadCounterUpdate(e),a.subscribe({query:r.subscriptionQuery,onAbort:function onAbort(n){u("UnreadCounter: Failed to subscribe",{error:n}),i(t.ERROR_ALERT,{customMessage:"UnreadCounter: Failed to subscribe",error:n,retryCallback:function retryCallback(){return r.subscribe(e)}})},onStart:function onStart(){s("UnreadCounter: Subscribed"),i(t.UNREAD_COUNTER_SUBSCRIBE_SUCCESS,e)},onResult:function onResult(e){var t,n=(null===(t=null==e?void 0:e.data)||void 0===t?void 0:t.updateReadMessages)||{};r.onUnreadCounterUpdate(n)}})},this.setLastReadMessage=function(e){var t=r.elixirChat.sendAPIRequest;if(e!==r.lastReadMessageId)return t(r.setLastReadMessageQuery,{messageId:e})},this.unsubscribe=function(){var e=r.elixirChat,t=e.graphQLClientSocket;(0,e.logInfo)("UnreadCounter: Unsubscribing..."),t.unsubscribe(r.subscriptionQuery),r.onUnreadCounterUpdate({unreadMessagesCount:0,unreadRepliesCount:0})},this.elixirChat=a}return _createClass(UnreadCounter,[{key:"onUnreadCounterUpdate",value:function onUnreadCounterUpdate(e){var n=this.elixirChat,r=n.triggerEvent,a=n.logInfo,s=e.unreadMessagesCount,u=e.unreadRepliesCount,i=(e.lastReadMessageId||"").toString().trim();s!==this.unreadMessagesCount&&(this.unreadMessagesCount=s,a("Unread messages count changed to "+s),r(t.UNREAD_COUNTER_MESSAGES_CHANGE,s)),u!==this.unreadRepliesCount&&(this.unreadRepliesCount=u,a("Unread replies count changed to "+u),r(t.UNREAD_COUNTER_REPLIES_CHANGE,u)),i!==this.lastReadMessageId&&(this.lastReadMessageId=i,a("Last message marked as read changed to: "+i),r(t.UNREAD_COUNTER_LAST_READ_MESSAGE_CHANGE,i))}}]),UnreadCounter}();exports.UnreadCounter=n;
