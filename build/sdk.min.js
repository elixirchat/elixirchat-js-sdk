...
"use strict";function _templateObject(){var e=_taggedTemplateLiteral(["\n    subscription {\n      updateMessage {\n        ...fragmentMessage\n      }\n    }\n  "]);return _templateObject=function _templateObject(){return e},e}function _taggedTemplateLiteral(e,t){return t||(t=e.slice(0)),Object.freeze(Object.defineProperties(e,{raw:{value:Object.freeze(t)}}))}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0}),exports.UpdateMessageSubscription=void 0;var e=require("./ElixirChatEventTypes"),t=require("./serializers/serializeMessage"),r=require("./GraphQLClient"),i=function UpdateMessageSubscription(i){var s=this,a=i.elixirChat;_classCallCheck(this,UpdateMessageSubscription),this.subscriptionQuery=r.insertGraphQlFragments(r.gql(_templateObject()),{fragmentMessage:t.fragmentMessage}),this.subscribe=function(){var r=s.elixirChat,i=r.graphQLClientSocket,a=r.triggerEvent,n=r.logInfo,o=r.logError;i.subscribe({query:s.subscriptionQuery,onAbort:function onAbort(e){o("UpdateMessageSubscription: Failed to subscribe",{error:e})},onStart:function onStart(){n("UpdateMessageSubscription: Subscribed")},onResult:function onResult(r){var i,n=null===(i=null==r?void 0:r.data)||void 0===i?void 0:i.updateMessage;if(n){var o=t.serializeMessage(n,s.elixirChat);a(e.UPDATE_MESSAGES_CHANGE,o)}}})},this.unsubscribe=function(){var e=s.elixirChat,t=e.graphQLClientSocket;(0,e.logInfo)("UpdateMessageSubscription: Unsubscribing..."),t.unsubscribe(s.subscriptionQuery)},this.elixirChat=a};exports.UpdateMessageSubscription=i;
},{"./ElixirChatEventTypes":"Cteb","./serializers/serializeMessage":"ZEl5","./GraphQLClient":"fvSB"}],"XLSb":[function(require,module,exports) {
"use strict";function _templateObject(){var t=_taggedTemplateLiteral(["\n    subscription {\n      updateCompanyWorking {\n        isWorking\n        workHoursStartAt\n      }\n    }\n  "]);return _templateObject=function _templateObject(){return t},t}function _taggedTemplateLiteral(t,e){return e||(e=t.slice(0)),Object.freeze(Object.defineProperties(t,{raw:{value:Object.freeze(e)}}))}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _defineProperties(t,e){for(var n=0;n<e.length;n++){var i=e[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}function _createClass(t,e,n){return e&&_defineProperties(t.prototype,e),n&&_defineProperties(t,n),t}Object.defineProperty(exports,"__esModule",{value:!0}),exports.OnlineStatusSubscription=void 0;var t=require("./GraphQLClient"),e=require("./ElixirChatEventTypes"),n=function(){function OnlineStatusSubscription(e){var n=this,i=e.elixirChat;_classCallCheck(this,OnlineStatusSubscription),this.onlineStatus={isOnline:!1,workHoursStartAt:null},this.subscriptionQuery=t.gql(_templateObject()),this.subscribe=function(t){var e=n.elixirChat,i=e.graphQLClientSocket,r=e.logInfo,s=e.logError,o=t||{},a=o.isOnline,u=o.workHoursStartAt;n.onStatusChange({isOnline:a,workHoursStartAt:u}),i.subscribe({query:n.subscriptionQuery,onAbort:function onAbort(t){s("OnlineStatusSubscription: Failed to subscribe",{error:t})},onStart:function onStart(){r("OnlineStatusSubscription: Subscribed")},onResult:function onResult(t){var e=t.data.updateCompanyWorking;n.onStatusChange({isOnline:null==e?void 0:e.isWorking,workHoursStartAt:null==e?void 0:e.workHoursStartAt})}})},this.unsubscribe=function(){var t=n.elixirChat,e=t.graphQLClientSocket;(0,t.logInfo)("OnlineStatusSubscription: Unsubscribing..."),e.unsubscribe(n.subscriptionQuery)},this.elixirChat=i}return _createClass(OnlineStatusSubscription,[{key:"onStatusChange",value:function onStatusChange(t){var n=this.elixirChat.triggerEvent,i=t||{},r=i.isOnline,s=i.workHoursStartAt,o={isOnline:Boolean(r),workHoursStartAt:s||null};o.isOnline===this.onlineStatus.isOnline&&o.workHoursStartAt===this.onlineStatus.workHoursStartAt||(this.onlineStatus=o,n(e.ONLINE_STATUS_CHANGE,o))}}]),OnlineStatusSubscription}();exports.OnlineStatusSubscription=n;
},{"./GraphQLClient":"fvSB","./ElixirChatEventTypes":"Cteb"}],"xY1B":[function(require,module,exports) {
"use strict";function _templateObject2(){var e=_taggedTemplateLiteral(["\n    mutation ($messageId: ID!) {\n      updateLastReadMessage(messageId: $messageId) {\n        unreadMessagesCount,\n        unreadRepliesCount,\n      }\n    }\n  "]);return _templateObject2=function _templateObject2(){return e},e}function _templateObject(){var e=_taggedTemplateLiteral(["\n    subscription {\n      updateReadMessages {\n        unreadMessagesCount\n        unreadRepliesCount\n        lastReadMessageId\n      }\n    }\n  "]);return _templateObject=function _templateObject(){return e},e}function _taggedTemplateLiteral(e,t){return t||(t=e.slice(0)),Object.freeze(Object.defineProperties(e,{raw:{value:Object.freeze(t)}}))}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _defineProperties(e,t){for(var s=0;s<t.length;s++){var n=t[s];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}function _createClass(e,t,s){return t&&_defineProperties(e.prototype,t),s&&_defineProperties(e,s),e}Object.defineProperty(exports,"__esModule",{value:!0}),exports.UnreadMessagesCounter=void 0;var e=require("./GraphQLClient"),t=require("./ElixirChatEventTypes"),s=function(){function UnreadMessagesCounter(t){var s=this,n=t.elixirChat;_classCallCheck(this,UnreadMessagesCounter),this.unreadMessagesCount=0,this.unreadRepliesCount=0,this.lastReadMessageId=null,this.subscriptionQuery=e.gql(_templateObject()),this.setLastReadMessageQuery=e.gql(_templateObject2()),this.subscribe=function(e){s.onUnreadCountsUpdate(Object.assign(Object.assign({},e),{lastReadMessageId:"Tm9ib2R5V29ya2luZ01lc3NhZ2U6NWYzNDQ4MTUtM2E2MS00M2Y3LTgxN2QtMjYxMjhkZGRlMzNm"})),s.initializeSocketClient()},this.setLastReadMessage=function(e){var t=s.elixirChat.sendAPIRequest;if(e!==s.lastReadMessageId)return t(s.setLastReadMessageQuery,{messageId:e})},this.unsubscribe=function(){var e=s.elixirChat,t=e.graphQLClientSocket;(0,e.logInfo)("UnreadMessagesCounter: Unsubscribing..."),t.unsubscribe(s.subscriptionQuery),s.onUnreadCountsUpdate({unreadMessagesCount:0,unreadRepliesCount:0})},this.elixirChat=n}return _createClass(UnreadMessagesCounter,[{key:"initializeSocketClient",value:function initializeSocketClient(){var e=this,t=this.elixirChat,s=t.graphQLClientSocket,n=t.logInfo,a=t.logError;s.subscribe({query:this.subscriptionQuery,onAbort:function onAbort(e){a("UnreadMessagesCounter: Failed to subscribe",{error:e})},onStart:function onStart(){n("UnreadMessagesCounter: Subscribed")},onResult:function onResult(t){var s,n=(null===(s=null==t?void 0:t.data)||void 0===s?void 0:s.updateReadMessages)||{};e.onUnreadCountsUpdate(n)}})}},{key:"onUnreadCountsUpdate",value:function onUnreadCountsUpdate(e){var s=this.elixirChat,n=s.triggerEvent,a=s.logInfo,r=e.unreadMessagesCount,i=e.unreadRepliesCount,u=(e.lastReadMessageId||"").toString().trim();r!==this.unreadMessagesCount&&(this.unreadMessagesCount=r,a("Unread messages count changed to "+r),n(t.UNREAD_MESSAGES_CHANGE,r)),i!==this.unreadRepliesCount&&(this.unreadRepliesCount=i,a("Unread replies count changed to "+i),n(t.UNREAD_REPLIES_CHANGE,i)),u!==this.lastReadMessageId&&(this.lastReadMessageId=u,a("Last message marked as read changed to: "+u),n(t.LAST_READ_MESSAGE_CHANGE,u))}}]),UnreadMessagesCounter}();exports.UnreadMessagesCounter=s;
},{"./GraphQLClient":"fvSB","./ElixirChatEventTypes":"Cteb"}],"jRw6":[function(require,module,exports) {
"use strict";function _toConsumableArray(e){return _arrayWithoutHoles(e)||_iterableToArray(e)||_unsupportedIterableToArray(e)||_nonIterableSpread()}function _nonIterableSpread(){throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function _unsupportedIterableToArray(e,t){if(e){if("string"==typeof e)return _arrayLikeToArray(e,t);var s=Object.prototype.toString.call(e).slice(8,-1);return"Object"===s&&e.constructor&&(s=e.constructor.name),"Map"===s||"Set"===s?Array.from(e):"Arguments"===s||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(s)?_arrayLikeToArray(e,t):void 0}}function _iterableToArray(e){if("undefined"!=typeof Symbol&&Symbol.iterator in Object(e))return Array.from(e)}function _arrayWithoutHoles(e){if(Array.isArray(e))return _arrayLikeToArray(e)}function _arrayLikeToArray(e,t){(null==t||t>e.length)&&(t=e.length);for(var s=0,r=new Array(t);s<t;s++)r[s]=e[s];return r}function _templateObject3(){var e=_taggedTemplateLiteral(["\n    query ($first: Int, $last: Int, $before: String, $after: String) {\n      messages(first: $first, last: $last, before: $before, after: $after) {\n        edges {\n          cursor\n          node {\n            ...fragmentMessage\n          }\n        }\n      }\n    }\n  "]);return _templateObject3=function _templateObject3(){return e},e}function _templateObject2(){var e=_taggedTemplateLiteral(["\n    mutation ($text: String!, $responseToMessageId: ID, $attachments: [Upload!], $tempId: ID) {\n      sendMessage(text: $text, responseToMessageId: $responseToMessageId, attachments: $attachments, tempId: $tempId) {\n        ...fragmentMessage\n      }\n    }\n  "]);return _templateObject2=function _templateObject2(){return e},e}function _templateObject(){var e=_taggedTemplateLiteral(["\n    subscription {\n      newMessage {\n        ...fragmentMessage\n      }\n    }\n  "]);return _templateObject=function _templateObject(){return e},e}function _taggedTemplateLiteral(e,t){return t||(t=e.slice(0)),Object.freeze(Object.defineProperties(e,{raw:{value:Object.freeze(t)}}))}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _defineProperties(e,t){for(var s=0;s<t.length;s++){var r=t[s];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function _createClass(e,t,s){return t&&_defineProperties(e.prototype,t),s&&_defineProperties(e,s),e}Object.defineProperty(exports,"__esModule",{value:!0}),exports.MessageSubscription=void 0;var e=require("./ElixirChatEventTypes"),t=require("./serializers/serializeMessage"),s=require("../utilsCommon"),r=require("./GraphQLClient"),a=function(){function MessageSubscription(a){var n=this,i=a.elixirChat;_classCallCheck(this,MessageSubscription),this.messageHistory=[],this.MESSAGE_HISTORY_REQUEST_INTERVAL=3e4,this.temporaryMessageTempIds=[],this.messageHistoryRequestInterval=null,this.subscriptionQuery=r.insertGraphQlFragments(r.gql(_templateObject()),{fragmentMessage:t.fragmentMessage}),this.sendMessageQuery=r.insertGraphQlFragments(r.gql(_templateObject2()),{fragmentMessage:t.fragmentMessage}),this.messageHistoryQuery=r.insertGraphQlFragments(r.gql(_templateObject3()),{fragmentMessage:t.fragmentMessage}),this.subscribe=function(){var e=n.elixirChat,t=e.graphQLClientSocket,s=e.logInfo,r=e.logError;n.updateMessageHistoryOnInterval(),t.subscribe({query:n.subscriptionQuery,onAbort:function onAbort(e){r("MessageSubscription: Failed to subscribe",{error:e})},onStart:function onStart(){s("MessageSubscription: Subscribed")},onResult:n.onMessageReceive})},this.onMessageReceive=function(s){var r,a=n.elixirChat,i=a.triggerEvent,o=a.logInfo,u=null===(r=null==s?void 0:s.data)||void 0===r?void 0:r.newMessage;if(u){var g=t.serializeMessage(u,n.elixirChat);n.temporaryMessageTempIds.includes(g.tempId)?n.forgetTemporaryMessage(g.tempId):(n.messageHistory.push(g),o("Received new message",{message:g}),i(e.MESSAGES_RECEIVE,g))}},this.changeMessageBy=function(t,s){var r=n.elixirChat.triggerEvent;n.messageHistory=n.messageHistory.map(function(e){var r,a=Object.assign({},e);return n.doesMessageMatchQuery(e,t)&&(a=Object.assign(Object.assign({},a),s)),(null===(r=e.responseToMessage)||void 0===r?void 0:r.id)&&n.doesMessageMatchQuery(e.responseToMessage,t)&&(a.responseToMessage=Object.assign(Object.assign({},a.responseToMessage),s)),a}),r(e.MESSAGES_CHANGE,n.messageHistory)},this.sendMessage=function(e){var r,a=n.elixirChat,i=a.logInfo,o=a.logError,u=a.sendAPIRequest,g=n.serializeSendMessageParams(e),l=g.variables,c=g.binaries;if(!l.text&&!l.attachments.length){var m='MessageSubscription: Either "text" or "attachments" parameter must not be empty';return o(m,l),Promise.reject({message:m})}if(e.appendConditionally){r=s.randomDigitStringId(6),l.tempId=r;var p=n.generateTemporaryMessage(e,{tempId:r});n.appendMessageConditionally(p)}else e.retrySubmissionByTempId&&(r=e.retrySubmissionByTempId,l.tempId=r,n.changeMessageBy({tempId:r},{isSubmitting:!0,submissionErrorCode:null}));return u(n.sendMessageQuery,l,c).then(function(s){var r=t.serializeMessage(s,n.elixirChat),a=r.tempId;return a?(i("MessageSubscription: Enriched temporary message with actual one",{sentMessage:r}),n.changeMessageBy({tempId:a},r)):i("MessageSubscription: Sent message",{textareaParams:e,variables:l,sentMessage:r}),r}).catch(function(e){var t=n.getSubmissionErrorCode(e);throw n.changeMessageBy({tempId:r},{isSubmitting:!1,submissionErrorCode:t}),e})},this.retrySendMessage=function(e){var t;return n.sendMessage({text:e.text,attachments:e.attachments,responseToMessageId:null===(t=null==e?void 0:e.responseToMessage)||void 0===t?void 0:t.id,retrySubmissionByTempId:e.tempId})},this.fetchMessageHistory=function(e){return n.getMessageHistoryByCursor({limit:e}).then(function(e){return n.onMessageHistoryChange(e)})},this.fetchPrecedingMessageHistory=function(e){var t,r=n.elixirChat.logError,a=null===(t=n.messageHistory[0])||void 0===t?void 0:t.cursor;if(!a){var i="MessageSubscription: Failed to fetch previous message history - cursors not found";return r(i),Promise.reject({message:i})}return n.getMessageHistoryByCursor({limit:e,beforeCursor:a}).then(function(e){var t=s._uniqBy([].concat(_toConsumableArray(e),_toConsumableArray(n.messageHistory)),"id");return n.onMessageHistoryChange(t)})},this.markPrecedingMessagesRead=function(e){var t=n.messageHistory.map(function(e){return e.id}).indexOf(e);n.messageHistory.forEach(function(e,s){t>=s&&(e.isUnread=!1)}),n.onMessageHistoryChange(n.messageHistory)},this.unsubscribe=function(){var e=n.elixirChat,t=e.graphQLClientSocket,s=e.logInfo;n.messageHistory=[],n.temporaryMessageTempIds=[],clearInterval(n.messageHistoryRequestInterval),s("MessageSubscription: Unsubscribing..."),t.unsubscribe(n.companyMessageSubscription)},this.elixirChat=i}return _createClass(MessageSubscription,[{key:"updateMessageHistoryOnInterval",value:function updateMessageHistoryOnInterval(){var e=this;this.messageHistoryRequestInterval=setInterval(function(){var t,r=(null===(t=s._last(e.messageHistory))||void 0===t?void 0:t.cursor)||null;e.getMessageHistoryByCursor({limit:20,afterCursor:r}).then(function(t){t.forEach(e.onMessageReceive)})},this.MESSAGE_HISTORY_REQUEST_INTERVAL)}},{key:"forgetTemporaryMessage",value:function forgetTemporaryMessage(e){this.temporaryMessageTempIds=this.temporaryMessageTempIds.filter(function(t){return t!==e})}},{key:"doesMessageMatchQuery",value:function doesMessageMatchQuery(e,t){for(var s in t)if(t[s]!==e[s])return!1;return!0}},{key:"getSubmissionErrorCode",value:function getSubmissionErrorCode(e){var t,s,r,a=(null===(r=null===(s=null===(t=e.rawError)||void 0===t?void 0:t.errors)||void 0===s?void 0:s[0])||void 0===r?void 0:r.status)||400;return navigator.onLine||(a=503),a}},{key:"serializeSendMessageParams",value:function serializeSendMessageParams(e){var t="string"==typeof e.text?e.text.trim():"",s=e.tempId,r="string"==typeof e.responseToMessageId?e.responseToMessageId:null,a=[],n={};try{e.attachments.forEach(function(e){var t=e.file;a.push(t.name),n[t.name]=t})}catch(i){}return{variables:{text:t,tempId:s,attachments:a,responseToMessageId:r},binaries:n}}},{key:"generateTemporaryMessage",value:function generateTemporaryMessage(e,r){var a=e.text,n=e.attachments,i=e.responseToMessageId,o=this.messageHistory.filter(function(e){return e.id===i})[0],u=n.map(function(e){var t=e.id,r=e.file,a=e.width,n=e.height,i=URL.createObjectURL(r),o=[];return s.isWebImage(r.type)&&a&&n&&(o=[{id:t,url:i}]),Object.assign(Object.assign({},e),{url:i,thumbnails:o,contentType:r.type,bytesSize:r.size})});return t.serializeMessage(Object.assign({id:s.randomDigitStringId(6),text:a.trim()||"",timestamp:(new Date).toISOString(),responseToMessage:o||{},attachments:u,isSubmitting:!0,sender:{__typename:"Client",foreignId:this.elixirChat.client.id}},r),this.elixirChat)}},{key:"appendMessageConditionally",value:function appendMessageConditionally(t){var s=this.elixirChat,r=s.triggerEvent,a=s.logInfo;this.messageHistory.push(t),this.temporaryMessageTempIds.push(t.tempId),a("Conditionally appended message",{message:t}),r(e.MESSAGES_RECEIVE,t)}},{key:"getMessageHistoryByCursor",value:function getMessageHistoryByCursor(e){var s,a=this,n=this.elixirChat.sendAPIRequest,i=e.limit,o=e.beforeCursor,u=e.afterCursor;return s=o?{last:i,before:o}:u?{first:i,after:u}:{last:i},n(this.messageHistoryQuery,s).then(function(e){return r.simplifyGraphQLJSON(e).map(function(e){return t.serializeMessage(e,a.elixirChat)})})}},{key:"onMessageHistoryChange",value:function onMessageHistoryChange(t){var s=this.elixirChat.triggerEvent;return this.messageHistory=t,s(e.MESSAGES_CHANGE,t),t}}]),MessageSubscription}();exports.MessageSubscription=a;
...
"use strict";function _templateObject(){var e=_taggedTemplateLiteral(["\n      mutation($companyId: Uuid!, $room: ForeignRoom, $client: ForeignClient!) {\n        joinRoom (companyId: $companyId, room: $room, client: $client) {\n          token\n          company {\n            isWorking\n            workHoursStartAt\n            widgetTitle\n            employees(first: 20) {\n              count\n              edges {\n                node { ...fragmentUser }\n              }\n            }\n          }\n          client {\n            ...fragmentUser\n            omnichannelCode\n          }\n          room {\n            id\n            title\n            foreignId\n            mustOpenWidget\n            unreadMessagesCount\n            unreadRepliesCount\n          }\n        }\n      }\n    "]);return _templateObject=function _templateObject(){return e},e}function _taggedTemplateLiteral(e,t){return t||(t=e.slice(0)),Object.freeze(Object.defineProperties(e,{raw:{value:Object.freeze(t)}}))}function _slicedToArray(e,t){return _arrayWithHoles(e)||_iterableToArrayLimit(e,t)||_unsupportedIterableToArray(e,t)||_nonIterableRest()}function _nonIterableRest(){throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function _unsupportedIterableToArray(e,t){if(e){if("string"==typeof e)return _arrayLikeToArray(e,t);var n=Object.prototype.toString.call(e).slice(8,-1);return"Object"===n&&e.constructor&&(n=e.constructor.name),"Map"===n||"Set"===n?Array.from(e):"Arguments"===n||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)?_arrayLikeToArray(e,t):void 0}}function _arrayLikeToArray(e,t){(null==t||t>e.length)&&(t=e.length);for(var n=0,i=new Array(t);n<t;n++)i[n]=e[n];return i}function _iterableToArrayLimit(e,t){if("undefined"!=typeof Symbol&&Symbol.iterator in Object(e)){var n=[],i=!0,r=!1,o=void 0;try{for(var a,s=e[Symbol.iterator]();!(i=(a=s.next()).done)&&(n.push(a.value),!t||n.length!==t);i=!0);}catch(u){r=!0,o=u}finally{try{i||null==s.return||s.return()}finally{if(r)throw o}}return n}}function _arrayWithHoles(e){if(Array.isArray(e))return e}function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function _typeof(e){return typeof e}:function _typeof(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _defineProperties(e,t){for(var n=0;n<t.length;n++){var i=t[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}function _createClass(e,t,n){return t&&_defineProperties(e.prototype,t),n&&_defineProperties(e,n),e}Object.defineProperty(exports,"__esModule",{value:!0}),exports.ElixirChat=void 0;var e=require("unique-names-generator"),t=require("../utilsCommon"),n=require("./serializers/serializeUser"),i=require("./Logger"),r=require("./ScreenshotTaker"),o=require("./TypingStatusSubscription"),a=require("./UpdateMessageSubscription"),s=require("./OnlineStatusSubscription"),u=require("./UnreadMessagesCounter"),l=require("./MessageSubscription"),c=require("./GraphQLClient"),h=require("./GraphQLClientSocket"),d=require("./ElixirChatEventTypes"),m=require("../utilsWidget");window.eventHandlers=[];var g=function(){function ElixirChat(e){var t=this;_classCallCheck(this,ElixirChat),this.version="4.0.2.omnichannel@7",this.config={},this.joinRoomData={},this.isInitialized=!1,this.eventHandlers={},this.triggerEvent=function(e,n,i){var r;i=i||{},t.logEvent(e,n),(null===(r=window.eventHandlers[e])||void 0===r?void 0:r.callbacks)||(window.eventHandlers[e]={callbacks:[]});var o=window.eventHandlers[e];o.firedOnce=i.firedOnce,o.firedOnceArguments=n,o.callbacks.forEach(function(e){return e(n)})},this.off=function(e,t){var n,i=window.eventHandlers[e];(null===(n=i.callbacks)||void 0===n?void 0:n.length)&&(i.callbacks=i.callbacks.filter(function(e){return e!==t}))},this.sendMessage=function(e){return t.checkIfConnected().then(function(){return t.typingStatusSubscription.dispatchTypedText(!1),t.messageSubscription.sendMessage(e)})},this.retrySendMessage=function(e){return t.checkIfConnected().then(function(){return t.messageSubscription.retrySendMessage(e)})},this.fetchMessageHistory=function(e){return t.checkIfConnected().then(function(){return t.messageSubscription.fetchMessageHistory(e)})},this.fetchPrecedingMessageHistory=function(e){return t.checkIfConnected().then(function(){return t.messageSubscription.fetchPrecedingMessageHistory(e)})},this.dispatchTypedText=function(e){return t.checkIfConnected().then(function(){return t.typingStatusSubscription.dispatchTypedText(e)})},this.setLastReadMessage=function(e){return t.checkIfConnected().then(function(){return t.unreadMessagesCounter.setLastReadMessage(e)})},this.takeScreenshot=function(){return t.screenshotTaker.takeScreenshot()},this.logEvent=function(e,n){return t.logger.logEvent(e,n)},this.logInfo=function(e,n){return t.logger.logInfo(e,n)},this.logError=function(e,n){return t.logger.logError(e,n)},this.sendAPIRequest=function(e,n,i){var r=c.parseGraphQLMethodFromQuery(e);return t.graphQLClient.query(e,n,i).then(function(e){return e[r]}).catch(function(i){var o,a,s="".concat(r,": ").concat(c.getErrorMessageFromResponse(i)),u={errorMessage:s,errorType:(null===(a=null===(o=null==i?void 0:i.errors)||void 0===o?void 0:o[0])||void 0===a?void 0:a.reason)||null,rawError:i,query:e,variables:n,graphQLMethod:r};throw t.logError(s,u),Object.assign({errorMessage:s},u)})},this.disconnect=function(){return t.checkIfConnected().then(function(){t.logInfo("Disconnecting from ElixirChat"),t.isConnected=!1,t.messageSubscription.unsubscribe(),t.updateMessageSubscription.unsubscribe(),t.unreadMessagesCounter.unsubscribe(),t.typingStatusSubscription.unsubscribe(),t.onlineStatusSubscription.unsubscribe()})},this.reconnect=function(e){return t.logInfo("Attempting to reconnect to another room",e),t.disconnect(),t.joinRoom(e.room,e.client)},this.hasAllRequiredConfigParameters(e)&&this.initialize(e),"undefined"!=typeof window&&(window.elixirChat=this)}return _createClass(ElixirChat,[{key:"hasAllRequiredConfigParameters",value:function hasAllRequiredConfigParameters(e){var t=["apiUrl","socketUrl","companyId"].filter(function(t){return!e[t]});if(t.length)throw"Required parameters: ".concat(t.join(", ")," not provided. \nSee more: https://github.com/elixirchat/elixirchat-js-sdk#config");return!0}},{key:"initialize",value:function initialize(e){var t=this;return this.config=e||{},this.isInitialized=!0,this.graphQLClient=new c.GraphQLClient,this.graphQLClientSocket=new h.GraphQLClientSocket,this.logger=new i.Logger({elixirChat:this}),this.screenshotTaker=new r.ScreenshotTaker({elixirChat:this}),this.messageSubscription=new l.MessageSubscription({elixirChat:this}),this.unreadMessagesCounter=new u.UnreadMessagesCounter({elixirChat:this}),this.updateMessageSubscription=new a.UpdateMessageSubscription({elixirChat:this}),this.typingStatusSubscription=new o.TypingStatusSubscription({elixirChat:this}),this.onlineStatusSubscription=new s.OnlineStatusSubscription({elixirChat:this}),this.on(d.UPDATE_MESSAGES_CHANGE,function(e){t.messageSubscription.changeMessageBy({id:e.id},e)}),this.on(d.LAST_READ_MESSAGE_CHANGE,function(e){t.messageSubscription.markPrecedingMessagesRead(e)}),this.logInfo("Initializing ElixirChat",e),this.joinRoom()}},{key:"serializeClient",value:function serializeClient(e){e=e||{};var n=t.getJSONFromLocalStorage("elixirchat-client")||{},i=this.generateAnonymousClientData(),r=e.id||n.id||i.id,o="string"==typeof e.firstName?e.firstName:n.firstName||i.firstName,a="string"==typeof e.lastName?e.lastName:n.lastName||i.lastName;return o||a||(o=n.firstName||i.firstName,a=n.lastName||i.lastName),{id:r.toString(),firstName:o,lastName:a}}},{key:"serializeRoom",value:function serializeRoom(e,n){e=e||{};var i=t.getJSONFromLocalStorage("elixirchat-room")||{},r=e.id||i.id||n.id,o=e.title||i.title||n.firstName+" "+n.lastName,a={};if("object"===_typeof(e.data))for(var s in e.data)a[s]=e.data[s].toString();return{id:r.toString(),title:o,data:JSON.stringify(a)}}},{key:"generateAnonymousClientData",value:function generateAnonymousClientData(){var n=e.uniqueNamesGenerator({length:2,separator:" ",dictionaries:null}),i=_slicedToArray(n.split(" ").map(t.capitalize),2),r=i[0],o=i[1],a=t.randomDigitStringId(4);return{id:n.replace(" ","-")+"-"+a,firstName:r,lastName:o}}},{key:"joinRoom",value:function joinRoom(e,i){var r=this;this.client=this.serializeClient(i),this.room=this.serializeRoom(e,this.client),this.isPrivateRoom=this.room.id===this.client.id,t.setToLocalStorage("elixirchat-room",this.room),t.setToLocalStorage("elixirchat-client",this.client);var o={companyId:this.config.companyId,client:this.client,room:this.room},a=c.insertGraphQlFragments(c.gql(_templateObject()),{fragmentUser:n.fragmentUser}),s=new c.GraphQLClient;return s.initialize({url:this.config.apiUrl}),s.query(a,o).then(function(e){if(null==e?void 0:e.joinRoom){var t=r.serializeJoinRoomData(e.joinRoom);return r.joinRoomData=t,r.onJoinRoomSuccess(t),r.triggerEvent(d.JOIN_ROOM_SUCCESS,t,{firedOnce:!0}),t}throw r.triggerEvent(d.JOIN_ROOM_ERROR,e),e}).catch(function(e){throw r.triggerEvent(d.JOIN_ROOM_ERROR,e),e})}},{key:"onJoinRoomSuccess",value:function onJoinRoomSuccess(e){var t=this.config,n=t.apiUrl,i=t.socketUrl,r=e.token,o=e.isOnline,a=e.workHoursStartAt,s=e.unreadMessagesCount,u=e.unreadRepliesCount;this.logInfo("Joined room",e),this.isConnected=!0,this.graphQLClient.initialize({url:n,token:r}),this.graphQLClientSocket.initialize({url:i,token:r}),this.messageSubscription.subscribe(),this.updateMessageSubscription.subscribe(),this.onlineStatusSubscription.subscribe({isOnline:o,workHoursStartAt:a}),this.unreadMessagesCounter.subscribe({unreadMessagesCount:s,unreadRepliesCount:u})}},{key:"serializeJoinRoomData",value:function serializeJoinRoomData(e){var t,i=this,r=e.token,o=e.room,a=void 0===o?{}:o,s=e.client,u=void 0===s?{}:s,l=e.company,h=void 0===l?{}:l;return{token:r,logoUrl:h.logoUrl,mainTitle:h.widgetTitle,chatSubtitle:h.widgetChatSubtitle,channels:this.serializeChannels(h.channels,u.omnichannelCode),employeesCount:(null===(t=h.employees)||void 0===t?void 0:t.count)||0,employees:c.simplifyGraphQLJSON(null==h?void 0:h.employees).map(function(e){return n.serializeUser(e,i)}),isOnline:h.isWorking,isPopupOpen:a.mustOpenWidget,workHoursStartAt:h.workHoursStartAt,elixirChatClientId:u.id,elixirChatRoomId:a.id,unreadMessagesCount:a.unreadMessagesCount,unreadRepliesCount:a.unreadRepliesCount,omnichannelCode:u.omnichannelCode}}},{key:"serializeChannels",value:function serializeChannels(e,n){e=[{type:"whatsapp",username:"917290961818"},{type:"telegram",username:"elixirchat_test_bot"},{type:"vkontakte",username:"club198196792"},{type:"viber",username:"chathelpdesk"},{type:"facebook",username:"huntflow"}];var i=m.isMobileSizeScreen(),r="Чтобы продолжить, просто отправьте целиком это сообщение. Ваш код: ".concat(n),o={whatsapp:"https://web.whatsapp.com/send?phone={{ username }}&text={{ manualMessage }}",telegram:"http://t.me/{{ username }}?start={{ omnichannelCode }}",viber:"viber://pa?chatURI={{ username }}&context={{ omnichannelCode }}",facebook:"https://m.me/{{ username }}?ref={{ omnichannelCode }}",vkontakte:"https://vk.me/{{ username }}?ref={{ omnichannelCode }}"},a={whatsapp:"whatsapp://send?phone={{ username }}&text={{ manualMessage }}",telegram:"tg://resolve?domain={{ username }}&start={{ omnichannelCode }}",viber:"viber://pa?chatURI={{ username }}&context={{ omnichannelCode }}",facebook:"https://m.me/{{ username }}?ref={{ omnichannelCode }}",vkontakte:"https://vk.me/{{ username }}?ref={{ omnichannelCode }}"};return(e||[]).map(function(e){var s=e.username,u=e.type.toLowerCase(),l=i?a[u]:o[u],c=t.template(l,{username:s,omnichannelCode:n,manualMessage:r});return{type:u,username:s,omnichannelCode:n,url:c}})}},{key:"checkIfConnected",value:function checkIfConnected(){if(this.isConnected)return Promise.resolve();var e="ElixirChat is not currently connected. Use reconnect({ room, client }) method to connect to a room.";return this.logError(e),Promise.reject({message:e})}},{key:"on",value:function on(e,t){var n,i=this;if(e instanceof Array)e.map(function(e){return i.on(e,t)});else{(null===(n=window.eventHandlers[e])||void 0===n?void 0:n.callbacks)||(window.eventHandlers[e]={callbacks:[]});var r=window.eventHandlers[e];r.callbacks.push(t),e===d.MESSAGES_RECEIVE&&(console.warn("%c__ MESSAGES_RECEIVE","color: green",r.callbacks.length,{callback:t,arguments:arguments,this2:this},arguments),window.__arguments2=arguments,window.__this6=this),r.firedOnce&&t(r.firedOnceArguments)}}},{key:"onlineStatus",get:function get(){return this.onlineStatusSubscription.onlineStatus}},{key:"unreadMessagesCount",get:function get(){return this.unreadMessagesCounter.unreadMessagesCount}},{key:"unreadRepliesCount",get:function get(){return this.unreadMessagesCounter.unreadRepliesCount}},{key:"lastReadMessageId",get:function get(){return this.unreadMessagesCounter.lastReadMessageId}},{key:"messageHistory",get:function get(){return this.messageSubscription.messageHistory}}]),ElixirChat}();exports.ElixirChat=g,"undefined"!=typeof window&&(window.ElixirChat=g);
